  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>市集是封建時代的經濟建築，需要蓋完磨坊才能建造。主要功能為使用黃金購買資源，以及販賣資源換取黃金或生產貿易車隊與其他玩家(不管是同盟、中立甚至是敵對)進行貿易，並產生黃金，以貿易車隊來說距離越遠所產生的黃金數量就越多。</p>
            <p>當然，市集也有許多團隊取向的科技可以研發，而這些功能使它不管在單人或是團隊遊戲都相當重要。</p>
            <p>而薩拉森的市集是相當強悍的，交易成本只需要5%。厲害的玩家可藉由市集來調整資源，以達到出兵最大化的優勢。</p>
          </div>
           <h3>可訓練的單位與技術</h3>
          <div class="hrn1"></div>
          <div class="row">
          ...
          <div class="n1">
            ...
            <ul>
              ...
              <li><a href="Saracens.php">薩拉森</a>市集的木材花費-43%(約莫是75木材)。</li>
            </ul>
          </div>
           <h3>歷史</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <p>隨著黑暗時代的結束和經濟的復甦，商品和工藝品的交換日漸增加。各種規模的城鎮為農民和商人空出一片空間當擺攤銷售商品的市場。每週會有一天或幾天是指定的市場日，這些天會是工作日的社交亮點。市場也是思想交流，娛樂（吟遊詩人，雜技演員，音樂家）和新聞傳播的場所。</p>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#3c763d;;">
                <div class="unititle"><a href="">市集</a>
                </div>
              </td>
            </tr>
            <tr>
