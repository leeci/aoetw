  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p><strong>法蘭切斯科-斯福爾札</strong>是《世紀帝國 II HD: 失落的帝國》中的一名步兵英雄，他是戰役"斯福爾札"系列中的主角而且一定要存活，他也能在戰役編輯器中使用。法蘭切斯科-斯福爾札擁有傭兵的外觀。由於他屬於英雄單位，因此不能被招降且會回血
              。</p>
            <p></p>
          </div>
          <div></div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><a href="">法蘭切斯科-斯福爾札</a>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/Francescosforzaicon.png" width="80" alt="">
                </div>
              </td>
            </tr>
            <tr>
