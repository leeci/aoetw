  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p><strong>霍斯勞</strong>或是霍斯勞一世，是西元531~579年薩珊帝國的“國王之王”（Shahanshah），是《世紀帝國
              II HD: 失落的帝國》布哈拉戰役中的主要腳色，他領導著薩珊王朝的波斯人 在戰鬥中擊敗匈奴和突厥。他擁有象弓騎兵的外觀，也受所有加成騎兵弓兵科技的影響(包含帕提亞戰術)。由於他屬於英雄單位，因此不能被招降且會回血
              。</p>
            <p></p>
          </div>
          <div></div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><a href="">霍斯勞</a>
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4"><a href="">騎兵<br>弓兵<br>英雄</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">370</td>
            </tr>
            <tr>
              <td class="unit3">攻擊</td>
              <td class="unit4">14(遠程)</td>
            </tr>
            <tr>
              <td class="unit3">攻擊加成</td>
              <td class="unit4">對標準建築+12
                <br>對石造建築+4</td>
            </tr>
            <tr>
