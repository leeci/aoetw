  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>火炮戰船在帝王時代的碼頭可以訓練。要訓練火炮戰船得先研發火炮戰船科技。</p>
          </div>
           <h3>戰術</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <p>火炮戰船的射程遠比城堡和火炮塔遠，而且對建築物有額外傷害加成，可說是"海上的火炮"(速度比火炮稍快)。火炮戰船有不錯的傷害，但是緩慢的開火速率，砲彈飛行時間長，有最小射程限制等缺點讓他們對船隻的攻擊幾乎沒有抵抗能力，尤其是
              <a
            ...
            <div class="col-md-12">
              <div class="n1">
                ...
                href="Byzantines.php">拜占庭</a>、 <a href="Celts.php">賽爾特</a>、 <a href="Chinese.php">中國</a>、 <a href="Ethiopians.php">衣索比亞</a>、
                  <a
                  href="Franks.php">法蘭克</a>、 <a href="Goths.php">哥德</a>、 <a href="Incas.php">印加</a>、 <a href="Indians.php">印度</a>、
                    <a
                    href="Italians.php">義大利</a>、 <a href="Japanese.php">日本</a>、 <a href="Khmer.php">高棉</a>、 <a href="Koreans.php">韓國</a>、
                      <a
                      href="Magyars.php">馬扎爾</a>、 <a href="Malay.php">馬來</a>、 <a href="Malians.php">馬利</a>、 <a href="Mongols.php">蒙古</a>、
                        <a
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-remove noc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">不可訓練</span></strong></h4>  <a href="Aztecs.php">阿茲特克</a>、 <a href="Huns.php">匈奴</a>、 <a href="Incas.php">印加</a>、
                <a
          ...
          <div class="n1">
            <ul>
              <li><a href="Berbers.php">柏柏</a>：火炮戰船移動速度快10%。</li>
              ...
              <li><a href="Vikings.php">維京</a>：火炮戰船訓練的費用在帝王減少20%。</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><a href="Turks.php">土耳其</a>：火炮戰船訓練速度快20%。</li>
              <li><a href="Teutons.php">條頓</a>：火炮戰船對招降的抵抗力更強。</li>
            </ul>
          </div>
           <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              ...
              <li><a href="Huns.php">匈奴</a>:可以訓練火炮戰船。</li>
              <li><a href="Spanish.php">西班牙</a>:火炮戰船受彈道學加成而且砲彈速度更快。</li>
            ...
            <ul>
              ...
              <li><a href="Italians.php">義大利</a>:火炮戰船便宜15%。</li>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td class="unit3">訓練所需科技</td>
              <td class="unit4">
                <img class="gg" src="img/Cannongalleonresearch.png" alt="">火炮戰船</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="img/Elite-cannon-galleon-resear.jpg" alt="">525木材 500黃金</td>
            </tr>
            <tr>
