  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="spw"><em>這篇文章是說關於英雄:塔里克·伊本·齊亞德這個遊戲單位。而關於塔里克·伊本·齊亞德請見<a href="Tariq_ibn_Ziyada.php">塔里克·伊本·齊亞德(戰役)</a></em>
          </div>
          <div class="n1">
            <p>塔里克·伊本·齊亞德，670年~720年4月11日，是一位柏柏人穆斯林將軍、安達盧斯總督(711~712)。最初是穆薩·本·努薩依爾副官，從摩洛哥北海岸開始，他發起了第一波對西哥德王國（包含現今的西班牙與葡萄牙）的征服行動。</p>
          </div>
          <h3>介紹</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <p>塔里克·伊本·齊亞德是一位馬弓騎兵英雄，只有在地圖編輯器與塔里克·伊本·齊亞德戰役中登場，外型是標槍騎兵，他是一個必須存活的單位。英雄不能被招降，且會自己回血。</p>
          </div>
          <h3>芝麻小事</h3>
          <div class="hrn1"></div>
          <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><a href="">塔里克·伊本·齊亞德</a>
                </div>
              </td>
            </tr>
            <tr>
