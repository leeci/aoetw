  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>非洲王國是AOE HD版繼失落的帝國後的第二張資料片，也是世紀帝國第三張資料片，此次主題著重於非洲大陸，四個文明有三個來自於非洲。並且新增了一些遊戲功能。</p>
          ...
          <div class="n1">
            <ul>
              ...
              <li><strong>馬利:</strong>跟隨偉大的<a href="Musa_ibn_Nusayr.php">曼薩·穆薩</a>，成為西非最偉大的國王，征服周圍的王國，獲取更大的財富，牢牢控制該地區的貿易路線，你能擊敗其他那些曾經與你敵對的人嗎?</li>
              <li><strong>衣索比亞:</strong>讓<a href="http://tinyurl.com/yc45cyps">阿克蘇姆帝國</a>再次偉大，由紅海出發，向阿拉伯半島進擊，你是否能平息帝國內部的矛盾，那些篡位者已經虎視眈眈。只有最強大的帝國才能存活下來。</li>
              <li><strong>葡萄牙:</strong>開啟新世界，發現新航路，前往未知的土地，啟航前往非洲王國，獲取更大的財富，建立起偉大的城市，迎接新世代的來臨。</li>
            </ul>
          </div>
           <h3>單位</h3>
          <div class="n1">
        ...
        <div class="col-md-12">
          ...
          <div class="n1">
            ...
            <ul>
              ...
              <li>精銳擲斧兵速度從 0.9改為1.0</li>
            </ul>匈奴
            <ul>
              <li>馬弓騎兵花費減少的程度，城堡與帝王時代從-25%/-30%改為-10%/-20%</li>
              <li>銀冠（掠奪者)花費從500F200G改為300W 200G</li>
            </ul>印加
            <ul>
              <li>金冠（信使）從+10%移動速度改為+1/+2 防禦</li>
              <li>投石者不用先蓋城堡即可生產</li>
              <li>獲得大型箭塔、公會制度、印刷術、姆指環</li>
            </ul>印度
            <ul>
              <li>村民花費，四時代 從 -5%/-10%/-15%/-20% 改為 -10%/-15%/-20%/-25% 獲得 公會制度、弓兵三防</li>
              <li>騎象射手血量從250改為280</li>
              <li>精銳騎象射手血量從350改為330</li>
              <li>（精銳）騎象射手遠防從4改為3</li>
              <li>（精銳）騎象射手花費從110F 80G改為100F 80G</li>
            </ul>義大利
            <ul>
              <li>傭兵不需先蓋城堡即可生產</li>
              <li>傭兵攻擊從9改為10</li>
              <li>傭兵速度從1改為1.2</li>
              <li>銀冠（大盾）可影響所有徒步弓兵</li>
              <li>銀冠（大盾）花費從 550F 300G 改為 300F 150G</li>
              <li>時代演進花費從 -10% 改為 -15%</li>
            </ul>日本
            <ul>
              <li>銀冠（射箭孔）花費從 400W 300F 改為 300W 300F</li>
            </ul>韓國
            <ul>
              <li>龜甲船不需先蓋城堡即可生產</li>
              <li>銀冠（板屋船）花費從 400W 400F 改為 300W 300F</li>
            </ul>馬雅
            <ul>
              <li>銀冠（黑曜石之箭）對建築攻擊從+4改為+6</li>
              <li>資源多20%改為多15%</li>
            </ul>斯拉夫
            <ul>　
              <li>種田速率從 1.18倍 改為 1.31倍（實際效率成為 輪軸後 +15%，手推車後 +5%）</li>
            </ul>西班牙
            <ul>
              <li>傳教士不需先蓋城堡即可生產</li>
              <li>銀冠（宗教法庭）花費從400F 400G改為100F 300G</li>
            </ul>條頓
            <ul>
              <li>銀冠（重盔甲）花費從 500W 350G改為400W 350G</li>
            </ul>維京
            <ul>
              <li>維京大戰船不需先蓋城堡即可生產</li>
              <li>維京大戰船花費從 90W 40G 改為 100W 50G</li>
              <li>銀冠（酋長）花費從 700F 400G 改為 400F 300G</li>
            ...
            <ul>
              ...
              <li>運輸船：可於黑暗時代生產</li>
              <li>木門：成為改為20木材(原為30木材)</li>
              <li>魚網：建造時間-13秒(現在為40秒)</li>
              <li>長槍兵、重裝 長槍兵、戟兵：-1對駱駝騎兵、船艦攻擊加成</li>
              <li>雙手劍兵：基礎攻擊力由11上升至12</li>
              <li>裝甲步兵、長劍兵、雙手劍兵、劍兵勇士：+1對普通建築的攻擊力</li>
              <li>駱駝騎兵、重裝駱駝騎兵：攻擊力+1(變成6、8)</li>
              <li>長弓兵、精銳長弓兵：生產時間-1秒(變成17秒)</li>
              <li>狂戰士、精銳狂戰士：生命值變為54/62(原為52/60)，訓練時間-2秒(原為16秒)</li>
              ...
              <li>鑄幣術費用從 150F 50G 改為 200F 100G</li>
              <li>馬弓花費從 40W 65G 改為 40W 60G</li>
              <li>貿易商船每趟多賺 30%</li>
            ...
            <ul>
              <li>追蹤技術：成本減至50食物</li>
              <li>護衛技術：成本減至100食物</li>
              <li>精銳羽毛箭射手：成本增加至700食物 1000木材</li>
            </ul>
          </div>
        </div>
      </div>
