  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>匈牙利輕騎兵或稱翼騎兵，是帝王時代兵種，可訓練於馬廄，對僧侶、遠程兵種、攻城武器有額外的加成。因為只需要肉即可生產，在華人圈俗稱肉馬。</p>
          </div>
          <h3>文明可訓練與否</h3> 
          <div class="hrn1"></div>
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                ...
                <a
                href="Celts.php">賽爾特</a>、 <a href="Ethiopians.php">衣索比亞</a>、 <a href="Goths.php">哥德</a>、
                  <a
                  href="Huns.php">匈奴</a>、 <a href="Indians.php">印度</a>、 <a href="Italians.php">義大利</a>、
                    <a
                    href="Koreans.php">韓國</a>、 <a href="Magyar.php">馬札爾</a>、 <a href="Mongols.php">蒙古</a>、 <a href="Persians.php">波斯</a>、
                      <a
                      href="Saracens.php">薩拉森</a>、 <a href="Slavs.php">斯拉夫</a>、 <a href="Spanish.php">西班牙</a>、 <a href="Turks.php">土耳其</a>。</div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-remove noc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">不可訓練</span></strong></h4>  <a href="Aztecs.php">阿茲特克</a>、 <a href="Britons.php">不列顛</a>、 <a href="Chinese.php">中國</a>、
                <a
                href="Franks.php">法蘭克</a>、 <a href="Incas.php">印加</a>、 <a href="Japanese.php">日本</a>、 <a href="Khmer.php">高棉</a>、
                  <a
                  href="Malay.php">馬來</a>、 <a href="Malians.php">馬利</a>、 <a href="Mayans.php">馬雅</a>、 <a href="Portuguese.php">葡萄牙</a>、
                    <a
                    href="Teutons.php">條頓</a>、 <a href="Vietnamese.php">越南</a>、 <a href="Vikings.php">維京</a>。</div>
            </div>
          </div>
          <h3>戰術</h3>
          <div class="hrn1"></div>
          <div class="n1">匈牙利輕騎兵可用於偷襲對手家裡、貿易車隊以及攻城武器和僧侶給予敵人經濟上的打擊。帝王時代初期<a href="Turks.php">土耳其</a>的匈牙利輕騎兵免費升級。當打到大後期時，匈牙利輕騎兵因不需要黃金則有重要的戰略意義，此時沒有匈牙利輕騎兵的國家劣勢會因此浮現出來。</div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Skirmisher.php">矛兵系列</a>，攻城器單位。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><a href="Spearman.php">槍兵</a>系，<a href="Kamayuk.php">槍隊長</a>，<a href="Mameluke.php">奴隸兵</a>，
                <a
                href="Camel.php">駱駝騎兵</a>，<a href="Genoese_Crossbowman.php">熱那亞弩手</a>，大部分近戰單位</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br>
                <img src="img/Unique-tech.jpg" class="gg" alt=""><a href="Manipur_Cavalry.php">曼尼普爾騎兵</a>:騎兵對建築物攻擊+3。</td>
            </tr>
            <tr>
          ...
          <h3>剋匈牙利輕騎兵的單位與建築</h3> 
          <div class="hrn1"></div>
          <div class="n1">以下單位擁有對匈牙利輕騎兵的額外傷害，按照傷殺力排列。
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-6">
          ...
          <div class="n1">
            <ul>
              <li><a href="Berbers.php">柏柏</a>：匈牙利輕騎兵便宜20%。</li>
              ...
              <li><a href="Magyars.php">馬扎爾</a>：免費鍛造.鑄鐵.鼓風爐科技，匈牙利輕騎兵系生產便宜15%</li>
              <li><a href="Mongols.php">蒙古</a>：匈牙利輕騎兵血量多30%。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li><a href="Huns.php">匈奴</a>：匈牙利輕騎兵生產效率快20%，<a href="Bloodlines.php">品種</a>與
                <a
                href="Husbandry.php">畜牧技術</a>研發快20%。</li>
              <li><a href="Mongols.php">蒙古</a>：匈牙利輕騎兵+2視野。</li>
              <li><a href="Teutons.php">條頓</a>：匈牙利輕騎兵對僧侶抵抗力更強。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li><a href="Italians.php">義大利</a>:沒有匈牙利輕騎兵。</li>
              <li><a href="Magyars.php">馬扎爾</a>:匈牙利輕騎兵便宜10%。</li>
            </ul>
            <h3><em><a href="ak.php">非洲王國</a></em></h3>
            <ul>
              <li><a href="Italians.php">義大利</a>:有匈牙利輕騎兵了。</li>
            </ul>
            <h3><em><a href="aor.php">王者崛起</a></em></h3>
            <ul>
              <li><a href="Magyars.php">馬扎爾</a>:5.5版本後匈牙利輕騎兵現在便宜15%。</li>
            </ul>
          </div>
          <h3>趣事</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li>歷史上的匈牙利輕騎兵在實戰中是不會裝飾羽毛的，唯有在閱兵時才會插上裝飾用的羽毛。</li>
            </ul>
          </div>
          <h3>歷史</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <p>驃騎兵（Hussar）是源自15世紀匈牙利的輕騎兵，這種騎兵的頭銜與特別衣著隨後廣泛地被歐洲與其他地區的騎兵團採用，至一戰前歐洲許多國家仍保有驃騎兵團作為輕騎兵使用。現代一些裝甲兵或儀兵還保有驃騎兵這個稱號。</p>
          </div>
          <h3>圖庫</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <div class="col-md-12">
              <div class="col-md-4"> <a href="img/Hussar.png"><img class="imgn" class="hg" src="img/Hussar.png" alt=""></a> 
                <p><em>一群匈牙利輕騎兵。</em>
                </p>
              </div>
            </div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#3c763d;;">
                <div class="unititle2">匈牙利輕騎兵</div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/HussarIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">+12對<a href="Armor_Class_Monk.php">僧侶係</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td class="unit3"><a href="Armor_class.php"></a>遠防</td>
              <td class="unit4">2</td>
            </tr>
            <tr>
