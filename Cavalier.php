    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        <div class="col-md-12">
           <h1>騎兵</h1>
          <div class="hrn1"></div>
          <div class="spw"><em><img src="img/Attila_the_Hun.png" width="50px;" alt="" style="margin-right:20px;">阿提拉：不要搞錯了！：此頁面和<a href="Cavalry_Units.php">騎兵類單位</a>與<a href="Armor_Class_Cavalry.php">騎兵防禦</a>。不同喔！</em>
          </div>
        </div>
        <div class="col-md-8">
          <div class="n1">
            <p>騎兵是帝王時代兵種，可訓練於馬廄，在帝王時代最優勢的兵種之一，對於僧侶、駱駝兵種、長槍兵種較劣勢。</p>
          </div>
           <h3>文明可訓練與否</h3> 
          <div class="hrn1"></div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-remove noc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">不可訓練</span></strong></h4>  <a href="Aztecs.php">阿茲特克</a>、 <a href="Incas.php">印加</a>、 <a href="Indians.php">印度</a>、
                <a
                href="Mayans.php">馬雅</a>、 <a href="Saracens.php">薩拉森</a>。</div>
            </div>
          </div>
           <h3>戰術</h3>
          <div class="hrn1"></div>
          ...
          <table class="table-bordered" width="100%">
           ...
           <h3>剋騎兵的單位與建築</h3> 
          <div class="hrn1"></div>
          <div class="n1">以下單位擁有對騎兵的額外傷害，按照傷殺力排列。
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-6">
          ...
          <div class="n1">
            <ul>
              <li><a href="Berbers.php">柏柏</a>：騎兵在帝王時代便宜15%/20%。</li>
              <li><a href="Burmese.php">緬甸</a>：<a href="Faith.php">忠誠信仰</a>便宜50%。</li>
              <li><a href="Celts.php">賽爾特</a>：只要在一個賽爾特單位的視野下，羊群不會被牽走</li>
              <li><a href="Chinese.php">中國</a>：對騎兵有利的科技研發在帝王時代各便宜15%/20%。</li>
              <li><a href="Franks.php">法蘭克</a>：騎兵血量多20%，研發<a href="Chivalry.php">騎士精神</a>後，
                <a
                href="Husbandry.php">畜牧技術</a>的研發速度和升級<a href="Paladin.php">遊俠</a>的時間都加快40%</li>
              <li><a href="Magyars.php">馬扎爾</a>：免費<a href="Forging.php">鍛造</a>、<a href="Iron_Casting.php">鑄造</a>和
                <a
                href="Blast_Furnace.php">鼓風爐</a>科技</li>
              <li><a href="Portuguese.php">葡萄牙</a>：騎兵黃金成本便宜15%。</li>
          ...
          <div class="n1">
            <ul>
              ...
              <li><a href="Franks.php">法蘭克</a>：騎兵+2視野。</li>
              <li><a href="Huns.php">匈奴</a>：騎兵生產效率和升級快20%，<a href="Bloodlines.php">品種</a>與
                <a
                href="Husbandry.php">畜牧技術</a>研發快20%。</li>
              <li><a href="Persians.php">波斯</a>：騎兵對<a href="Armor_Class_Archer.php">射手類</a>+2攻擊。</li>
              <li><a href="Teutons.php">條頓</a>：騎兵對僧侶抵抗力更強。</li>
            </ul>
          </div>
           <h3>更新日誌</h3>
          <div class="hrn1"></div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/CavalierIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="img/PaladinIcon.jpg" alt=""><a href="Paladin.php">遊俠</a>
              </td>
            </tr>
            <tr>
              <td class="unit3">升級成本</td>
              <td class="unit4">
                <img class="gg" src="img/Paladin-research.jpg" alt="">1300食物750黃金</td>
            </tr>
            <tr>
              <td class="unit3">升級時間</td>
              <td class="unit4">170秒</td>
            </tr>
          </table>
        </div>
      </div>
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            ...
            <div class="col-md-4"> <a href="img/Cavalier.png"><img class="imgn" class="hg" src="img/Cavalier.png" alt=""></a> 
              <p><em>一群騎兵。</em>
              </p>
            </div>
          </div>
