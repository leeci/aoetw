  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>重型弩砲戰船在<a href="Imperial_Age.php">帝王時代</a>時可以在碼頭中被訓練。重型弩砲戰船是海戰的主要輸出，大多數文明都能訓練重型弩砲戰船，但這時數量就很重要了，數量夠多就能夠掌控海上形勢，並能夠快速地殲滅敵方船艦、碼頭，但注意的是重型弩砲戰船很被
              <a
              href="Fire_Galley.php">火戰船</a>克制。</p>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Transport_Ship.php">運輸船</a>、<a href="Fishing_Ship.php">漁船</a>、
                <a
                href="Demolition_Ship.php">神風船</a>、<a href="Cannon_Galleon.php">火炮戰船</a>、在岸邊的建築物和近戰單位。</td>
            </tr>
            <tr>
          ...
          <h3>剋重型弩炮戰船的單位與建築</h3>
          <div class="hrn1"></div>
          <div class="n1">以下單位擁有對重型弩炮戰船的額外傷害，按照傷殺力排列。
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-6">
          ...
          <div class="n1">
            <ul>
              ...
              <li><a href="Persians.php">波斯</a>：重型弩炮戰船訓練的速度在帝王提高20%，研究<a href="Careening.php">傾側維修術</a>和
                <a
                href="Dry Dock.php">旱碼頭</a>的速度快20％。</li>
              <li><a href="Portuguese.php">葡萄牙</a>：重型戰船訓練減少15%黃金成本，重型弩炮戰船+10％HP。</li>
              <li><a href="Saracens.php">薩拉森</a>：重型弩炮戰船攻擊速度提高25%。</li>
              <li><a href="Spanish.php">西班牙</a>：在兵工廠升級有利於重型弩炮戰船的科技不消耗黃金。</li>
              <li><a href="Turks.php">土耳其</a>：<a href="Chemistry.php">化學</a>免費。</li>
              <li><a href="Vikings.php">維京</a>：重型弩炮戰船在帝王時代便宜20%。</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><a href="Japanese.php">日本</a>：重型弩炮戰船擁有+50%的視野距離。</li>
              <li><a href="Malians.php">馬利</a>：研究<a href="Chemistry.php">化學</a>、<a href="Ballistic.php">彈道學</a>的速度提高80%</li>
              <li><a href="Teutons.php">條頓</a>：重型弩炮戰船對招降的抵抗力更強。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          ...
          <div class="n1">
            <ul>
              <li>事實上火炮戰船應該比較適合代表重型弩炮戰船。對重型弩炮戰船更加準確的名字應該是卡拉維爾帆船，後來把卡拉唯爾帆船這個名字給了葡萄牙人成為他們的特殊單位。</li>
              <li>一開始在世紀帝國資料片中重型弩炮戰船在攻擊時會發出跟弩炮一樣的"whoosh"的聲音；不過在征服者入侵資料片後因為遺失了該音源檔所以就再也聽不到這個聲音了。</li>
          ...
          <div class="n1">
            <div class="ien">
              <p>重型弩炮戰船是一艘用於戰爭的帆船，是在西方事件使用大砲之前使用過最大的戰鬥船。這艘龐大而堅固的艦載有大批戰鬥人員，可能還有一些較重的攻城火砲。船員會試圖在戰鬥中登上敵方船隻並試圖奪取該船艦。彈射器或弩弓提供額外的火力。</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#3c763d;;">
                <div class="unititle"><a href="">重型弩砲戰船</a>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/GalleonAoE2.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">除了<a href="Aztecs.php">阿茲特克</a>外的所有文明</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">165</td>
            </tr>
            <tr>
              <td class="unit3">攻擊</td>
              <td class="unit4">8(遠攻)</td>
            </tr>
            <tr>
              <td class="unit3">傷害加成</td>
              <td class="unit4">+11對<a href="Armor_Class_Ship.php">船</a>
                <br>+8對<a href="Armor_class_building.php">建築</a>
        ...
        <div class="col-md-12">
          ...
          <div class="n1">
            <div class="col-md-12">
              ...
              <div class="col-md-4"> <a href="img/Galleon.png"><img class="imgn" class="hg" src="img/Galleon.png" alt=""></a> 
                <p><em>一群重型弩炮戰船。</em>
                </p>
              </div>
              <div class="col-md-4"> <a href="img/GalleonHD.png"><img class="imgn" class="hg" src="img/GalleonHD.png" alt=""></a> 
                <p><em>各種重型弩炮戰船(世紀帝國和征服者入侵資料片)。</em>
                </p>
              </div>
              <div class="col-md-12">
                <div class="col-md-4"> <a href="img/GalleonDLC.png"><img class="imgn" class="hg" src="img/GalleonDLC.png" alt=""></a> 
