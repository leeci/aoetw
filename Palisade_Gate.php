  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>木門是在世紀帝國:失落的帝國資料片中出現的防禦性建築，他可以建在木牆上，可以讓同盟通過同時阻擋敵人。木門在友方單位靠近時會自動開啟讓他們通過，並在門下沒有任何單位時(我方或敵方)關上。為了避免敵方單位尾隨有方單位進門後佔住城門變成防守漏洞，可以將木門鎖定(可再次解鎖)；然而阻擋敵方單位時我方單位也無法通過該木門。</p>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          ...
          <div class="n1">
            <ul>
              <li><a href="Byzantines.php">拜占庭</a>：木門在黑暗/封建/城堡/帝王時代多10%/20%/30%/40%的血量。</li>
              <li><a href="Chinese.php">中國</a>：對木門有利的技術在城堡/帝王時代價格便宜15％/20％。</li>
              <li><a href="Koreans.php">韓國</a>：木門建築速度快33%</li>
              <li><a href="Malians.php">馬利</a>：木門造價便宜15%。</li>
              <li><a href="Spanish.php">西班牙</a>：木門建築速度快30%。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li><a href="Mayans.php">馬雅</a>：木門便宜50%</li>
            </ul>
          </div>
        </div>
        <div class="col-md-4">
