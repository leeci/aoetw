  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>步兵鎖甲可於<a href="Castle_Age.php">城堡時代</a>在<a href="Blacksmith.php">兵工廠</a>研發，可讓步兵護甲+1/+1。</p>
          </div>
           <h3>文明加成</h3> 
          <div class="hrn1"></div>
          <div class="n1">
           ...
           <h3>歷史</h3> 
          <div class="hrn1"></div>
          <div class="n1"> <em>"連接金屬鏈製成的鎖甲是鱗甲的改進。它有更好的一致性，並在受到衝擊時仍舊保有良好的保護作用。 鱗甲在受到衝擊時鱗片可能會鬆動，但鎖甲仍舊可以保持完好。由於鎖鍊比鱗片更小的關係，鎖甲穿起來更加靈活且舒適。不過雖然鎖甲有諸多改進，但製造成本也更加昂貴和耗時。"</em> 
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/Chainmailarmor.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
