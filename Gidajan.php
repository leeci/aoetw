  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>極大汗是個步兵英雄，在"世界地國II:非洲王朝"資料片中的"流亡之路"和"毀壞的石碑"戰役以玩家敵對出現，在地圖編輯器中也能找到他的身影。極大汗是以同名的衣索比亞帝王所命名。他會受到所有步兵科技加成的影響，不能被招降而且會自行回血。</p>
          </div>
          <div></div>
          <div></div>
        </div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><a href="">極大汗</a>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/Gidajanicon.png" width="80" alt="">
                </div>
              </td>
            </tr>
            <tr>
