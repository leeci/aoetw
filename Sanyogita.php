  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>姍優姬妲是一位在布里斯比羅吉第三關：私奔中登場的英雄單位。她的原型是在布里斯比羅吉羅索史詩（Prithviraj Raso）中的同名角色。</p>
            <p>在遊戲中，姍優姬妲以皇后的外表登場。跟皇后一樣，她無法進行攻擊。作為一個英雄單位，她無法被招降且會自動回血。</p>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><a href="">姍優姬妲</a>
                </div>
              </td>
            </tr>
            <tr>
