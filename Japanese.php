  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>日本在世紀帝國中是個相對"年輕"的民族，日本的封建制度開始於11世紀左右，相對其他遊戲種族來說更晚。</p>
            <p>自古以來，步兵(不論是輕裝的槍兵或是重裝的武士)佔有日本軍隊的比例相較其他文明來說高了許多，自然而然，遊戲中他也被分類為步兵文明。</p>
            <p>日本自上古時代開始就不停地吸收他國文化並轉化為自己的優勢，這或許能解釋他在遊戲中相對平衡的科技樹。</p>
            <p>縱然日本歷史一直是很迷人且被大多數遊戲引用，但是不得不承認，日本在中世紀與近現代是相對落後西方國家的。</p>
          </div>
          <h3>文明概要</h3>
          <div class="hrn1"></div>
          <div class="n1">
          ...
          <div class="n1">
            <ul>
              <li>漁船生命值+100%，遠程裝甲+2，工作速度於黑暗時代+5%，封建時代+10%，城堡時代+15%，帝王時代+20%(互不疊加)</li>
              <li>伐木場，採礦營地，磨坊的建築成本減少50%</li>
              <li>步兵攻擊速度在封建時代提升10%，城堡時代提升15%，帝王時代則是25%</li>
          ...
          <div class="n1">
            <ul><strong>優勢</strong> 
              ...
              <li>日本的射箭場與兵工廠科技齊全，所以遠程的火力也有保證。</li>
              <li>由於團隊加成，日本與隊友可以在前期取得極大的海上發展優勢。</li>
              <li>日本的僧侶科技只缺異端邪說，這代表僧侶的戰術是可行的。</li>
              <li>日本的文明加成讓他可以在遊戲初期省下不少木材，搭配上漁船的加成，可以說是有十分好的前期經濟。</li>
            </ul>
            <ul><strong>劣勢</strong> 
              <li>強大步兵的代價就是虛弱的騎兵，沒有遊俠、匈牙利輕騎兵與駱駝，所以日本面對長距離的攻城武器會很吃力(比方投石車或弩砲)。</li>
              <li>沒有火炮，這讓日本更加害怕投石車。</li>
              <li>沒有駱駝，所以難以追擊敵人的騎兵，縱然在白刃戰中靠著強大的長槍兵系拔得頭籌，但是面對騎兵游擊戰術會顯得非常吃虧。</li>
              <li>日本主要部隊都是步兵，所以火藥單位對於日本來說是極大的威脅。</li>
              <li>前期的經濟是好的，但是後期的日本由於大量使用步兵，加上缺少輪耕科技，可能會有食物不夠用的窘況。</li>
              <li>日本的攻城武器是相當平庸的，需要謹慎考慮投資。</li>
              <li>日本是沒有火炮塔的，所以遭到大量如精銳鷹勇士或哥德衛隊這樣的高遠程裝甲單位突襲基地，可能會有嚴重後果。</li>
            </ul>
            ...
            <ul>
              <li>日本是個前期種族，在封建時代是特別強大的，把基地圍好並且生產遠程兵種來反制。</li>
              <li>城堡時代的日本比較不那麼強勢，但是這個階段的日本擁有不錯的騎兵，最好能夠鞏固防守直到後期。</li>
              <li>由於日本主打步兵，石牆加上投石車是很有效的。</li>
              <li>善用投石車與火藥部隊來抗擊日本的精良步兵。</li>
              <li>由於日本沒有騎兵，在面對騷擾型的戰術會很吃力。</li>
              <li>面對日本時，火炮塔是個好的防禦手段。</li>
