  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>世界奇觀能在帝王時代建造。而在某些模式下，守護奇觀達到遊戲時間200年即可獲得勝利。</p>
            <p>每個文明的世界奇觀都有獨特造型，而它們全部都跟該文明的歷史息息相關。</p>
          </div>
          <h3>概要</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li>世界奇觀可以在任何模式裡面建造，但是只有在特定遊戲模式中會導致世界奇觀勝利。</li>
              <li>當一個玩家開始建立世界奇觀時，遊戲會自動送出消息通知所有玩家，且會直接標記出位置，以便其他玩家攻擊。</li>
              <li>紀念碑，是一個跟世界奇觀長的一樣的建築，但是只能在地圖編輯器或是特定遊戲模式或戰役裡找到，有9999點生命值，且每個文明的紀念碑都跟奇觀長的一樣。</li>
              <li>世界奇觀建造時間非常長，沒有踏輪起重機的狀況下，單獨一名村民建造世界奇觀的時間是58.5分鐘。就算有30名村民也要至少5分鐘的時間才能建築完成。</li>
              <li>你可以建造一個以上的世界奇觀，他們長的一樣，但是要注意，每個世界奇觀的倒數計時是分開計算的，舉個例子：一名玩家建立了世界奇觀A，並在遊戲時間50年後建立世界奇觀B，建立了B之後又過了50年，世界奇觀A被摧毀了，倒數計時會從剩餘100年跳回剩餘150年(也就是世界奇觀B的倒數計時)。</li>
            </ul>
          </div>
          <h3>戰術與位置</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li>世界奇觀勝利可以說是防禦性文明的專利，若你是個擅長進攻的文明譬如馬札爾，那還是直接消滅敵人比較快。</li>
              <li>最好能先建立陣地，以及一支可靠的軍隊，然後再開始建築世界奇觀，因為一旦開始建築，敵人很可能立刻發兵攻擊你。</li>
              <li>城牆可以有效的保護世界奇觀，多建立幾層的城牆只有好處，但是至少要留幾格空間以放置幾個村民，以免被損傷的世界奇觀沒有辦法修復。</li>
              <li>世界奇觀最好建立在高地，以防止敵軍用高低差優勢對世界奇觀造成更多傷害。</li>
              <li>如果你有強大的海軍防衛(比如中國的神風船或西班牙的火炮戰船)，則選擇在海島上建築奇觀也是很不錯的選擇。</li>
              <li>黑森林等地圖尤其適合世界奇觀，但是要小心敵人用重型投石車切穿樹林進攻。</li>
              <li>如果可以，把世界奇觀對敵軍的出入口減少，並且集中你的部隊在出入口。</li>
              <li>通常你需要大量的攻城武器來防禦世界奇觀，若你的攻城武器真的不行，那還是換種勝利方式吧。</li>
            </ul>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          ...
          <table class="table-bordered" width="100%">
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
                <div class="unititle"><font color="black">劣勢與優勢</font>
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="tta4">所有單位。</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
                <div class="unititle"><font color="black">升級</font>
                </div>
              </td>
            </tr>
            <tr>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">5x5</td>
            </tr>
            <tr>
              <td class="unit3">血量</td>
              <td class="unit4">4800</td>
            </tr>
            <tr>
        ...
        <div class="row" style="">
          <div class="col-md-12">
            ...
            <div class="n1">
              <ul>
                <li><a href="Byzantines.php">拜占庭</a>：世界奇觀的生命值+40%。</li>
                <li><a href="Chinese.php">中國</a>：在帝王時代，對世界奇觀有加成的科技價格便宜20％。</li>
                <li><a href="Incas.php">印加</a>：世界奇觀成本減少15%石頭。</li>
                <li><a href="Malians.php">馬利</a>：世界奇觀成本減少15%木材。</li>
              </ul>
            </div>
            <h3>團隊加成</h3>
            <div class="hrn1"></div>
            <div class="n1">
              <ul>
                <li><a href="Malians.php">馬利</a>：研究<a href="Treadmill_Crane.php">踏輪起重機</a>，
                  <a
                  href="Architecture.php">建築學</a>和<a href="Treadmill_Crane.php">踏輪起重機</a>科技的團隊速度提高80%。</li>
              </ul>
            </div>
            <h3>更新日誌</h3>
            <div class="hrn1"></div>
            <div class="n1">
              ...
              <ul>
                <li><a href="Indians.php">印度</a>的世界奇觀是Gol Gumbaz。</li>
              </ul>
              <h3><em><a href="aof.php">王者崛起</a></em></h3>
              <ul>
                <li><a href="Indians.php">印度</a>現在的世界奇觀是布里哈迪希瓦拉神廟，Gol Gumbaz還是可以在戰役編輯器中找到。</li>
              </ul>
            </div>
            <h3>趣事</h3>
            <div class="hrn1"></div>
            <div class="n1">
              <ul>
                <li>世界奇觀不屬於標準建築的防禦類型，而這樣的建築只有兩個，漁網跟世界奇觀。</li>
                <li>在世紀帝國II裡的所有單位、科技、建築，只有世界奇觀是需要三種不同資源的。</li>
                <li>不列顛的世界奇觀原型是在德國，且當時是查理曼大帝的行宮，也就是說這是一個在德國境內為了法國國王建造的教堂。</li>
                <li>拜占庭的世界奇觀，聖索菲亞大教堂，相比現實建築之所以少了四根尖塔，是因為當時拜占庭帝國並不是伊斯蘭教，沒有那四根尖塔，尖塔是由鄂圖曼土耳其帝國的歷任蘇丹慢慢加上去的。</li>
                <li>比起沙特爾主教座堂，巴黎聖母院或許更能勝任法蘭克的世界奇觀，雖然巴黎聖母院其實算是哥德式建築，但是哥德式這個詞其實是在近代出現的，在此之前的哥德式建築稱為法國式建築。</li>
                <li>東大寺至今仍是世界上最大的單一木造建築物(木造建築群則是紫禁城)。</li>
                <li>成吉思汗的金帳其實不如想像中宏偉，蒙古是遊牧民族，而巨大的金帳只會造成行軍不便罷了。</li>
                <li>波斯的世界奇觀其實是長方形，而非遊戲中的正方形。</li>
                <li>薩拉森的世界奇觀，薩邁拉大清真寺，曾在2005年遭受炸彈攻擊炸毀部分塔頂，據說是跟美軍曾經使用這地方作為瞭望台有關。</li>
                <li>條頓的世界奇觀是個修道院，而非馬爾堡城堡這個歷史悠久且由條頓騎士親手建造的城堡，這是很奇怪的，畢竟條頓騎士團曾在中世紀以強大的戰鬥力揚名立萬，而馬爾堡城堡是他們的指揮中心。</li>
                <li>距離最近的世界奇觀為拜占庭的聖索菲亞大教堂與土耳其的蘇丹艾哈邁德清真寺，兩者相距僅500公尺。</li>
                <li>阿茲特克的世界奇觀，特诺奇蒂特兰大金字塔，頂上有兩座神廟，一座代表雨神，一座代表戰神，中間有活人祭祀用的石台。大部分祭品都是戰俘，這點引起鄰國不滿，間接導致阿茲特克的滅亡。</li>
                <li>匈奴人不需要房子，連遊戲都這麼說，可是匈奴卻有世界奇觀可以建造，而且根本跟匈奴一點關係沒有(撐死來說，是被他們征服文明的世界奇觀)。</li>
                <li>瑪雅的世界奇觀更像是把大美洲豹神廟跟面具神廟融合起來的產物。</li>
                <li>西班牙的黃金塔，作用是保護西班牙珍寶船隊(從美洲運送奢侈品的船隊，黃金塔也得名於此)，實際上沒有遊戲中這麼宏偉。</li>
                <li>沒有人知道馬丘比丘到底是怎麼建造的，印加人有輪子，但是不用，且每個石頭都緊密契合，連匕首都插不進去，這種高工藝技術使的印加文化留下了深深的謎團。</li>
                <li>很神奇的，印度的世界奇觀不是泰姬瑪哈陵，這是因為泰姬瑪哈陵是出於穆斯林之手，比起神廟或是陵墓，印度文化的元素更少。</li>
                <li>斯拉夫的世界奇觀是不合時宜的，基日島木教堂其實建構於17世紀，若要說哪個更適合斯拉夫，聖母升天大教堂、費拉邦多夫修道院以及古克里姆林宮可能更加合適(克里姆林宮以前曾是石灰石城堡)。</li>
                <li>衣索比亞是中世紀非洲少數的基督教國家，該國基督教歷史可以追溯至舊約聖經列王紀上第十章，示巴女王為了聽取所羅門王的智慧來到以色列，帶回了基督教文化的前身：猶太信仰，而新約聖經使徒行傳第八章也提到有衣索匹亞的太監來聽基督的福音。</li>
                <li>馬利的世界奇觀也是不合時宜的，傑內大清真寺雖然確實是是13世紀馬利的建築，但是現在的清真寺其實是1907年重建的，真正的古清真寺可能不是這個模樣。</li>
                <li>緬甸的瑞西貢佛塔，是真正意義上的金碧輝煌，整個佛塔是用金箔貼上的(真有錢)。</li>
                <li>高棉是古稱，現在叫做柬埔寨，而吳哥窟就在柬埔寨的國旗上。</li>
                <li>最大的世界奇觀是法蘭克的沙特爾主教座堂，而最小的是狄奧多里克陵墓，但以建築群來說，是高棉的吳哥窟最大。</li>
                <li>建立最早的世界奇觀是匈奴的君士坦丁凱旋門，最晚的是馬利的傑內大清真寺，兩者建造時間差距近1600年。但若以原始建築來說，最晚的是斯拉夫基日島的木結構教堂，但也差距了近1400年。</li>
              </ul>
            </div>
          </div>
          <div class="col-md-12">
            ...
            <div class="col-md-4">
              ...
              <p>登場戰役：征服者的戰役-亞琴哥特(1415)、阿提拉6-羅馬的衰落</p>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              ...
              <p>登場戰役：沙拉丁6-獅子與惡魔、法蘭西斯科．阿爾梅達3-帝國的廢墟</p>
            </div>
            <div class="col-md-4">
              ...
              <p>登場戰役：沙拉丁5-聖戰、成吉思汗6-蒙古治下的和平、巴巴羅薩4-倫巴聯盟、阿提拉6-羅馬的衰落</p>
            </div>
            <div class="col-md-4">
              ...
              <p>登場戰役：沙拉丁1-阿拉伯騎士、席德4-黑衛隊、布里斯比羅吉4-塔蘭村之戰</p>
            </div>
            <div class="col-md-4">
              ...
              <div class="hrn1"></div>
              <p>位於現今挪威萊達爾博爾貢，建於1180年到1250年間，為挪威28座木教堂裡保存最好的一座，現在不再是教堂，而是博物館。</p>
            ...
            <div class="col-md-4">
              ...
              <div class="hrn1"></div>
              <p>位於現今墨西哥墨西哥市，僅存地基，1325年開始修建，1487年最後一次擴建時的獻祭殺死了至少2000人作為祭品。毀於1521年西班牙征服者的入侵。</p>
              <p>登場戰役：蒙特蘇馬6-斷矛、失落帝國的戰役-雙柱城(648)</p>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              ...
              <p>登場戰役：松迪亞塔5-深入虎穴、法蘭西斯科．阿爾梅達3-帝國的廢墟</p>
            </div>
            <div class="col-md-4">
              ...
              <p>登場戰役：法蘭西斯科．阿爾梅達4-葡屬印度、法蘭西斯科．阿爾梅達5-兒子的血仇、勃印曩5-鳳凰涅槃</p>
            </div>
            <div class="col-md-4">
              ...
              <p>登場戰役：勃印曩2-猛蛇出洞、勃印曩3-百鳥朝鳳、勃印曩5-鳳凰涅槃</p>
            </div>
            <div class="col-md-4">
              ...
              <p>登場戰役：蘇利耶跋摩一世5-千古偉業、勃印曩1-餓虎撲食</p>
            </div>
            <div class="col-md-4">
