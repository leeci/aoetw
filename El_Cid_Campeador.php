  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p><strong>羅德里高-迪亞茲-熙德</strong>是《世紀帝國 II HD: 征服者入侵》席德戰役系中的主角，他也能在戰役編輯器中使用。由於他屬於英雄單位，因此不能被招降且會回血
              。</p>
            <p></p>
          </div>
          <div></div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><a href="">羅德里高-迪亞茲-熙德</a>
                </div>
              </td>
            </tr>
            <tr>
