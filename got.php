...
and (max-device-width: 480px)  {
  ...
  <body style=" font-family: " 微軟正黑體 ";">
    ...
    <tr>
      ...
      <td class="t13 trm">
        <img class="gg" src="img/HuskarlIcon.jpg" width="30" alt="">
        <div><a href="Huskarl.php">哥德衛隊</a>
        </div>
      </td>
      <td class="t13 trm">
      ...
      <td class="t13 trm">
        ...
        <div><a href="Anarchy.php">無政府狀態</a>
        </div>
      </td>
      <td class="t13 trm"></td>
      <td class="t13 trm"></td>
    ...
    <tr>
      ...
      <td class="t13 trm">
        <img class="gg" src="img/HuskarlIcon.jpg" width="30" alt="">
        <div><a href="Huskarl.php">精銳哥德衛隊</a>
        </div>
      </td>
      <td class="t13 trm">
      ...
      <td class="t13 trm">
        ...
        <div><a href="Perfusion.php">灌注士氣</a>
        </div>
      </td>
