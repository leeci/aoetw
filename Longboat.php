  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>維京大戰船是<a href="Vikings.php">維京</a>的第二個特殊單位，在<a href="Castle_Age.php">城堡時代</a>的
              <a
              href="Dock.php">碼頭</a>可以訓練。它是一艘會射出多重箭矢的戰船。</p>
            <p>維京大戰船可在<a href="Imperial_Age.php">帝王時代</a>升級為精銳維京大戰船。</p>
          </div>
           <h3>戰術</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <p>維京大戰船與<a href="Chu_Ko_Nu.php">中國連弩兵</a>一樣會在一次攻擊中射出多重箭矢，而且只有第一發箭能有弓兵科技的加成而且是完整傷害，其他箭都只有1的遠程傷害。維京大戰船無論精銳與否每次攻擊都是射四支箭。與
              <a
              href="Chu_Ko_Nu.php">中國連弩兵</a>不同的維京大戰船是在同一時間發射所有箭，而不是快速連續發射。由於世界帝國II中護甲和傷害的計算後面的三發箭矢會對單位造成額外+3傷害。維京大戰船可以戰勝
                <a
                href="War_Galley.php">弩炮戰船</a>，精銳維京大戰船可以戰勝<a href="Galleon.php">重型弩砲戰船</a>(險勝)。維京大戰船建造速度比大多數的戰艦快，而複數數量的維京大戰船可以有效對付敵方艦隊。</p>
            <p>維京大戰船很怕岸邊的<a href="Mangonel.php">投石車</a>和<a href="Bombard_Cannon.php">火炮</a>，所以他們最好保持距離或是用速度閃過攻擊。
              <a
              href="Turtle_Ship.php">龜甲船</a>的高護甲對維京大戰船也是個麻煩，但如果有細微的操作而且龜甲船的數量不多，維京大戰船還是能應付他們。<a href="Fire_Ship.php">火戰船</a>是反制維京大戰船的首選。</p>
          ...
          <div class="n1">
            <ul>
              ...
              <li>維京大戰船開火速率比重型弩炮戰船慢，不過單次攻擊的投射物比較多。</li>
              <li>範圍、攻擊、視野跟護甲兩者都一樣，不過重型弩炮戰船比維京大戰船多5HP。</li>
              <li>精銳維京大戰船的造價比重型弩炮戰船貴，即便是非精銳維京大戰船也比不上。另外升級精銳維京大戰船的成本也比升級成重型弩炮戰船貴。</li>
              <li>精銳維京大戰船跟重型弩炮戰船單挑時精銳維京大戰船會以些微差距獲勝。</li>
              <li>維京大戰船在破壞建築跟攻擊陸上單位的命中率上比重型弩炮戰船好。</li>
              <li>整體來說精銳維京大戰船比重型弩炮戰船表現更加(特別是速度)，不過考慮到訓練成本時他們的價值其實大致相同。</li>
            </ul>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Transport_Ship.php">運輸船</a>、<a href="Fishing_Ship.php">漁船</a>、
                <a
                href="bulding.php">建築物</a>、在岸邊和淺灘的陸地單位、<a href="Cannon_Galleon.php">火炮戰船</a>、<a href="Galleon.php">重型弩炮戰船</a>。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><a href="Fire_Ship.php">火戰船</a>、<a href="Turtle_Ship.php">龜甲船</a>、<a href="Samurai.php">日本武士</a>(在淺灘處)；箭塔、
                <a
                href="Castle.php">城堡</a>、在岸邊的遠距攻城單位。</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
          ...
          <div class="n1">
            <ul>
              <li><a href="Vikings.php">維京</a>：維京大戰船訓練的費用在城堡/帝王減少15%/20%。</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li><a href="Teutons.php">條頓</a>：維京大戰船對招降的抵抗力更強。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          ...
          <div class="n1">
            <div class="ien">
              <p>9至11世紀的維京海盜特別恐怖，因為他們可能沿著海岸甚至上游的任何地方發動攻擊，他們有這種能力得益於他們的維京大戰船，這些船很長，窄，吃水很淺，但令人驚訝地是非常適合航行，他們用槳和一個方形帆作為推進力，維京大戰船可以進入很淺的水域並靠岸，只有高懸崖峭壁或岩石的海岸對當時的船員來說才是安全的。</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/LongboatIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="img/LongboatIcon.jpg" alt="">精銳維京大戰船</td>
            </tr>
            <tr>
