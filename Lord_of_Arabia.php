    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>
              <p>阿拉伯之主為沙拉丁戰役的第二關劇情關卡，此關描述法國十字軍騎士沙底隆的雷諾襲擊紅海的戰役。</p>
          </div>
          <h2>玩家</h2>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <table class="table-bordered" width="100%">
              ...
              <tr>
                ...
                "></div>玩家2：</td>  <td class="tc6 " width="35% ">麥地那（橘色）薩拉森 </td>  <td class="tc6 " width="15% "">
                  <div class="p4"></div>玩家3：</td>
                <td class="tc6" width="35%">阿魁巴（黃色）薩拉森</td>
              </tr>
              <tr>
            ...
            <div class="n1">
              <ol>
                <li>要打敗雷諾的武士、強盜、和海盜，以防止他們破壞你同盟的城鎮中心。</li>
          ...
          <div class="n1">
            <ul>
              ...
              <li>保持你與同盟國之間的貿易路線暢通，他們將會酬謝你。並指派單位去護衛同盟國的貿易車隊。</li>
            </ul>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#375d96;">
                <div class="unititle"><a href="">阿拉伯之主</a>
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4"> <a href="An_Arabian_Knight.php">阿拉伯騎士</a> 
            </tr>
            <tr>
