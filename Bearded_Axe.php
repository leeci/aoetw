  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>倒鉤斧是<a href="Franks.php">法蘭克</a>的特殊科技，可於<a href="Imperial_Age.php">帝王時代</a>在
              <a
          ...
          <div class="n1">
            <ul>
              <li>雖然攻擊範圍+1看起來微不足道，倒鉤斧可以讓擲斧兵在遠程戰鬥中更加彈性化，因為法蘭克人無法訓練<a href="Arbalest.php"></a>強弩兵，弓兵的科技樹也很差。
                特別是在暴民和“stand ground”模式下，擲斧兵可以更容易地消滅<a href="Infantry_Units.php">步兵</a>甚至
                <a
                href="Cavalry_Units.php">騎兵</a>。</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
          ...
          <div class="n1">
            <p>的名字來源於刀片尾端延長的長度，使得刀片比它與柄部的連接長得多。這把斧頭是弗朗西斯卡斧頭的進一步發展，弗朗西斯卡是法蘭克人被稱為法蘭克的原因。
              倒鉤斧可能會丟出或拿著使用。在法蘭克人發展騎兵之前，他們進行團體戰鬥。當他們接近敵人時，前排隊員會朝敵人投擲斧頭。這些會造成敵人混亂跟一些人員傷亡，並讓他們被困在自己的盾牌後面，動作也變得笨拙。法蘭克人這時會迅速接近並用額外的斧頭或劍擊殺敵人。</p>
          </div>
        </div>
        <div class="col-md-4">
