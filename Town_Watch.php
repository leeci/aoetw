  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>城鎮瞭望可於<a href="Feudal_Age.php">封建時代</a>在<a href="Town_Center.php">城鎮中心</a>研發。研發後建築物視野+4。</p>
          </div>
           <h3>文明加成</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><a href="Byzantines.php">拜占庭</a>：該科技免費。</li>
              <li><a href="Chinese.php">中國</a>：該科技在封建/城堡/帝王時代花費便宜10%/15%/20%。</li>
              <li><a href="Persians.php">波斯</a>：研究<a href="Town_Watch.php">城鎮瞭望</a>的時間在封建/城堡/帝王時代快10%/15%/20%。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li><a href="Byzantines.php">拜占庭</a>:跟其他文明一樣需要研發城鎮瞭望。</li>
            </ul>
            <h3><em><a href="aoc.php">征服者入侵</a></em></h3>
            <ul>
              <li><a href="Byzantines.php">拜占庭</a>:1.0c改版後免費獲得城鎮瞭望。</li>
            </ul>
          </div>
          <h3>歷史</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <p>每個城鎮和社區在中世紀的大部分時間依靠當地的領主和他的士兵們來保護他們，常常會有土匪，掠奪者或不友善的鄰近村莊會襲擊村子。城鎮瞭望可以定期對附近的鄉村進行監視，如果有危險發生可以馬上通報讓城鎮有時間準備防禦措施。</p>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#31b0d5;">
                <div class="unititle"><a href="">城鎮瞭望</a>
                </div>
              </td>
            </tr>
            <tr>
