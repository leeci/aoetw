    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          ...
          <div class="hrn1"></div>
          <div class="n1">
            <p>塔攻在國際玩家間非常流行，也歷久不衰，塔攻的變化非常多，可以搭配很多兵種組合，而這邊講的是純塔攻，一般來說純塔攻少了其他兵種的掩護，可能會比較危險，但卻可以有更多的村民去蓋塔，家裡也更多的人挖石頭，箭塔將一隻一隻地蓋。且塔攻升級會比一般升級還快，一般正常封快約21~22P，純塔攻要要20P才會有威力。塔攻講求控制力、反應力與手速，手速快的玩家才能在對方村民來拆塔時，立刻蓋起木牆防禦。</p><strong><span class="glyphicon glyphicon-plus" aria-hidden="true" style=" color: #3c763d; margin-right: 5px; "></span>什麼時候可以打塔攻</strong>
            <ul>
              <li>對手地形不好時:如果對手黃金石頭甚至木材都在外面，那不用懷疑，塔攻是很好的選擇。</li>
              <li>你選到塔攻文明時:西班牙與韓國都是相當典型的塔攻文明，不塔攻很可惜。</li>
            </ul><strong><span class="glyphicon glyphicon-plus" aria-hidden="true" style=" color: #3c763d; margin-right: 5px; "></span>什麼時候不要打塔攻</strong>
            <ul>
              <li>對手地形很好時:塔不到東西的情況下，經濟將會慢慢被拉開。</li>
              <li>正式比賽時:塔攻風險高，大型比賽較不容易看到。</li>
            </ul><strong><span class="glyphicon glyphicon-plus" aria-hidden="true" style=" color: #3c763d; margin-right: 5px; "></span>插塔的地點</strong>
            <ul>
              <li>首選石頭區，因為塔攻最好用塔防。</li>
              <li>任何點都可以，那怕是兩塊田，有塔到就是賺了。</li>
            </ul>
          </div>
          <h3>反制</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <p>塔攻一般來說只要第一隻塔沒有起來，那麼便沒有威力，所以不斷的擴大視野向外探索，找到對方前置村民，用村民與民兵斥侯等予以殲滅，那麼塔攻就會失敗。如果發現對方起塔了，請務必立刻去挖石頭與研發城鎮視野，因為最好防塔的方法就是塔守。如果前方守住了，那麼對方經濟便跟不上你，他家裡空虛，生產一隊斥侯或小弓將可帶來可怕的破壞。</p>
          </div>
          <h3>流程</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <div class="n1">一般來說，所有文明都適合，但以下文明更適合一點。
              <ul>
                ...
                <li>西班牙:建築快30%，對塔很有優勢，存的石頭也可以上城堡出征服者。</li>
                <li>印加:暴力塔、經濟強、村民厚、石頭省、鷹勇遠，延伸閱讀<a href="https://www.ptt.cc/bbs/AOE/M.1541222470.A.E27.html">鉛筆塔。</a></li>
                <li>蒙古:升級相當快速。</li>
                <li>條頓:箭塔可以駐紮10個人。</li>
                <li>馬來:升級比蒙古還快</li>
              </ul>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">幾乎任何文明可用</td>
            </tr>
            <tr>
              <td class="unit3">缺點</td>
              <td class="unit4">吃運氣地形</td>
            </tr>
          </table>
