  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p><strong>破壞者</strong>是《世紀帝國 II HD: 帝王世紀》中的一名透過作弊換得的自殺英雄，只能在戰役編輯器中找到或是透過輸入作弊密碼"to
              smithereens"破壞者就會出現在玩家的城鎮中心旁邊，它也會出現在成吉思汗第五戰役"蒙古治下的和平"。破壞者比一般的爆炸桶移動速度更快，對建築物的傷害力也更強。它的外觀是爆炸桶，由於他屬於英雄單位，因此不能被招降且會回血(在征服者資料片後)。</p>
            <p></p>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><a href="">破壞者</a>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/Saboteuricon.png" width="80" alt="">
                </div>
              </td>
            </tr>
            <tr>
