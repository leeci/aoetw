  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-12">
          <div class="n1">
            <p>傭兵護甲是一個在5.7版<a href="aor.php">《世紀帝國II:王者崛起》</a>新增的防禦裝甲類別，所有在這個系列的兵種都會被剋該護甲的兵種有額外的傷害。</p>
            <p>傭兵的定位是反火藥單位，所以ㄧ開始有10的步兵裝甲去抵消<a href="Hand_Cannoneer.php">火槍兵</a>對步兵單位+10的攻擊加成，可是這樣也讓傭兵對其它反步兵單位例如
              <a
