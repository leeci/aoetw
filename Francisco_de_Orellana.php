  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p><strong>法蘭切斯科-德-奧雷亞納</strong>是《世紀帝國 II HD: 失落的帝國》中的一名英雄，他是以一位西班牙探險家和征服者為基礎的，該名探險家以在亞馬遜河上航行並在厄瓜多爾建立定居點而聞名。在戰役"黃金國"系列中法蘭切斯科-德-奧雷亞納都是主角，他擁有征服者的外觀，並受所有騎兵和火藥科技的加成影響。由於他屬於英雄單位，因此不能被招降且會回血
              。</p>
            <p></p>
          </div>
          <div></div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><a href="">法蘭切斯科-德-奧雷亞納</a>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/Franciscodeorellanaicon.png" width="80" alt="">
                </div>
              </td>
            </tr>
            <tr>
