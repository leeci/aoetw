  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>羅馬軍團隨時殺到為阿拉里克戰役的第二關劇情關卡，在這關故事中，這是關於阿拉里克發現羅馬皇帝霍諾留·奧古斯都背叛他背後的援軍，因此決心反抗羅馬皇帝。</p>
          </div>
          <h2>玩家</h2>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <table class="table-bordered" width="100%">
              ...
              <tr>
                ...
                ">  <ul>    <li>阿拉里克已經在地圖中間搭建了營地，他只等著皇帝批准他們進入新領地。在阿拉里克營地的西邊有2個善良的村民(灰色)。他們手無寸鐵，但卻能給你一些很好的策略建議。</li><li>作為阿拉里克的左膀右臂，阿陶爾夫(綠色)在東邊搭建他了營地，必要的時候可以協助你你的敵人是那些遍佈地圖的羅馬軍團(紅色和黃色)</li></ul><h2>戰術</h2><div class="hrn1 "></div><div class="n1
                ...
                ">弗拉維烏斯·奧古斯都·霍諾留</a></b></i></div></div>  </div></div>      </div>    <!-- /container --><?php include("allbatt.php "); ?><?php include("foot.php "); ?></body></html>