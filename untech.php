    ...
    <div class="container" style="margin-top:50px">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <p>如要觀看一般科技請見:<a href="tech.php">科技總攬</a>
          </p>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          ...
          <table class="table-bordered table-striped" width="100%">
            ...
            <tr>
              ...
              <td class="tunitc6"><a href="Skirmisher.php">矛兵系列</a>和<a href="Genitour.php">標槍騎兵</a>的攻擊和攻擊範圍+1。</td>
            </tr>
            <tr>
              <td class="tunitc6">
            ...
            <tr>
              ...
              <td class="tunitc5">300W 400F</td>
              <td class="tunitc6"><a href="Battle_Elephant.php">矛象伕</a>護甲+1/+1。</td>
            </tr>
            <tr>
              <td class="tunitc6">
              ...
              <td class="tunitc6"><a href="Fire_Ship.php">火戰船</a>+1攻擊範圍。</td>
            </tr>
            <tr>
              <td class="tunitc6">
              ...
              <td class="tunitc5">250F 200G</td>
              <td class="tunitc6">城堡和箭塔開火速率快25%。</td>
            </tr>
            <tr>
              <td class="tunitc6">
            ...
            <tr>
              ...
              <td class="tunitc6">箭塔可發射額外兩支箭。</td>
            </tr>
            <tr>
              <td class="tunitc6">
            ...
            <tr>
              ...
              <td class="tunitc6">僧侶招降速度變快(對單位時間-1，對建築物時間-7)。</td>
            </tr>
            <tr>
              <td class="tunitc6">
            ...
            <tr>
              ...
              <td class="tunitc6">步兵對<a href="Armor_Class_Cavalry.php">騎兵</a>攻擊+5，對<a href="Armor_Class_Camel.php">駱駝騎兵</a>攻擊+4。</td>
            </tr>
          </table>
           <h3><a href="">帝王時代</a></h3> 
          <div class="hrn1"></div>
          <table class="table-bordered table-striped" width="100%">
            ...
            <tr>
              ...
              <td class="tunitc6"><a href="Infantry_Units.php">步兵</a>攻擊+4。</td>
            </tr>
            <tr>
              <td class="tunitc6">
            ...
            <tr>
              ...
              <td class="tunitc6"><a href="Cavalry_Units.php">騎兵單位</a>和<a href="Arambai.php">飛鏢騎兵</a>對
                <a
                href="Armor_class_building.php">建築物</a>和<a href="Armor_class_standard_building.php">標準建築</a>攻擊+3。</td>
            </tr>
            <tr>
              <td class="tunitc6">
              ...
              <td class="tunitc6">拜占庭聖騎兵有踐踏傷害，對<a href="Infantry_Units.php">步兵</a>攻擊+6。</td>
            </tr>
            <tr>
              <td class="tunitc6">
              ...
              <td class="tunitc6"><a href="Siege_Workshop.php">攻城器製造所</a>的單位+40% HP。</td>
            </tr>
            <tr>
              <td class="tunitc6">
              ...
              <td class="tunitc6"><a href="Chu_Ko_Nu.php">中國連弩兵</a>攻擊+2，<a href="Scorpion.php">弩炮</a>攻擊+4。</td>
            </tr>
            <tr>
              <td class="tunitc6">
            ...
            <tr>
              ...
              <td class="tunitc6">遺跡和世界奇觀的勝利時間延長100年，間諜/叛徒花費-50%。</td>
            </tr>
            <tr>
              <td class="tunitc6">
            ...
            <tr>
              ...
              <td class="tunitc6">玩家和同盟立即獲得500黃金。</td>
            </tr>
            <tr>
              <td class="tunitc6">
              ...
              <td class="tunitc6">狂戰士回血速度提升(每分鐘回20 HP變每分鐘回40 HP)。</td>
            </tr>
          </table>
