  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p><strong>桑喬國王</strong>是《世紀帝國 II HD: 征服者入侵》中的一名英雄，也出現在戰役"兄弟鬩牆"與他的兄弟阿方索對決，他同樣能在戰役編輯器中使用。桑喬國王不能攻擊，但移動速度快而且有很大的視野範圍。由於他屬於英雄單位，因此不能被招降且會回血
              。</p>
          </div>
          <div></div>
          <div></div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><a href="">桑喬國王</a>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/Kingsanchoicon.png" width="80" alt="">
                </div>
              </td>
            </tr>
            <tr>
