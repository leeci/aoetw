...
<html lang="zh-tw">
  ...
  <body>
    ...
    <div class="container" style="margin-top:50px">
      ...
      <div class="row">
        <div class="col-md-12">
          <p>英雄是帝國時代II的特殊單位。 在常規遊戲中不可用，英雄通常指的是歷史人物。因此，他們經常在戰役場景中出現。在那裡，他們往往是必須生存的單位，即他們的死亡意味著失敗。在征服者資料片之後所有英雄都不能被招降，並獲得回血的能力。英雄往往有獨特的外貌，有時甚至有獨特的單位設定，他們通常有很好的戰鬥屬性，這使他們在遊戲中非常有價值。</p>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="tunitcc" style="width: 20%;">名稱</td>
              <td class="tunitcc" style="width: 15%;">類型</td>
              <td class="tunitcc" style="width: 15%;">外貌</td>
              <td class="tunitcc" style="width: 55%;">登場戰役</td>
            </tr>
            <tr>
              <td class="tunitc6">
            ...
            <tr>
              ...
              <td class="tunitc6"><a href="The_Saxon_Revolt.php">撒克遜起義</a>
              </td>
            </tr>
            <tr>
              <td class="tunitc6">
              ...
              <td class="tunitc4">步兵</td>
              <td class="tunitc6">擲斧兵</td>
              <td class="tunitc6"><a href="Tours(732).php">都爾(732)</a>
              </td>
            </tr>
            <tr>
              <td class="tunitc6">
            ...
            <tr>
              ...
              <td class="tunitc6"><a href="The_Emperor_Sleeping.php">沉睡的皇帝</a>
              </td>
            </tr>
            <tr>
              <td class="tunitc6">
              ...
              <td class="tunitc6"><a href="Vindlandsaga(1000).php">芬特蘭撒格(1000)</a>
              </td>
            </tr>
            <tr>
              <td class="tunitc6">
            ...
            <tr>
              ...
              <td class="tunitc4">攻城單位</td>
              <td class="tunitc6">火炮</td>
              <td class="tunitc6"><a href="The_Siege_of _Paris.php">巴黎攻城戰</a>
              </td>
            </tr>
            <tr>
              <td class="tunitc6">
            ...
            <tr>
              ...
              <td class="tunitc4">步兵</td>
              <td class="tunitc6">日本武士</td>
              <td class="tunitc6"><a href="Kurikara(1183).php">礪波山(1183)</a>
              </td>
            </tr>
            <tr>
              <td class="tunitc6">
            ...
            <tr>
              ...
              <td class="tunitc4">步兵</td>
              <td class="tunitc6">劍兵勇士</td>
              <td class="tunitc6"><a href="The_Battle_of _Falkirk.php">福爾克之役</a>
              </td>
            </tr>
          </table>
          <div class="row">
            <div class="col-md-12">
               <h3><a href="">征服者入侵</a></h3> 
              <div class="hrn1"></div>
              <table class="table-bordered" width="100%">
                <tr>
                  <td class="tunitcc" style="width: 20%;">名稱</td>
                ...
                <tr>
                  ...
                  <td class="tunitc6"><a href="Noryang Point(1598).php">洛陽點(1598)</a>
                  </td>
                </tr>
                <tr>
                  <td class="tunitc6">
                ...
                <tr>
                  ...
                  <td class="tunitc4">步兵</td>
                  <td class="tunitc6">狂戰士</td>
                  <td class="tunitc6"><a href="Hastings(1066).php">哈斯汀斯(1066)</a>
                  </td>
                </tr>
                <tr>
                  <td class="tunitc6">
                  ...
                  <td class="tunitc4">騎兵</td>
                  <td class="tunitc6">遊俠</td>
                  <td class="tunitc6"><a href="Agincourt(1415).php">亞琴哥特(1415)</a>
                  </td>
                </tr>
                <tr>
                  <td class="tunitc6">
                  ...
                  <td class="tunitc4">僧侶</td>
                  <td class="tunitc6">特殊</td>
                  <td class="tunitc6"><a href="The_Enemy_of_my_Enemy.php">我敵人的敵人</a>
                  </td>
                </tr>
                <tr>
                  <td class="tunitc6">
                ...
                <tr>
                  ...
                  <td class="tunitc4">步兵</td>
                  <td class="tunitc6">日本武士</td>
                  <td class="tunitc6"><a href="Kyoto(1582).php">京都(1582)</a>
                  </td>
                </tr>
                <tr>
                  <td class="tunitc6">
                  ...
                  <td class="tunitc4">僧侶</td>
                  <td class="tunitc6">僧侶</td>
                  <td class="tunitc6"><a href="Fall_of_Rome.php">羅馬的衰落</a>
                  </td>
                </tr>
                <tr>
                  <td class="tunitc6">
                ...
                <div class="col-md-12">
                  ...
                  <table class="table-bordered" width="100%">
                    ...
                    <tr>
                      ...
                      <td class="tunitc4">火藥單位、騎兵</td>
                      <td class="tunitc6">征服者</td>
                      <td class="tunitc6"><a href="The_Split.php">分離告別</a>
                      </td>
                    </tr>
                    <tr>
                      <td class="tunitc6">
                    ...
                    <tr>
                      ...
                      <td class="tunitc6"><a href="Bapheus(1302).php">巴菲烏斯(1302)</a>
                      </td>
                    </tr>
                    <tr>
                      <td class="tunitc6">
                    ...
                    <tr>
                      ...
                      <td class="tunitc4">村民</td>
                      <td class="tunitc6">特殊</td>
                      <td class="tunitc6"><a href="The_Elopement.php">私奔</a>
                      </td>
                    </tr>
                    <tr>
                      <td class="tunitc6">
                    ...
                    <div class="col-md-12">
                      ...
                      <table class="table-bordered" width="100%">
                        ...
                        <tr>
                          ...
                          <td class="tunitc4">馬騎弓兵</td>
                          <td class="tunitc6">特殊</td>
                          <td class="tunitc6"><a href="A_Fallen-Crown.php">摔落的皇冠</a>
                          </td>
                        </tr>
                        <tr>
                          <td class="tunitc6">
                        ...
                        <tr>
                          ...
                          <td class="tunitc4">步兵</td>
                          <td class="tunitc6">特殊</td>
                          <td class="tunitc6"><a href="Welcome_Home.php">重回故里</a>
                          </td>
                        </tr>
                        <tr>
                          <td class="tunitc6">
                        ...
                        <tr>
                          ...
                          <td class="tunitc6"><a href="Consolidation_and_Subjugation.php">攻城拔寨</a>
                          </td>
                        </tr>
                        <tr>
                          <td class="tunitc6">
                        ...
                        <tr>
                          ...
                          <td class="tunitc4">村民</td>
                          <td class="tunitc6">特殊</td>
                          <td class="tunitc6"><a href="Path_of_Exile.php">流亡之路</a>
                          </td>
                        </tr>
                        <tr>
                          <td class="tunitc6">
                        ...
                        <tr>
                          ...
                          <td class="tunitc4">騎兵</td>
                          <td class="tunitc6">拜占庭聖騎兵</td>
                          <td class="tunitc6"><a href="The_Lion's_Den.php">深入虎穴</a>
                          </td>
                        </tr>
                        <tr>
                          <td class="tunitc6">
                          ...
                          <td class="tunitc4">騎兵</td>
                          <td class="tunitc6">輕騎兵</td>
                          <td class="tunitc6"><a href="Hunted.php">擒獲</a>
                          </td>
                        </tr>
                        <tr>
                          <td class="tunitc6">
                        ...
                        <div class="col-md-12">
                          ...
                          <table class="table-bordered" width="100%">
                            ...
                            <tr>
                              ...
                              <td class="tunitc4">步兵</td>
                              <td class="tunitc6">劍兵勇士</td>
                              <td class="tunitc6"><a href="The_Mountain_Siege.php">至靈山魂</a>
                              </td>
                            </tr>
                            <tr>
                              <td class="tunitc6">
