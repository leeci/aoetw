  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>蒙古突騎是<a href="Mongols.php">蒙古</a>的特殊單位。對攻城器有加成傷害的馬弓騎兵單位。蒙古突騎能夠在<a href="Imperial_Age.php">帝王時代</a>>升級成精銳蒙古突騎。</p>
          </div>
          <h3>戰術</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <p>蒙古突騎非常適合攻擊<a href="Monk.php">僧侶</a>、<a href="Villager.php">村民</a>與<a href="Infantry_Units.php">步兵</a>等移動緩慢的單位，也能夠用於突襲徒步弓兵。此外對
              <a
              href="Siege_Weapon_Unit.php">攻城器</a>加成讓蒙古突騎能以中距離射程殲滅<a href="Battering_Ram.php">衝撞車</a>，使得<a href="Battering_Ram.php">衝撞車</a>更難接近防禦工事。雖然蒙古突騎擁有對
                <a
                href="Siege_Weapon_Unit.php">攻城器</a>加成，但蒙古突騎仍然不適合與<a href="Mangonel.php">投石車</a>或是<a href="Scorpion.php">弩砲</a>正面交鋒。除此之外也要避免
                  <a
                  href="Camel.php">駱駝騎兵</a>及<a href="Spearman.php">長槍兵</a>接近，他們對蒙古突騎擁有大量的加成傷害。規模龐大的<a href="Light_Cavalry.php">輕騎兵</a>與
                    <a
                    href="Skirmisher.php">矛兵</a>組合能夠完全壓制蒙古突騎，讓蒙古突騎迴避這個陣容才是上策。</p>
          </div>
          <h3>與馬弓騎兵的比較</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li>全面升級後，防禦、射程和血量都一樣。但在城堡時代，馬弓騎兵的血量少10。</li>
              <li>蒙古突騎開火間隔是5，馬弓騎兵是10，這表示蒙古突騎更可以使用拉打戰術。</li>
              <li>蒙古突騎跑速和訓練速度更快（當然訓練速度實際上是射箭場生產的<a href="Cavalry_Archer.php">馬弓騎兵</a>會更快）。</li>
              <li><a href="Cavalry_Archer.php">馬弓騎兵</a>成本便宜15木材5黃金。</li>
              <li>總而言之，蒙古突騎速度快，更可以配合蒙古的另一主力兵種<a href="Light_Cavalry.php">輕騎兵</a>。此外蒙古突騎對攻城武器有加成，可以輕鬆射爆
                <a
                href="Battering_Ram.php">衝撞車</a>。盡可能的使用蒙古突騎才是上策。</li>
            </ul>
          </div>
          <h3>與駱駝弓騎兵的比較</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li>攻擊和射程都相同，但是蒙古突騎的射速快，所以蒙古突騎的傷害輸出較高，此外，因為<a href="Parthian_Tactics.php">帕提亞戰術</a>的關係，蒙古突騎有+2攻擊vs
                <a
                href="Spearman.php">長槍兵</a>。</li>
              <li><a href="Camel_Archer.php">駱駝弓騎兵</a>多5點生命值，且可以自動<a href="Maghrabi_Camels.php">回血</a>，並且還有1的近防。</li>
              <li><a href="Camel_Archer.php">駱駝弓騎兵</a>的防禦類別屬於<a href="Armor_Class_Camel.php">駱駝類</a>，而不是
                <a
                href="Armor_Class_Cavalry.php">騎兵</a>，所以<a href="Camel.php">駱駝</a>和<a href="Spearman.php">長槍兵</a>等反騎兵單位對他的傷害較小。此外還有+1（精銳+2）的騎兵防禦，所以傷害更小。</li>
              <li><a href="Camel_Archer.php">駱駝弓騎兵</a>在<a href="Armor_Class_Cavalry_Archer.php">馬弓騎兵</a>防禦有+2，所以更不怕
                <a
                href="Skirmisher.php">矛兵</a>與<a href="Genitour.php">標槍騎兵</a>。</li>
              <li>蒙古突騎跑的更快一點。</li>
              <li>駱駝弓騎兵便宜5木與5金，升級精銳也比較便宜。</li>
              <li>蒙古突騎對攻城武器有加成，而<a href="Camel_Archer.php">駱駝弓騎兵</a>對於<a href="Cavalry_Archer.php">馬弓騎兵</a>有加成。</li>
              <li>總而言之，蒙古突騎攻擊速度更快，火力更強，但由於<a href="Camel_Archer.php">駱駝弓騎兵</a>的防禦較高，血量也多，還可以回血，所以更加的耐用。</li>
              <li>在一對一的戰鬥中，<a href="Camel_Archer.php">駱駝弓騎兵</a>可以秒殺蒙古突騎，因為<a href="Camel_Archer.php">駱駝弓騎兵</a>對馬弓騎兵攻擊+4/+6(精銳)</li>
            </ul>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Infantry_Units.php">步兵</a>、<a href="Villager.php">村民</a>、<a href="Battering_Ram.php">衝撞車</a>。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><a href="Kamayuk.php">槍隊長</a>、<a href="Genoese_Crossbowman.php">熱那亞弩手</a>、
                <a
                href="Huskarl.php">哥德衛隊</a>、<a href="Mameluke.php">奴隸兵</a>、<a href="Camel.php">駱駝騎兵</a>、
                  <a
                  href="Skirmisher.php">矛兵</a>、<a href="Eagle_Warrior.php">鷹勇士</a>、<a href="Halberdier.php">戟兵</a>、
                    <a
                    href="Samurai.php">日本武士</a>、<a href="Camel_Archer.php">駱駝弓騎兵</a>。</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br>
                <img class="gg" src="img/Parthian-Tactics.jpg" width="30" alt=""><a href="Parthian_Tactics.php">帕提亞戰術</a>:+2對<a href="Armor_Class_Spearman.php">長槍兵</a> 
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" src="img/Thumb_Ring.png" width="30" alt=""><a href="Thumb_Ring.php">拇指環</a>:增加命中率至100%
                <br>
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br>
                <img class="gg" src="img/Parthian-Tactics.jpg" width="30" alt=""><a href="Parthian_Tactics.php">帕提亞戰術</a>(+1/+2)</td>
            </tr>
            <tr>
          ...
          <h3>剋蒙古突騎的單位</h3>
          <div class="hrn1"></div>
          <div class="n1">以下單位擁有對蒙古突騎的額外傷害，按造傷殺力排列。
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <ul>
                    <li>
                      <img class="gg" src="img/Imperialskirmishericon.png" alt=""> <a href="Imperial_Skirmisher.php">帝王戰矛兵</a> (<a href="Vietnamese.php">越南</a>及同盟限定)</li>
                    <li>
                  ...
                  <ul>
                    ...
                    <li>
                      <img class="gg" style="margin: 2px;" src="img/CamelArcherIcon.jpg" alt=""><a href="Camel_Archer.php">精銳駱駝弓騎兵</a>(<a href="Berbers.php">柏柏</a>限定)</li>
                    <li>
                  ...
                  <ul>
                    ...
                    <li>
                      <img class="gg" style="margin: 2px;" src="img/CamelArcherIcon.jpg" alt=""><a href="Camel_Archer.php">駱駝弓騎兵</a>(<a href="Berbers.php">柏柏</a>限定)</li>
                  </ul>
              ...
              <div class="col-md-12">以下技術可讓以下單位對蒙古突騎有額外攻擊力
                <div class="n1">
              ...
              <div class="col-md-12">以下團隊加成可讓以下單位對蒙古突騎有額外攻擊力
                <div class="n1"><a href="Persians.php">波斯</a>在團隊加成裡，給予以下單位+2額外攻擊vs<a href="Archer_Units.php">射手單位</a>。
                  <div
                  class="row">
                    <div class="col-md-6">
        ...
        <div class="n1">
          <ul>
            <li><a href="Mongols.php">蒙古</a>：蒙古突騎攻擊速度快20%。</li>
          </ul>
        </div>
        <h3>團隊加成</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <ul>
            <li><a href="Berbers.php">柏柏</a>：<a href="Kasbah.php">聚居堡壘</a>能夠提高蒙古突騎的生產速度還有加速
              <a
            ...
            <li><a href="Teutons.php">條頓</a>：蒙古突騎更不容易被招降。</li>
          </ul>
        </div>
        <h3>更新日誌</h3>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <ul>
            <li>蒙古突騎對<a href="Armor_Class_Siege_Weapon.php">攻城武器</a>攻擊+3(精銳+5)。</li>
            <li>蒙古突騎開火速率為2.03。</li>
            <li>蒙古突騎命中率100%。</li>
            <li>蒙古突騎速度為1.43。</li>
            <li>蒙古突騎訓練時間為21秒。</li>
            <li>蒙古突騎(非精銳)開火間隔為10。</li>
            <li>精銳蒙古突騎的開火間隔為0。</li>
          </ul>
          <h3><em><a href="aoc.php">征服者入侵</a></em></h3>
          <ul>
            <li>蒙古突騎對<a href="Armor_Class_Spearman.php">長槍兵</a>攻擊+1。</li>
            <li>蒙古突騎開火速率減慢為2.13。</li>
            <li>蒙古突騎命中率降到95%。</li>
            <li>蒙古突騎速度增加至1.45。</li>
            <li>蒙古突騎訓練時間增加至26秒。</li>
          ...
          <ul>
            ...
            <li>蒙古突騎對<a href="Armor_Class_Ram.php">衝撞車</a>攻擊+3(精銳+5)。</li>
            <li>蒙古突騎(非精銳)的開火間隔減少為5。</li>
          </ul>
          <h3><em><a href="aok.php">非洲王朝</a></em></h3>
          <ul>
            <li>4.8版後蒙古突騎現在的開火間隔為5。</li>
            <li>4.8版後蒙古突騎重新得到一開始對攻城武器攻擊+3(精銳+5)的加成。對衝撞車的攻擊加成被移除。</li>
          </ul>
        </div>
        <h3>豆知識</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <ul>
            <li>蒙古突騎是唯一升不升級精銳;血量都相同的單位。</li>
          </ul>
        </div>
        <h3>歷史</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <div class="ien"><em>“蒙古人由成吉思汗統一，他們的領土曾經從太平洋到地中海甚至到中歐，蒙古人是優秀的騎兵，每個戰士都有馬廄眷養小馬，保持有源源不斷的坐騎可用。 蒙古軍隊的主力是馬弓騎兵，這些弓箭手中最好的，叫做蒙古突騎，即便處於劣勢他們也能用策略擊敗敵人。他們會使用陷阱來消耗敵人的騎兵，再把它們射程蜂窩，緩慢的敵人部隊更可以最低風險在一定範圍內就將其擊倒射殺。敵人的軍隊在疲憊不堪之際還是碰不到蒙古突騎一根寒毛。蒙古軍隊的主要弱點是只有偉大的領導人才能領導凝聚，他們，當偉大的可汗或者後來的領導人去世時，軍隊就會為了爭奪可汗分封崩離析。“</em>
            <p
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#3c763d;;">
              <div class="unititle" style="color:#fff;">蒙古突騎</div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="img/MangudaiIcon.jpg" width="45" alt="">
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4"><a href="Archer.php">弓兵</a>、 <a href="Cavalier.php"> 騎兵</a>
            </td>
          </tr>
          <tr>
            <td class="unit3">文明</td>
            <td class="unit4"><a href="Mongols.php">蒙古</a>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">對<a href="Armor_Class_Siege_Weapon.php">攻城武器</a>+3/+5(精銳)
              <br>對<a href="Armor_Class_Spearman.php">槍兵類</a>+1</td>
          </tr>
          <tr>
            <td class="unit3">射速</td>
            <td class="unit4">1.7</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="img/MangudaiIcon.jpg" width="22" alt="">精銳蒙古突騎</td>
          </tr>
          <tr>
      ...
      <div class="col-md-12">
        ...
        <div class="hrn1"></div>
        <div class="n1">
          <div class="col-md-4"> <a href="img/Mangudai.png"><img class="imgn" class="hg" width="180" src="img/Mangudai.png" alt=""></a> 
            <div
        ...
        <div class="col-md-4"> <a href="img/Mangudai_real_life.jpg"><img class="imgn" class="hg" width="200" src="img/Mangudai_real_life.jpg" alt=""></a> 
          <div
          class="lightbox-caption" style="width:220px" ;>
            <p><em>真實歷史上的蒙古突騎。</em>
            </p>
      ...
      <div class="col-md-4"> <a href="img/Mangudai_Preview.jpg"><img class="imgn" class="hg" width="200" src="img/Mangudai_Preview.jpg" alt=""></a> 
        <div
        class="lightbox-caption" style="width:185px" ;>
          <p><em>世紀帝國III中的蒙古突騎。</em>
          </p>
      </div>
    </div>
    </div>
