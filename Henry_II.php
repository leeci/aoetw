  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p><strong>亨利二世</strong>是一名可在《世紀帝國II HD： 非洲王朝》的地圖編輯器中使用的<a href="Infantry_Units.php">步兵</a>
              <a
              href="heros.php">英雄</a>。他的原型是<strong>英格蘭的國王亨利二世</strong>，最著名的事蹟是在百年戰爭之前奪回了<a href="Britons.php">英國</a>在法國內的領地，並收回了英格蘭境內的皇家統治。在遊戲中，亨利二世以
                <a
                href="Two_Handed_Swordsman.php">雙手劍兵</a>的外表登場。作為一個英雄單位，他無法被招降且會自動回血。</p>
            <p>和其他步兵單位一樣，亨利二世會受到所有影響步兵的升級及加成影響。</p>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><a href="">亨利二世</a>
                </div>
              </td>
            </tr>
            <tr>
