  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>南美文明限定，<a href="Mayans.php">馬雅</a>、 <a href="Aztecs.php">阿茲特克</a>、<a href="Incas.php">印加</a>。
              到了世紀帝國2失落的帝國 ，在封建時代便可以生產鷹斥侯，到了城堡時代可以升為 <a href="Eagle_Warrior.php">鷹勇士</a> 。</p>
          </div>
           <h3>戰術</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <p>由於鷹勇士遠防相當高，甚至比<a href="Knight.php">騎士</a>還高，高達3，總體防禦高達5，就算在<a href="Town_Center.php">城鎮中心</a>底下也可以盡情屠殺
              <a
              href="Villager.php">村民</a>。也是所有<a href="Archer_Units.php">弓兵</a>的剋星；對於近戰步兵是被克制的，但因移動速度快步兵很難打到。在
                <a
                href="Castle_Age.php">城堡時代</a>鷹斥侯可升為鷹勇士，鷹勇士可以說是在城堡時代最強的兵種。克制弓兵、對馬有加成，也不怕招降、攻城武器也沒再怕的(遇到弩砲仍有所忌憚)。可怕的是他非常便宜，只需要20肉50黃金，生產也非常快速，這讓南美國家變得非常強勢。而他身體嬌小(相對於騎士)，在隙縫中鑽來鑽去也是非常靈活的。南美國只要出鷹勇士配合僧侶，幾乎是無往不利，相當難纏。</p> <strong>反制</strong> 
            <p>要在城堡時代對付鷹勇士是相當困難的，能有效克制鷹勇士只有<a href="Knight.php">騎士</a>，而<a href="Knight.php">騎士</a>量少會跟不上鷹勇士出的速度，對方也會出
              <a
              href="Monk.php">僧侶</a>甚至<a href="Pikeman.php">重裝長槍兵</a>反制，適時的可以配點<a href="Scorpion.php">弩砲</a>+
                <a
                href="Knight.php">騎士</a>，<a href="Scorpion.php">弩砲</a>攻擊12還有貫穿攻擊，打老鷹和<a href="Monk.php">僧侶</a>都是不錯，重點是家裡要圍好，配合
                  <a
                  href="Castle.php"></a>城堡與騎士，不要給鷹勇士鬧到，拖到後期，老鷹國就相對沒有城堡這麼可怕。非常不建議出<a href="Long_Swordsman.php">長劍兵</a>，即使
                    <a
                    href="Long_Swordsman.php">長劍兵</a>打鷹勇士很快，但<a href="Long_Swordsman.php">長劍兵</a>耗資源，且走的太慢，又非常怕弩兵，對方看你這麼多
                      <a
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Archer_Units.php">弓兵</a>、<a href="Siege_Weapons.php">攻城單位</a>、
                <a
                href="Monk.php">僧侶</a>。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><a href="Cataphract.php">聖騎兵</a>、<a href="Boyar.php">貴族鐵騎</a>、<a href="Hand_Cannoneer.php">火槍兵</a>、
                <a
                href="Infantry_Units.php">步兵</a>、<a href="Slinger.php">投石手</a>。</td>
            </tr>
            <tr class="tta">
           ...
           <h3>剋鷹勇士的單位</h3> 
          <div class="hrn1"></div>
          <div class="n1">以下單位擁有對鷹勇士系的額外傷害，按造傷殺力排列。一般來說，大多數的 <a href="Armor_Class_Infantry.php">步兵單位</a>都有加成。
            <div
            class="n1">
              <div class="row">
                <div class="col-md-6">
        ...
        <div class="n1">
          <ul>
            <li><a href="Aztecs.php">阿茲特克</a>：鷹勇士生產速度提高15％。</li>
          </ul>
        </div>
         <h3>團隊加成</h3> 
        <div class="hrn1"></div>
        <div class="n1">
          <ul>
            ...
            <li><a href="Goths.php">哥德</a>：鷹勇士訓練和升級快20%。研發<a href="Tracking.php">追縱技術</a>、
              <a
              href="Squires.php">護衛</a>、<a href="Arson.php">縱火</a>科技的時間快20%。</li>
            <li><a href="Teutons.php">條頓</a>：鷹勇士更不容易被招降。</li>
          </ul>
        </div>
         <h3>更新日誌</h3> 
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <ul>
            <li>鷹勇士多了一個前身，<a href="Eagle_Scout.php">鷹斥侯</a>。</li>
            <li>鷹勇士有55HP與3的遠防。</li>
            <li>訓練時間為32秒。</li>
            <li>升級鷹勇士的費用為300食物/200黃金。</li>
            <li>鷹勇士對<a href="Armor_Class_Cavalry.php">騎兵</a>有+3的攻擊加成，對<a href="Armor_Class_Camel.php">駱駝</a>和
              <a
              href="Armor_Class_Ship.php">船艦</a>額外+1。</li>
            <li><a href="Incas.php">印加</a>:<a href="Couriers.php">信使</a>給予鷹勇士+10％的移動速度。</li>
            <li>鷹勇士改變外觀。</li>
          </ul>
          ...
          <ul>
            ...
            <li>速度由1.1升級到1.2。</li>
            <li><a href="Incas.php">印加</a>:<a href="Couriers.php">信使</a>給予鷹勇士+1/+2的防禦。移除+10％的速度。</li>
          </ul>
           <h3><em><a href="aor.php">王者崛起</a></em></h3> 
          <ul>
            <li>5.7版本後鷹勇士現在的移動速度為1.15。</li>
            <li>5.7版本後鷹勇士現在的訓練時間為35。</li>
            <li>5.7版本後鷹勇士現在對<a href="Armor_Class_Camel.php">駱駝單位</a>攻擊+2。</li>
          </ul>
        </div>
         <h3>趣事</h3> 
        <div class="hrn1"></div>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#3c763d;;">
              <div class="unititle"><a href="">鷹勇士</a>
              </div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="img/EagleWarriorIcon.jpg" width="45" alt="">
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="img/Elite-eagle-warrior-researc.jpg" alt="">800食物500黃金</td>
          </tr>
        </table>
    ...
    <div class="col-md-12">
      ...
      <div class="n1">
        ...
        <div class="col-md-4"> <a href="img/Eaglewarrior.png"><img class="imgn" class="hg" src="img/Eaglewarrior.png" alt=""></a> 
          <p><em>一群鷹勇士(《世紀帝國II:失落的帝國》資料片)</em>
          </p>
        </div>
      </div>
      <div class="col-md-12">
        <div class="col-md-4"> <a href="img/Eagle_Warrior.jpg"><img class="imgn" class="hg" src="img/Eagle_Warrior.jpg" alt=""></a> 
          <p><em>一名鷹勇士</em>
          </p>
        </div>
      </div>
