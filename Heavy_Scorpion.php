  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>重裝弩砲可訓練於攻城武器製造所，他發射大型箭矢，可對敵人造成貫穿，但只有目標單位會受到全部的傷害，其他單位只會受到一半的傷害。不像投石車，弩砲不會傷害友方單位，所以在近距離的肉搏戰相當好用。</p>
          </div>
          <h3>戰術</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <p>重裝弩砲對步兵，弓箭手和僧侶等速度慢的單位非常有效，因為速度慢的單位容易被弩砲貫穿攻擊。但弩砲對於快速的步兵，如<a href="Woad_Raider.php">菘藍武士</a>、
              <a
              href="Eagle_Warrior.php">鷹勇士</a>表現並不是很好，因為可以快速縮短距離，並貼身攻擊。而哥德衛隊擁有高遠防，可以抵抗弩砲的攻擊。像大多數的<a href="Siege_Weapons.php">攻城武器</a>一樣，弩砲必須派其他單位在旁邊保護，因為弩砲速度慢容易遭受攻擊。弩砲最常與
                <a
                href="Armor_Class_Spearman.php">長槍兵</a>搭配攻擊，可以相輔相成。這個組合在<a href="Celts.php">賽爾特</a>、<a href="Slavs.php">斯拉夫</a>與
                  <a
                  href="Khmer.php">高棉</a>特別強大。</p>
            <p>如果使用得當，弩砲可以非常有威脅性，一個中等規模的弩砲可以瞬間秒殺整個<a href="Infantry_Units.php">步兵</a>與
              <a
              href="Archer_Units.php">弓箭手</a>的軍隊，甚至可以抵抗<a href="Cavalry_Units.php">騎兵</a>的攻擊，但弩砲很怕遠程單位，如<a href="Bombard_Cannon.php">火砲</a>或是
                <a
                href="Longbowman.php">長弓兵</a>。當然如果對自己的控兵有信心，用<a href="Cavalry_Archer.php">馬弓騎兵</a>也可以。當然<a href="Mangonel.php">投石車</a>與
                  <a
                  href="Bombard_Cannon.php">火砲</a>永遠是弩砲的殺手。</p>
          </div>
           <h3>文明可訓練與否</h3> 
          <div class="hrn1"></div>
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-ok okc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">可訓練</span></strong></h4>  <a href="Chinese.php">中國</a>、 <a href="Malay.php">馬來</a>、 <a href="Teutons.php">條頓</a>、
                <a
                href="Turks.php">土耳其</a>、 <a href="Berbers.php">柏柏</a>、 <a href="Britons.php">不列顛</a>、
                  <a
                  href="Burmese.php">緬甸</a>、 <a href="Celts.php">賽爾特</a>、 <a href="Ethiopians.php">衣索比亞</a>、
                    <a
                    href="Franks.php">法蘭克</a>、 <a href="Goths.php">哥德</a>、 <a href="Incas.php">印加</a>、 <a href="Japanese.php">日本</a>、
                      <a
                      href="Khmer.php">高棉</a>、 <a href="Magyars.php">馬扎爾</a>、 <a href="Mayans.php">馬雅</a>、 <a href="Mongols.php">蒙古</a>、
                        <a
                        href="Persians.php">波斯</a>、 <a href="Slavs.php">斯拉夫</a>、 <a href="Vikings.php">維京</a>。</div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-remove noc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">不可研發</span></strong></h4>  <a href="Aztecs.php">阿茲特克</a>、 <a href="Byzantines.php">拜占庭</a>、 <a href="Huns.php">匈奴</a>、
                <a
                href="Indians.php">印度</a>、 <a href="Italians.php">義大利</a>、 <a href="Koreans.php">韓國</a>、
                  <a
                  href="Malians.php">馬利</a>、 <a href="Portuguese.php">葡萄牙</a>、 <a href="Saracens.php">薩拉森</a>、
                    <a
                    href="Spanish.php">西班牙</a>、 <a href="Vietnamese.php">越南</a>。</div>
            </div>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Armor_class_building.php">建築物</a>、<a href="Archer_Units.php">弓兵</a>、移動緩慢的單位。</td>
            </tr>
            <tr>
          ...
          <h3>剋弩炮的單位與建築</h3>
          <div class="hrn1"></div>
          <div class="n1">以下單位擁有對弩炮的額外傷害，按造傷殺力排列。
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-6">
          ...
          <div class="n1">
            <ul>
              <li><a href="Aztecs.php">阿茲特克</a>：重型弩炮生產快15%。</li>
              <li><a href="Celts.php">賽爾特</a>：重型弩炮攻擊速度快25%。</li>
              <li><a href="Chinese.php">中國</a>：對重型弩炮有加成的科技在帝王時代便宜20%。</li>
              <li><a href="Slavs.php">斯拉夫</a>：重型弩炮成本便宜：15%。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><a href="Celts.php">賽爾特</a>：重型弩炮訓練速度快20%。</li>
              <li><a href="Koreans.php">高棉</a>：重型弩炮+1射程。</li>
              <li><a href="Malians.php">馬利</a>：研發<a href="Chemistry.php">化學</a>和<a href="Siege_Engineers.php">攻城工程師</a>的速度快80%。</li>
              <li><a href="Teutons.php">條頓</a>：重型弩炮對僧侶的招降有較好的抗性。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li>重型弩砲有5的射程。</li>
              <li>重型弩砲有0的<a href="Frame_delay.php">開火間隔</a>
              </li>
              <li>重型弩砲的<a href="Frame_delay.php">開火間隔</a>為0</li>
              <li>重型弩砲受<a href="Fletching.php">箭羽</a>、<a href="Bodkin_Arrow.php">錐狀箭頭</a>和
                <a
                href="Bracer.php">護腕</a>加成影響。所以總共可以+3射程和攻擊。</li>
              <li><a href="Chemistry.php">化學</a>給予重型弩砲+2攻擊。</li>
              <li><a href="Britons.php">不列顛</a>:不能使用重型弩炮。</li>
            </ul>
            <h3><em><a href="aoc.php">征服者入侵</a></em></h3>
            <ul>
              <li>重型弩砲射程為7。</li>
              <li>重型弩砲有7的<a href="Frame_delay.php">開火間隔</a>。</li>
              <li>重型弩砲不再有<a href="Fletching.php">箭羽</a>、<a href="Bodkin_Arrow.php">錐狀箭頭</a>和
                <a
                href="Bracer.php">護腕</a>加成影響。</li>
              <li><a href="Chemistry.php">化學</a>給予+1的攻擊。</li>
              <li>引進<a href="Heresy.php">異端邪說</a>。</li>
              <li><a href="Celts.php">賽爾特</a>:<a href="Furor_Celtica.php">賽爾特狂暴</a>給予弩炮多50%的HP。、</li>
              <li><a href="Chinese.php">中國</a>:引進<a href="Rocketry.php">火箭術</a>。</li>
              <li><a href="Mongols.php">蒙古</a>:引進<a href="Drill.php">演習</a>科技。</li>
            </ul>
            <h3><em><a href="aof.php">失落的帝國</a></em></h3>
            <ul>
              <li><a href="Celts.php">賽爾特</a>:<a href="Furor_Celtica.php">賽爾特狂暴</a>給予弩炮多40%的HP。</li>
              <li><a href="Teutons.php">條頓</a>：引進<a href="Ironclad.php">鋼鐵甲</a>
              </li>
              <li><a href="Britons.php">不列顛</a>:可以使用重型弩炮了。</li>
            </ul>
            ...
            <div class="n1">
              <ul>
                ...
                <li>弩砲有0的近戰攻擊，所以攻擊近戰防禦-3的<a href="Battering_Ram.php">衝車</a>是可以的，有意思的是弩砲對衝車還有加成。</li>
              </ul>
            </div>
            <h3>圖庫</h3>
            <div class="hrn1"></div>
            ...
            <div class="n1">
              <div class="col-md-12">
                <p>投射機（Ballista）或稱扭力弩砲，是以絞繩的扭力（而非「弓身」的彈力）來發射物體的大型冷兵器砲。此器與弩、牀弩依靠弓身的彈力來發射物體的運作模式不同。投射機最早可追溯至古希臘時代。古羅馬軍隊使用的投射機有分大型與小型，小型的投射器又稱作蠍砲（Scorpius）。另外也有單兵使用的手持投射機（扭力弩）。</p>
                <p>床弩又稱床子弩、牀弩、牀子弩（Arcuballista），在中國最早出現於戰國時代，是把弩大型化或有多個弩翼（弓身），裝在發射台或車輛上的一種大型的特殊弩。床弩的主要使用目的是攻城或海戰。據《武經總要》記載宋朝軍隊中共有六種床弩。典型的中國床子弩使用絞車拉動弓弦，操作士兵達7名，根據宋人記載的最高射程約合現在的1500米。根據史料記載，遼軍將領蕭撻凜便是被400多米外宋軍陣地的兩米巨箭射殺，最終雙方簽訂著名的「澶淵之盟」</p>
              </div>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td class="unit3"><a href="Attack.php">攻擊</a>
              </td>
              <td class="unit4">16(遠程)0(近戰)</td>
            </tr>
            <tr>
              <td class="unit3">攻擊加成</td>
              <td class="unit4">+8 vs<a href="Armor_Class_War_Elephant.php">戰象</a>
                <br>+4 vs<a href="Armor_class_building.php">建築</a>
                <br>+2 vs<a href="Armor_Class_Ram.php">衝撞車</a>
              </td>
            </tr>
            <tr>
