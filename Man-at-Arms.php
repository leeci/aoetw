  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>裝甲步兵，到<a href="Feudal_Age.php">封建時代</a>就可以在<a href="Barracks.php">軍營</a>裡進行訓練。他們對封建時代的大多數單位擁有強大的優勢，使他們成為破壞對手經濟的有效單位。</p>
          </div>
          <h3>戰術</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <p>裝甲步兵，在封建時代對地人的打擊和干擾方面非常好用。由於速度較慢，對弓箭手尤其弱。可以訓練一些矛兵來對付弓箭手。而著名的<a href="mantower.php">裝甲塔戰術</a>更是讓新手聞風喪膽。裝甲步兵是打得贏斥候的。</p>
            <p>一搬來說，<a href="Japanese.php">日本</a>、<a href="Celts.php">賽爾特人</a>、<a href="Aztecs.php">阿茲特克</a>與
              <a
              href="Goths.php">哥德</a>非常適合生產裝甲步兵來進行封建初期的關鍵打擊。</p>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Skirmisher.php">矛兵</a>、<a href="Scout_Cavalry.php">斥侯</a>、
                <a
                href="Eagle_Scout.php">鷹斥侯</a>、<a href="Spearman.php">槍兵</a>、<a href="Villager.php">村民</a>。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><a href="Archer_Units.php">弓兵</a>、<a href="Scorpion.php">弩炮</a>。</td>
            </tr>
            <tr class="tta">
          ...
          <h3>剋裝甲步兵的單位與建築</h3>
          <div class="hrn1"></div>
          <div class="n1">以下單位擁有對裝甲步兵的額外傷害，按造傷殺力排列。
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-6">
          ...
          <div class="n1">
            <ul>
              <li><a href="Aztecs.php">阿茲特克</a>：裝甲步兵生產速度提高15％。</li>
              <li><a href="Burmese.php">緬甸</a>：裝甲步兵在封建/城堡/帝王時代有 +1/+2/+3攻擊。</li>
              <li><a href="Celts.php">賽爾特</a>：裝甲步兵移動加快15％。</li>
              <li><a href="Chinese.php">中國</a>：利於裝甲步兵的技術在封建/城堡/帝王時代便宜10％/15％/20％。</li>
              <li><a href="Goths.php">哥德</a>：裝甲步兵從封建時代開始便宜35％並對<a href="Armor_Class_Standard_Building.php">標準建築</a>攻擊+1。研發
                <a
                href="Perfusion.php">灌注士氣</a>後研發<a href="Tracking.php">追縱技術</a>、<a href="Squires.php">護衛</a>、
                  <a
                  href="Arson.php">縱火</a>和升級長劍兵的速度快100%。</li>
              <li><a href="Japanese.php">日本</a>：裝甲步兵攻速快33％。</li>
              <li><a href="Magyars.php">馬札爾</a>：免費升級<a href="Forging.php">鍛造</a>、<a href="Iron_Casting.php">鑄造</a>和
                <a
                href="Blast_Furnace.php">鼓風爐</a>。</li>
              <li><a href="Malians.php">馬利</a>：裝甲步兵在封建/城堡/帝王時代有 +1/+2/+3 遠程護甲。</li>
              <li><a href="Portuguese.php">葡萄牙</a>：裝甲步兵黃金成本減少15％。</li>
              ...
              <li><a href="Vikings.php">維京</a>：裝甲步兵在封建/城堡/帝王時代加10％/15％/20％的生命值。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li><a href="Goths.php">哥德</a>：裝甲步兵訓練和升級快20%。研發<a href="Tracking.php">追縱技術</a>、
                <a
                href="Squires.php">護衛</a>、<a href="Arson.php">縱火</a>科技的時間快20%。</li>
              <li><a href="Teutons.php">條頓</a>：裝甲步兵更不容易被招降。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li>裝甲步兵對<a href="Armor_Class_Standard_Building.php">標準建築</a>+1攻擊。</li>
              <li>裝甲步兵遠防是0。</li>
              <li><a href="Goths.php">哥德</a>:在封建/城堡/帝王時代，裝甲步兵成本便宜10%/15%/25%。</li>
            </ul>
            <h3><em><a href="aoc.php">征服者入侵</a></em></h3>
            <ul>
              <li>裝甲步兵現在擁有1的遠防。</li>
              <li>引入<a href="Heresy.php">異端邪說</a>。</li>
              <li><a href="Goths.php">哥德</a>:1.0c後，哥德裝甲步兵從封建時代開始便宜35%。引入<a href="Perfusion.php">灌注士氣</a>
              </li>
            </ul>
            <h3><em><a href="aof.php">失落的帝國</a></em></h3>
            <ul>
              <li>裝甲步兵擁有+2攻擊VS<a href="Armor_Class_Standard_Building.php">標準建築</a>。</li>
            </ul>
            <h3><em><a href="ak.php">非洲王國</a></em></h3>
            <ul>
              <li>新科技<a href="Arson.php">縱火</a>引進。</li>
              <li><a href="Vikings.php">維京</a>:4.8版本引進<a href="Chieftains.php">酋長</a>科技，裝甲步兵對
                <a
                href="Armor_Class_Cavalry.php">騎兵單位</a>有+5攻擊。</li>
              <li><a href="Vikings.php">維京</a>:在4.8b版本後，<a href="Chieftains.php">酋長</a>讓裝甲步兵對駱駝有額外+2攻擊。</li>
            </ul>
            <h3><em><a href="aor.php">王者崛起</a></em></h3>
            <ul>
              <li><a href="Vikings.php">維京</a>:5.7版本<a href="Chieftains.php">酋長</a>科技現在讓裝甲步兵對駱駝有額外+4攻擊。</li>
            </ul>
          </div>
          <h3>趣事</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li>裝甲步兵的英文Man-at-Arms，其實名稱並不正確，因為Man-at-Arms是中古時代的重型騎兵。</li>
              <li>馬來的民兵系再研發<a href="Forced Levy.php">強制徵兵</a>後不用黃金。</li>
              <li>民兵是遊戲中少數四個沒有任何攻擊加成的單位。（另外三個是遊俠、貴族鐵騎與龜甲船）。</li>
            </ul>
          </div>
          <h3>圖庫</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <div class="col-md-12">
              ...
              <div class="col-md-4"> <a href="img/Manatarms.png"><img  class="imgn" class="hg" width="250" src="img/Manatarms.png" alt=""></a> 
                <p><em>一群裝甲步兵</em>
                </p>
              </div>
            </div>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">+2對<a href="Armor_Class_Eagle_Warrior.php">鷹勇士</a>
                <br>+2對<a href="Armor_Class_Standard_Building.php">標準建築</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="img/Long-swordsman-research.jpg" alt="">200肉65金</td>
            </tr>
            <tr>
