  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>製圖學可以研究於<a href="Market.php">市集</a>。功能是看到盟友的視野。</p>
            </p>在遊戲早期這是個非常有用的科技，尤其是在多人連線時，重點是他不用成本。</p>
          </div>
           <h3>可研發文明</h3> 
          <div class="hrn1"></div>
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><span class="glyphicon glyphicon-ok okc" aria-hidden="true"></span><span class="okcc" style="margin-left: 2px;">可研發</span></h4> 所有文明</div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
          ...
          <div class="n1">
            <ul>
              <li><a href="Portuguese.php">葡萄牙</a>：在<a href="Dark_Age.php">黑暗時代</a>時及擁有免費的製圖學。</li>
            </ul>
          </div>
           <h3>更新日誌</h3>
          <div class="hrn1"></div>
          ...
          <div class="n1">
            <ul>
              <li>在5.7以前很多玩家就算是玩單挑，也會研發製圖學，因為Free Carto。</li>
            </ul>
          </div>
           <h3>歷史</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <p>在一些東方古老的國家，如中國、埃及、巴比倫等，由於農業的發展，需要大量土地，產生了簡易的測量工具和方法。其後，行政管理、貿易和戰爭更是促進了對地圖的需要。刻畫在陶片上的巴比倫地圖大約是2500年前的遺物，上面刻有山脈、河流、城市和海洋；中國歷史上記載的鑄造在九鼎上的地圖，距今也有4000多年的歷史。</p>
          </div>
        </div>
        <div class="col-md-4">
