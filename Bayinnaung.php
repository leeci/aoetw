  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>勃印曩是個騎兵英雄，在"拉惹的崛起"資料片的勃印曩相關戰役和地圖編輯器裡出現。</p>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/Bayinnaungicon.png" width="80" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">對建築物+10
                <br>對石造建築+10</td>
            </tr>
            <tr>
              <td class="unit3">建設範圍</td>
              <td class="unit4">0.4(patch5.7後待確認)</td>
            </tr>
            <tr>
