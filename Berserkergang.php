    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          ...
          <div class="n1">
            <ul>
              <li>狂戰士幫讓狂戰士在戰場上即使沒有僧侶在後方支援還是能撐相當長的一段時間。如果操作得宜，玩家可用狂戰士以非常少的損失對對手造成巨大傷害。</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><a href="Berbers.php">柏柏</a>：<a href="Kasbah.php">聚居堡壘</a>能夠加速狂戰士幫的研究時間(快25%)。</li>
            </ul>
          </div>
           <h3>更新日誌</h3>
          <div class="hrn1"></div>
          ...
          <div class="n1">
            ...
            <p>傳說狂戰士因為蒙受戰神奧丁的神力加持而具有特殊的狂戰體質，平時力量雖和一般戰士無異，但是在危急時能夠進入無我的狂暴狀態，稱為「狂戰士之怒」（Berserker
              Rage），突然湧出如熊又如狼般的勇猛力量，在戰場上大發神威。</p>
            <p>傳說狂戰士甚至可以不穿甲冑也不持武器，僅身披熊皮或狼皮便以狂暴之姿衝鋒陷陣，徒手殺死敵人或把敵人的喉嚨咬破。13世紀的冰島史學家斯諾里·斯蒂德呂松曾經如此描述：「哈拉爾一世（Harald
              I）的禁軍中有狂戰士，即使用武器也傷不了他們」。但狂戰士在狂戰士之怒消退後會立刻陷入虛脫的狀態。</p>
          </div>
        </div>
        <div class="col-md-4">
