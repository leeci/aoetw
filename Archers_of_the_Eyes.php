  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p><strong>神弓手</strong>是《世紀帝國 II HD: 帝王世紀》中的一名徒步弓兵英雄，可以在許多戰役和戰役編輯器中找到。現實中的神弓手是講努比亞弓箭手，他們以專業的槍法而聞名，據說可以弓箭精準射中敵人眼睛因此得名。神弓手的外觀是強弩兵，會受弓兵科技和其他加成的影響，由於它屬於英雄單位，因此不能被招降且會回血(在征服者資料片後)
              。</p>
            <p></p>
          </div>
           <h3>出現場景</h3>
          ...
          <div class="n1">
            <ul>
              <li>薩拉丁的第四個戰役"耶路撒冷攻城戰"，玩家一開始會有幾名神弓手作防守用。</li>
              <li>在薩拉丁最後戰役"獅子與惡魔"中玩家也會有一些神弓手做防守工作。</li>
              <li>在巴巴羅薩最後戰役"沉睡的皇帝"中，薩拉丁變成玩家敵人並有幾名神弓手在他的軍隊中。</li>
            </ul>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/Archersoftheeyesicon.png" width="80" alt="">
                </div>
              </td>
            </tr>
            <tr>
