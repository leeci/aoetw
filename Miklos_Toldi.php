  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>米克羅斯-陶笛是個騎兵英雄，在"世界地國II:非洲王朝"資料片之後版本的地圖編輯器出現，米克羅斯-陶笛的名字是以建立匈牙利王國的貴族所命名，該貴族被匈牙利人們傳頌為擁有強大力量的傳奇英雄。</p>
            <p>在遊戲中米克羅斯-陶笛的外型是馬札爾驃騎兵，他會受到所有騎兵單位科技加成的影響。他不能被招降而且會自行回血。</p>
          </div>
          <div></div>
          <div></div>
        </div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><a href="">米克羅斯-陶笛</a>
                </div>
              </td>
            </tr>
            <tr>
