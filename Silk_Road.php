  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>絲綢之路是<a href="Italians.php">義大利</a>的特殊科技，可於<a href="Imperial_Age.php">帝王時代</a>在
              <a
              href="Castle.php">城堡</a>研發。研發後<a href="Trade_Cart.php">貿易馬車</a>、<a href="Trade_Cog.php">貿易商旅</a>造價減半。</p>
          </div>
          <h3>戰術要點</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li>雖然在團隊遊戲之外沒有太多的用處，絲綢之路可以在很重要的遊戲中節省大量的資源。 如果一條貿易路線被摧毀後需要重建，那麼絲綢之路將大大降低重建的成本。
                另外，研發<a href="Shipwright.php">造船匠</a>和絲綢之路後，貿易商旅只要30木材和25黃金，移動速度變的非常快。</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><a href="Berbers.php">柏柏</a>：<a href="Kasbah.php">聚居堡壘</a>能夠加速絲綢之路的研究時間(快25%)。</li>
            </ul>
          </div>
        </div>
        <div class="col-md-4">
