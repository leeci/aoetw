  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>騎士精神是<a href="Franks.php">法蘭克</a>的特殊科技，可於<a href="Castle_Age.php">城堡時代</a>在
              <a
              href="Castle.php">城堡</a>研發。研發後<a href="Stable.php">馬廄</a>工作效率快40%。</p>
          </div>
           <h3>戰術要點</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><a href="Knight.php">騎士</a>一直是法蘭克玩家的軍隊核心。騎士精神可讓法蘭克玩家在短時間內創建一支騎兵大軍。如果有至少五~九個馬廄建議就直接研發騎士精神了。雖然研發的成本可以抵過五名騎兵，但如果玩家經濟許可就應該研究，獲得軍事生產的優勢。如果沒有足夠的馬廄而且城鎮遭受攻擊，那麼研發騎士精神加速量產騎士上場作戰也是可行的</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><a href="Berbers.php">柏柏</a>：<a href="Kasbah.php">聚居堡壘</a>能夠加速騎士精神的研究時間(快25%)。</li>
            </ul>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#31b0d5;">
                <div class="unititle"><a href="">騎士精神</a>
                </div>
              </td>
            </tr>
            <tr>
