  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>貿易商旅是一種無法攻擊的船艦，在封建時代的時候可以從碼頭中被訓練。</p>
          </div>
           <h3>概要</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <p>貿易商旅被用來在兩個文明（同盟、中立、敵人都可以）碼頭之之間交易產生黃金，在兩個碼頭中間形成貿易路線。貿易其實並不影響兩個文明之間的資源交換，空的貿易商旅移動另一個文明的碼頭，並帶著黃金返航。獲得的黃金數量取決於兩個碼頭間的距離，距離越遠產黃金就越多。</p>
            <p>重要的是，兩個碼頭之間的距離至少要5格以上才能夠產生一個黃金。值得一提的是，如果是大型地圖最遠的距離，一次可以產生的最大黃金量是513。</p>
            <p>由於大部分地圖上的金礦數量是有限的，交易是遊戲晚期極為重要黃金來源。因此貿易路線是攻擊的主要目標，應該要加強防守。在大後期決戰中，往往決定勝負的關鍵都在於貿易車隊有無安全的運行。</p>
          </div>
           <h3>與貿易車隊比較</h3> 
          <div class="hrn1"></div>
          <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" src="img/CastleAgeUnique.png" style="margin: 2px;" alt=""><a href="Sultans.php">蘇丹</a>(+10%，<a href="Indians.php">印度</a>限定)</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" style="margin: 2px;" src="img/Drydock.jpg" alt=""><a href="Dry_Dock.php">旱碼頭</a>(+15%)
                <br>
                <img class="gg" style="margin: 2px;" img width="22" src="img/CaravanII.png"
            ...
            <tr>
              ...
              <td class="tta4">
                <img style="margin: 2px;" class="gg" src="img/Shipwright.jpg" alt=""><a href="Shipwright.php">造船匠</a>(-20%)
                <br>
                <img class="gg" src="img/Unique-tech.jpg" style="margin: 2px;" alt=""><a href="Silk_Road.php">絲綢之路</a>(-50%，<a href="Italians.php">義大利</a>限定)</td>
            </tr>
          </table>
          <h3>剋貿易商旅的單位與建築</h3>
          <div class="hrn1"></div>
          <div class="n1">以下單位擁有對貿易商旅的額外傷害，按照傷殺力排列。
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-6">
          ...
          <div class="n1">
            <ul>
              ...
              <li><a href="Persians.php">波斯</a>：貿易商旅訓練的速度在封建/城堡/帝王提高10/15/20%， <a href="Careening.php">傾側維修術</a>的研究速度在城堡/帝王提高15/20％。研究
                <a
                href="Dry Dock.php">旱碼頭</a>的速度快20％。</li>
              <li><a href="Portuguese.php">葡萄牙</a>：貿易商旅訓練減少15%黃金，貿易商旅+10％HP。</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><a href="Spanish.php">西班牙</a>：貿易商旅可以產生多25%的黃金</li>
              <li><a href="Teutons.php">條頓</a>：隊伍中的貿易商旅對招降的抵抗力更強。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              ...
              <li>團隊有<a href="Spanish.php">西班牙</a>人時貿易商旅多產生33%黃金。</li>
            </ul>
            ...
            <ul>
              ...
              <li>4.8版本後團隊有<a href="Spanish.php">西班牙</a>人時貿易商旅多產生25%黃金。</li>
            </ul>
          </div>
          <h3>豆知識</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><a href="Berbers.php">柏柏</a>的貿易商旅當研發<a href="Dry_Dock.php">旱碼頭</a>和
                <a
                href="Caravan.php">大商隊</a>會是遊戲中最快的單位，移動速度達2.0547！</li>
            </ul>
          </div>
          <h3>歷史</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <p>“歐洲北部沿海地區的貿易需求導致了新型船舶的發展，這些新型船舶具有寬梁，深拉，方帆，船尾舵和大貨艙。這種新設計的船被稱為貿易商旅，他們主宰了中世紀從波羅的海到西地中海的海上貿易。由於這些船不能輕易地在海灘上拖曳，港口要求碼頭要擴建到水深足以讓貿易商旅可以停留的水域，遠東的貿易商旅相當於中國的戎克船，一艘西方在幾個世紀內仍無法超越的更先進的船。“</p>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#3c763d;;">
                <div class="unititle"><a href="">貿易商旅</a>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/TradeCogIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">民用、<a href="Naval_Vessels.php">船</a>
              </td>
            </tr>
            <tr>
          ...
          <div class="wiki" style="margin-top: 5px;">
            ...
            <div style="margin-left: 60px;">維基百科上的戎克船
              <div style="margin-left: 10px;"><i><b><a href="https://zh.wikipedia.org/wiki/%E6%88%8E%E5%85%8B%E8%88%B9">戎克船</a></b></i>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            <div class="col-md-4"> <a href="img/Tradecog.png"><img class="imgn" class="hg" src="img/Tradecog.png" alt=""></a> 
              <p><em>一群貿易商旅。</em>
              </p>
            </div>
            <div class="col-md-4"> <a href="img/TradeCogHD.png"><img class="imgn" class="hg" src="img/TradeCogHD.png" alt=""></a> 
              <p><em>各種貿易商旅(世紀帝國和征服者入侵資料片)。</em>
              </p>
            </div>
            <div class="col-md-4"> <a href="img/TradeCogDLC.png"><img class="imgn" class="hg" src="img/TradeCogDLC.png" alt=""></a> 
