  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>穆斯塔法帕夏是個火藥單位英雄，在"世界地國II:非洲王朝"資料片之後版本的地圖編輯器出現，穆斯塔法帕夏的名字是以同名的土耳其軍事領導人所命名，該名領導者是鄂圖曼帝國最後試圖擴張到中歐和東歐的中心人物。</p>
            <p>在遊戲中穆斯塔法帕夏的外型是土耳其火槍兵，他會受到所有弓兵和火藥單位科技加成的影響。他不能被招降而且會自行回血。</p>
          </div>
          <div></div>
          <div></div>
        </div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><a href="">穆斯塔法帕夏</a>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/JanissaryIcon.jpg" width="80" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4"><a href="">火藥單位<br>英雄</a>
              </td>
            </tr>
            <tr>
