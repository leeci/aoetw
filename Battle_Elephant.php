        ...
        <div class="col-md-8">
          ...
          <div class="n1">
            <ul>
              ...
              <li>為什麼非洲文明不使用大象？雖然非洲象比亞洲象身軀龐大，但非洲象並沒有像亞洲象那樣被運用到戰事和典禮之中，因為非洲象難以馴養。一些非洲君主也曾使用過象，但使用的是現今已經絕滅了的北非象(North
                African elephant) 。因此馴象的使用大多數被限制於亞洲象居住的地區。</li>
              <li>大象在東南亞被廣泛運用於死刑之中，在緬甸有相當長的一段歷史，而在中南半島的占城，其歷史同樣悠久。在暹羅，人們訓練大象在殺死犯人之前將他擲向空中。1821年，約翰·克勞福德（John
                Crawfurd）作為英國使節前往交趾支那（現在越南南部），目睹了另一種象刑的行刑方法。克勞福德描述道：「罪人被綁在木樁上，（陛下的）大象沖向了他，並將他踐踏致死。」</li>
            </ul>
          </div>
           <h3>歷史</h3>
          <div class="hrn1"></div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#3c763d;;">
                <div class="unititle2">矛象伕</div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/Battleelephanticon.png" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="img/EliteBattleElephantIcon.png" alt=""><a href="Elite_Battle_Elephant.php">精銳矛象伕</a>
              </td>
            </tr>
            <tr>
              <td class="unit3">升級成本</td>
              <td class="unit4">
                <img class="gg" src="img/Battleelephantupgrade.png" alt="">1200食物900黃金</td>
            </tr>
            <tr>
        ...
        <div class="col-md-12">
          ...
          <div class="n1">
            <div class="col-md-12">
              ...
              <div class="col-md-4"> <a href="img/Battle_Elephant_group.jpg"><img class="imgn" class="hg" src="img/Battle_Elephant_group.jpg" alt=""></a> 
                <p><em>一群矛象伕。</em>
                </p>
              </div>
            </div>
