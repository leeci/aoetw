  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p><strong>貝查德爵士</strong>是《世紀帝國 II HD: 帝王世紀》中的一名騎兵英雄，可以在戰役編輯器中找到。現實中他是百年戰爭中的老兵並和他的同伴梅茲爵士在1429年護送聖女貞德從沃庫勒爾到支農。這史實也忠實反映梅茲爵士出現在聖女貞德戰役“一個不大可能的彌賽亞”的場景中。貝查德爵士有騎士的外貌但有更好的戰鬥力。由於他屬於英雄單位，因此不能被招降且會回血(在征服者資料片後)
              。</p>
            <p></p>
          </div>
          <div></div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><a href="">貝查德爵士</a>
                </div>
              </td>
            </tr>
            <tr>
          ...
          <div class="wiki" style="margin-top: 5px;">
            ...
            <div style="margin-left: 60px;">維基百科上的貝查德爵士
              <div style="margin-left: 10px;"><i><strong><a href="https://en.wikipedia.org/wiki/Bertrand_de_Poulengy">貝查德爵士</a></strong></i>
              </div>
            </div>
          </div>
        </div>
