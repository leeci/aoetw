  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p><strong>洛林的約翰</strong>是《世紀帝國 II HD: 帝王世紀》中的一名英雄，可以在聖女貞德第五戰役"巴黎攻城戰"和戰役編輯器中找到。洛林的約翰是以馬克·吐溫的小說“聖女貞德的個人回憶”的洛林的約翰為基礎的。他被形容為“著名的砲手”，約翰二世更邀請他參與攻擊英軍的圍城行動。由於他屬於英雄單位，因此不能被招降且會回血(在征服者資料片後)
              。</p>
            <p></p>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/Jeandelorrain.png" width="80" alt="">
                </div>
              </td>
            </tr>
            <tr>
