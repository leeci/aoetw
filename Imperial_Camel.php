  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">帝王駱駝騎兵是<a href="Imperial_Age.php">帝王時代</a>兵種，可訓練於<a href="Stable.php">馬廄</a>，對於騎兵較有優勢，為
            <a
            href="Indians.php">印度</a>的特殊兵種。</div>
          <h3>戰術</h3>
          <div class="hrn1"></div>
          <div class="n1">在<a href="Indians.php">印度</a>文明出現後帝王駱駝騎兵為帝王時代最強大的騎兵之一，因為印度文明並沒有<a href="Cavalier.php">騎兵</a>所以駱駝兵種成為印度不可或缺的兵種之一。雖然坦度不如騎兵類型但是可以有效的克制對方的騎兵造成重大的傷害。帝王駱駝騎兵雖為印度的特殊兵種，卻不會受到
            <a
            href="Samurai.php">日本武士</a>的攻擊加成。帝王駱駝基本上你可以把他當成<a href="Paladin.php">遊俠</a>看待。而帝王駱駝搭配<a href="Elite_Skirmisher.php">戰矛兵</a>則是
              <a
              href="Indians.php">印度</a>在後期簡單又威力無窮的組合。</div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Skirmisher.php">矛兵</a>、<a href="Siege_Weapons.php">攻城器單位</a>、
                <a
                href="Cavalry_Archer.php">馬弓騎兵</a>、<a href="Cavalry_Units.php">騎兵單位</a>。</td>
            </tr>
            <tr>
          ...
          <div class="n1">
            <ul>
              <li><a href="Indians.php">印度</a>：帝王駱駝騎兵+1/+1防禦。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
          ...
          <div class="n1">
            ...
            <ul>
              <li>帝王駱駝騎兵的防禦類型有包括<a href="Armor_Class_Ship.php">船艦護甲</a>，所以會同時承受反船/反駱駝攻擊加成。</li>
            </ul>
          ...
          <div class="n1">
            <ul>
              <li>駱駝是少數幾個符合史實的單位，從古至今，駱駝被地中海和印度地區的軍隊使用，雖然目前還不清楚中國和蒙古是否用駱駝作戰，但肯定的是他們會拿來運送物資。</li>
              <li>遊戲中的駱駝騎兵是單峰駱駝，而現實中;中國與蒙古原產的是雙峰駱駝，速度極為緩慢，並不適合作戰。</li>
              <li>中國和蒙古是遊戲中，除了非洲與中東國家外，唯二有駱駝的文明。</li>
          ...
          <div class="n1"><strong>駱駝為何剋馬？：</strong>
            ...
            <img
            class="img-responsive" class="imgn" src="img/camelhorse.jpg" alt="">
              <p>駱駝的確比馬大很多</p>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#3c763d;;">
                <div class="unititle"><a href="">帝王駱駝騎兵</a>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/ImperialCamelIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
        ...
        <div class="col-md-12">
          ...
          <div class="n1">
            <div class="col-md-12">
              <div class="col-md-4"> <a href="img/AOF35_Imperial_Camel.jpg"><img class="imgn" class="hg" width="250" src="img/AOF35_Imperial_Camel.jpg" alt=""></a> 
                <p><em>失落的帝國，3.5版本的帝王駱駝騎兵。</em>
                </p>
              </div>
              <div class="col-md-4"> <a href="img/AOF36_Imperial_Camel.jpg"><img class="imgn" class="hg" src="img/AOF36_Imperial_Camel.jpg" alt=""></a> 
                <p><em>3.6版本的帝王駱駝騎兵。</em>
                </p>
              </div>
              <div class="col-md-4"> <a href="img/D.png"><img class="imgn" class="hg" src="img/D.png" alt=""></a> 
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-4"> <a href="img/Indians_preview.png"><img class="imgn" class="hg" src="img/Indians_preview.png" alt=""></a> 
                  <p><em>失落的帝國還沒釋出前的官方圖，可以看到帝王駱駝的最初樣子。</em>
                  </p>
                </div>
                <div class="col-md-4"> <a href="img/Imperial_Camel_AoFE.jpg"><img class="imgn"  class="hg" src="img/Imperial_Camel_AoFE.jpg" alt=""></a> 
                  <p><em>3.6版本的帝王駱駝騎兵。</em>
                  </p>
                </div>
              </div>
