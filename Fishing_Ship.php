  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>漁船在海上算是一個弱小的單位，負責捕魚增加肉的生產，可以在<a href="Dock.php">碼頭</a>訓練。</p>
            <p>漁船可以建造類似於水上農田的魚網，雖然魚網需要更長的時間建設，但比較多食物。漁船捕魚的速度比從魚網捕魚還要快，大概與村民捕魚或是種田一樣。</p>
            <p>值得一提的是幾個文明，<a href="Japanese.php">日本</a>的漁船工作效率極高，而<a href="Italians.php">義大利</a>的漁船相當便宜，
              <a
              href="Malay.php">馬來</a>的漁網有無限的食物採集量。</p>
          </div>
           <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          ...
          <h3>剋漁船的單位與建築</h3>
          <div class="hrn1"></div>
          <div class="n1">以下單位擁有對漁船的額外傷害，按照傷殺力排列。
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-6">
                  ...
                  <ul>
                    ...
                    <li>
                      <img src="img/LongboatIcon.jpg" class="gg" alt=""><a href="Longboat.php">精銳維京大戰船</a>(<a href="Vikings.php">維京</a>限定)</li>
                  </ul>
          ...
          <div class="n1">
            <ul>
              <li><a href="Berbers.php">柏柏</a>：漁船移動速度提高10％。</li>
          ...
          <div class="n1">
            <ul>
              <li><a href="Teutons.php">條頓</a>：隊伍中的漁船對招降的抵抗力更強。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li>漁船可以完成村民未建造完成的建築物如果該建築物是在岸邊的話。</li>
            ...
            <ul>
              ...
              <li><a href="Italians.php">義大利</a>:漁船視野+2。</li>
            </ul>
            <h3><em><a href="ak.php">非洲王朝</a></em></h3>
            <ul>
              <li><a href="Italians.php">義大利</a>:4.8版本後漁船現在便宜33%並移除+2視野。</li>
            </ul>
            <h3><em><a href="aor.php">王者崛起</a></em></h3>
            <ul>
              <li><a href="Italians.php">義大利</a>:5.5版本後漁船現在便宜20%。</li>
              <li><a href="Malay.php">馬來</a>:最初漁船便宜33%，5.3版本後該利益被移除。</li>
              <li><a href="ver5-8.php">5.8版</a>後義大利魚船花費60W → 64W (其他文明 75W)</li>
              <li><a href="ver5-8.php">5.8版</a>火蒙衝對漁船傷害 3hp → 1hp</li>
            </ul>
          </div>
          <h3>歷史</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <div class="ien">
              <p>中世紀造船，航海技術和導航技術大幅改善。這些進步的結果是漁船的捕魚範圍和效率更大。歐洲，北非和亞洲海岸的豐富水域提供了豐富的海產，可以通過乾燥和鹽漬來保存。保存的魚，特別是鱈魚，在中世紀後期成為重要的貿易品。</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#3c763d;;">
                <div class="unititle"><a href="Fishing Ship.php">漁船</a>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/FishingShipIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">平民、<a href="Naval_Vessels.php">船</a>
              </td>
            </tr>
            <tr>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            <div class="col-md-4"> <a href="img/Fishingship.png"><img class="imgn" class="hg" src="img/Fishingship.png" alt=""></a> 
              <p><em>一群漁船。</em>
              </p>
            </div>
            <div class="col-md-4"> <a href="img/Fishingshipworking.png"><img class="imgn" class="hg" src="img/Fishingshipworking.png" alt=""></a> 
              <p><em>工作中的漁船。</em>
              </p>
            </div>
            <div class="col-md-4"> <a href="img/Fishingshipworkingtrap.png"><img class="imgn" class="hg" src="img/Fishingshipworkingtrap.png" alt=""></a> 
              <p><em>收集漁網食物的漁船。</em>
              </p>
            </div>
          </div>
