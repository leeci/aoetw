  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>封建時代是帝國時代的第二個時代。 它允許訓練和建造更多的單位和建築，還有更多的科技可以研發。 玩家可以使用一系列的<a href="Infantry_Units.php">步兵</a>、
              <a
              href="Cavalry_Units.php">騎兵</a>、<a href="Archer_Units.php">弓箭手</a>和<a href="Naval_Vessels.php">海軍單位</a>以及有效的防禦建築。</p>
          </div>
          <h3>可建造建築</h3>
          <div class="hrn1"></div>
          ...
          <div class="n1">
            ...
            <div class="n1"><strong>城鎮中心</strong>
              ...
              <div class="n1">
                <ul>
                  <li><a href="Ethiopians.php">衣索比亞</a>：到封建時代可獲得100金、100肉。</li>
                  <li><a href="Italians.php">義大利</a>：研發封建時代成本減少15％。</li>
                  <li><a href="Khmer.php">高棉</a>：升級封建時代不需要前置建築。</li>
                  <li><a href="Malay.php">馬來</a>：研究封建時代速度快80。</li>
                </ul>
                <h3>戰術</h3>
                <div class="hrn1"></div>
                <div class="n1">
                  <p>封建時代通常是不同文明開始脫穎而出的地方。弓箭手，騎兵和海上文明可以開始在這個時代訓練他們的基本單位。封建時代也是軍事衝突開始發生的地方。玩家應該考慮開採石礦，準備在
                    <a
                    href="Castle_Age.php">城堡時代</a>建造威力強大的<a href="Castle.php">城堡</a>。玩家也應該開始消除城鎮旁的漏洞，用圍牆或是建築搭配天然障礙物以防止其他玩家的早期攻擊。</p>
                  <p>正是在這個階段，玩家開始決定採取哪種策略。如果選擇步兵，弓箭手或騎兵的快攻，玩家必須建立一個兵營（至少兩個，如果他們選擇棒棒快攻(民兵)），然後射箭場或馬廄（取決於他們的文明加成）和一個兵工廠以升級他們的單位。另外，重點要放在經濟的調配上，打什麼樣的策略去決定要收集甚麼資源。如果玩家進行塔攻，或是防守城鎮；抑或是快速上城堡時代然後蓋城堡，他們應該把重點放在收集木材和石頭上，建立一個市集（可以做資源交換），並讓至少八個村民在農田採集食物維持經濟。</p>
                  <p>如果玩家想要趕快進入城堡時代進行僧快(僧侶快攻)，馬暴(大量騎士)或是其他城堡時代的快攻，那麼他們應該建立一個市場和一個兵工廠，或是建立一個軍營和訓練一些長槍兵，也許在蓋一些塔保護自己。在經濟注重食物和黃金收集然後盡快進入城堡時代。</p>
                  <p>在達到封建時代的團隊遊戲中，製圖法可讓玩家分享盟友的視線。進貢策略也從封建時代開始，因為可以興建市場並且能夠進貢和交換資源，達到快速進入下個時代用更強大的軍隊和經濟打敗對手。</p>
                </div>
              </div>
            </div>
             <h3>歷史</h3>
            <div class="hrn1"></div>
            <div class="n1">
              <p>查理曼大帝在西元九世紀時創建法蘭西帝國，結束了歐洲的黑暗時代，也是封建時代的開始。大部分被西歐野蠻人部落統治的的地方正慢慢被地方力量收復。羅馬教會正在提供一個統一的社會結構。查理大帝試圖恢復教育，鼓勵藝術發展。然而，他的帝國在他去世後走向頹勢，新的掠奪者破壞了他的大部分建設和制度。政治和經濟權力從國王轉移到統治層級內的地主。普通百姓在這片土地上耕耘，供養著貴族和教士。</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
