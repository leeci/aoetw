...
<td class="t19 trm"></td>  
        ...
        <tr>
          ...
          <td class="t15 trm"><img class="gg" src="img/GenitourIcon.jpg"><a href="Genitour.php"><div>標槍騎兵</div></a> <i class="fas fa-arrow-down"></i></td>
        ...
        <tr>
          ...
          <td class="t15 trm"><img class="gg" src="img/GenitourIcon.jpg"><a href="Genitour.php"><div>精銳標槍騎兵</div></a></td>
        ...
        <tr>
          <td style=" vertical-align: middle; " class="t5 trm ca"><a href="Castle_Age.php">城堡時代</a></td>
         <td class="t13 trm">
          <img class="gg" src="img/CamelArcherIcon.jpg" width="30" alt=""><div><a href="Camel_Archer.php">駱駝弓騎兵</a></div>
          </td>
          <td class="t13 trm">
            <img class="gg" src="img/PetardIcon.jpg" width="30" alt=""><div><a href="Petard.php">爆炸桶</a></div>
          </td>
          <td class="t13 trm"><img class="gg" src="img/CastleAgeUnique.png" width="30" alt=""><div><a href="Kasbah.php">聚居堡壘</a></div></td>
          <td class="t13 trm"></td>
          <td class="t13 trm"></td>
          <td class="t13 trm"></td>
          <td class="t13 trm"></td>
        ...
        <tr>
          <td style=" vertical-align: middle; " class="t5 trm im"><a href="Imperial_Age.php">帝王時代</a></td>
          <td class="t13 trm">
          <img class="gg" src="img/CamelArcherIcon.jpg" width="30" alt=""><div><a href="Camel_Archer.php">精銳駱駝弓騎兵</a></div>
          </td>
          <td class="t13 trm"><img class="gg" src="img/TrebuchetPackedIcon.jpg" width="30" alt=""><div><a href="Trebuchet.php">巨型投石機</a></div></td>
          <td class="t13 trm"><img class="gg" src="img/Unique-tech.jpg" width="30" alt=""><div><a href="Maghrabi_Camels.php">馬格拉比駱駝</a></div></td>
   ...
   <tr>
    <td style=" vertical-align: middle; " class="t5 trm fe"><a href="Feudal_Age.php">封建時代</a></td>           
        ...
        <tr>
          ...
          <td class="t10 trm"><img class="gg" src="img/CannonGalleonIcon.jpg"><div><a href="Cannon_Galleon.php">火炮戰船</a></div><i class="fas fa-arrow-down"></i><br><img class="gg" src="img/CannonGalleonIcon.jpg"><div><a href="Elite_Cannon_Galleon.php" class="not">精銳火炮戰船</a></div></td>
