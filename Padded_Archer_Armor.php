  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>弓兵布甲可於<a href="Feudal_Age.php">封建時代</a>在 <a href="Blacksmith.php">兵工廠</a> 研發，可讓弓兵護甲+1/+1。</p>
          </div>
          <h3>文明加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
          ...
          <div class="hrn1"></div>
          <div class="n1">
            <p>弓箭手和矛兵通常不會進行近身戰鬥，所以他們在中世紀早期很少穿盔甲。他們需要靈活的手臂運動，並迅速地在戰場上移動。所以有些時候這些部隊會穿上不會影響其戰鬥能力的護甲。一種早期的輕型裝甲是穿在軀幹上的簡單襯墊，可以提供一些保護，免受近戰或箭矢攻擊。</p>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#31b0d5;">
                <div class="unititle"><a href="">弓兵布甲</a>
                </div>
              </td>
            </tr>
            <tr>
