  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>到了<a href="Imperial_Age.php">帝王時代</a>雙手劍兵可以在<a href="Barracks.php">兵營</a>被訓練。這是民兵的第四級升級。</p>
            <p>除了<a href="Persians.php">波斯人</a>之外，所有文明都有雙手劍兵。</p>
          </div>
          <h3>戰術</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <p>雙手劍兵主要用於帝王時代的早期</p>
            <p>除了沒有劍兵勇士的國家外，雙手劍兵並不常見，他主要出現在帝王初期，但值得一提的是他對鷹勇士有相當顯卓的攻擊效果。</p>
            <p><a href="Malay.php">馬來人</a>的情況是特別有趣的，因為他們的獨特技術之一是<a href="Forced Levy.php">強制徵兵</a>，使得劍兵系列不用耗費黃金訓練，使得這些部隊成為後期“垃圾戰爭”中一個可行的策略，輕鬆擊敗其他垃圾單位（
              <a
              href="Halberdier.php">戟兵</a>，<a href="Hussar.php">輕騎兵</a>和<a href="Elite_Skirmisher.php">戰矛兵</a>）。</p>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Skirmisher.php">矛兵</a>、<a href="Villager.php">戟兵</a>、<a href="Scout_Cavalry.php">駱駝騎兵</a>、
                <a
                href="Eagle_Scout.php">鷹勇士</a>、<a href="building.php">建築物</a>、<a href="Spearman.php">輕騎兵</a>。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><a href="Archer_Units.php">弓兵</a>、<a href="Scorpion.php">弩炮</a>、<a href="Cataphract.php">聖騎兵</a>、
                <a
                href="Jaguar_Warrior.php">豹勇士</a>、<a href="Boyar.php">貴族鐵騎</a>、<a href="Hand_Cannoneer.php">火槍兵</a>、
                  <a
                  href="Conquistador.php">征服者</a>、<a href="Janissary.php">土耳其火槍兵</a>、<a href="Slinger.php">投石手</a>、
                    <a
            ...
            <tr>
              ...
              <tr>
                ...
                <td class="tta4">
                  <img class="gg" src="img/Unique-tech.jpg" width="30" alt=""><a href="Forced_Levy.php">強制徵兵</a>:軍營步兵單位訓練不需花黃金，<a href="Malay.php">馬來</a>限定。</td>
              </tr>
          </table>
          <h3>剋雙手劍兵的單位與建築</h3>
          <div class="hrn1"></div>
          <div class="n1">以下單位擁有對雙手劍兵的額外傷害，按造傷殺力排列。
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-6">
          ...
          <div class="n1">
            <ul>
              <li><a href="Aztecs.php">阿茲特克</a>：雙手劍兵生產速度提高15％。</li>
              <li><a href="Burmese.php">緬甸</a>：雙手劍兵在帝王時代有+3攻擊。</li>
              <li><a href="Celts.php">賽爾特</a>：雙手劍兵移動加快15％。</li>
              <li><a href="Chinese.php">中國</a>：利於雙手劍兵的技術在帝王時代便宜20％。</li>
              <li><a href="Goths.php">哥德</a>：雙手劍兵便宜35％並對<a href="Armor_Class_Standard_Building.php">標準建築</a>攻擊+1。研發
                <a
                href="Perfusion.php">灌注士氣</a>後研發<a href="Tracking.php">追縱技術</a>、<a href="Squires.php">護衛</a>、
                  <a
                  href="Arson.php">縱火</a>和升級劍兵勇士的速度快100%。</li>
              <li><a href="Japanese.php">日本</a>：雙手劍兵攻速快33％。</li>
              <li><a href="Magyars.php">馬札爾</a>：免費升級<a href="Forging.php">鍛造</a>、<a href="Iron_Casting.php">鑄造</a>和
                <a
                href="Blast_Furnace.php">鼓風爐</a>。</li>
              <li><a href="Malians.php">馬利</a>：雙手劍兵在帝王時代有 +3 遠程護甲。</li>
              <li><a href="Portuguese.php">葡萄牙</a>：雙手劍兵黃金成本減少15％。</li>
              ...
              <li><a href="Vikings.php">維京</a>：雙手劍兵在城堡/帝王時代加15％/20％的生命值。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li><a href="Goths.php">哥德</a>：雙手劍兵訓練和升級快20%。研發<a href="Tracking.php">追縱技術</a>、
                <a
                href="Squires.php">護衛</a>、<a href="Arson.php">縱火</a>科技的時間快20%。</li>
              <li><a href="Teutons.php">條頓</a>：雙手劍兵更不容易被招降。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li>雙手劍兵現在攻擊有11。</li>
              <li>雙手劍兵擁有+3攻擊VS<a href="Armor_Class_Standard_Building.php">標準建築</a>。</li>
              <li>雙手劍兵遠防是0。</li>
              <li><a href="Goths.php">哥德</a>:在帝王時代，雙手劍兵成本便宜25%。</li>
            </ul>
            <h3><em><a href="aoc.php">征服者入侵</a></em></h3>
            <ul>
              <li>雙手劍兵擁有+6攻擊VS<a href="Armor_Class_Eagle_Warrior.php">鷹勇士</a>。</li>
              <li>雙手劍兵現在擁有1的遠防。</li>
              <li>引入<a href="Heresy.php">異端邪說</a>。</li>
              <li><a href="Goths.php">哥德</a>:1.0c後，哥德雙手劍兵便宜35%。引入<a href="Perfusion.php">灌注士氣</a>
              </li>
            </ul>
            <h3><em><a href="aof.php">失落的帝國</a></em></h3>
            <ul>
              <li>雙手劍兵現在攻擊有12。</li>
              <li>雙手劍兵擁有+4攻擊VS<a href="Armor_Class_Standard_Building.php">標準建築</a>。</li>
              <li>雙手劍兵擁有+8攻擊VS<a href="Armor_Class_Eagle_Warrior.php">鷹勇士</a>。</li>
            </ul>
            <h3><em><a href="ak.php">非洲王國</a></em></h3>
            <ul>
              <li>新科技<a href="Arson.php">縱火</a>引進。</li>
              <li><a href="Vikings.php">維京</a>:4.8版本引進<a href="Chieftains.php">酋長</a>科技，雙手劍兵對
                <a
                href="Armor_Class_Cavalry.php">騎兵單位</a>有+5攻擊。</li>
              <li><a href="Vikings.php">維京</a>:在4.8b版本後，<a href="Chieftains.php">酋長</a>讓雙手劍兵對駱駝有額外+2攻擊。</li>
            </ul>
            <h3><em><a href="aor.php">王者崛起</a></em></h3>
            <ul>
              <li><a href="Vikings.php">維京</a>:5.7版本<a href="Chieftains.php">酋長</a>科技現在讓雙手劍兵對駱駝有額外+4攻擊。</li>
            </ul>
          </div>
          <h3>趣事</h3>
          <div class="hrn1"></div>
          ...
          <div class="n1">
            <div class="col-md-12">
              ...
              <div class="col-md-4"> <a href="img/Twohandedswordsman.png"><img  class="imgn" class="hg" width="250" src="img/Twohandedswordsman.png" alt=""></a> 
                <p><em>一群雙手劍兵</em>
                </p>
              </div>
            </div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#3c763d;;">
                <div class="unititle"><a href="">雙手劍兵</a>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/2HandedswordsmanIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">除了<a href="Persians.php">波斯</a>以外的文明</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="img/Champion-research.jpg" alt="">750肉350金</td>
            </tr>
            <tr>
