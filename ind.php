...
<td class="t19 trm"></td>  
        ...
        <tr>
          ...
          <td class="t19 trm not"><img class="gg" src="img/KnightIcon.jpg"><div><a href="Knight.php">騎士</a></div><i class="fas fa-arrow-down"></i></td>
        ...
        <tr>
          ...
          <td class="t19 trm"><img class="gg" src="img/HeavyCamelIcon.jpg"><div><a href="Heavy_Camel.php">重裝駱駝騎兵</a></div><i class="fas fa-arrow-down"></i><br><img class="gg" src="img/ImperialCamelIcon.jpg"><div><a href="Imperial_Camel.php" class="">帝王駱駝騎兵</a></div></td>
        ...
        <tr>
         ...
         <td class="t13 trm">
          <img class="gg" src="img/ElephantArcherIcon.jpg" width="30" alt=""><div><a href="Elephant_Archer.php">象弓騎兵</a></div>
          </td>
          <td class="t13 trm">
            <img class="gg" src="img/PetardIcon.jpg" width="30" alt=""><div><a href="Petard.php">爆炸桶</a></div>
          </td>
          <td class="t13 trm"><img class="gg" src="img/CastleAgeUnique.png" width="30" alt=""><div><a href="Sultans.php">蘇丹</a></div></td>
          <td class="t13 trm"></td>
          <td class="t13 trm"></td>
          <td class="t13 trm"></td>
          <td class="t13 trm"></td>
        ...
        <tr>
          <td style=" vertical-align: middle; " class="t5 trm im"><a href="Imperial_Age.php">帝王時代</a></td>
          <td class="t13 trm">
          <img class="gg" src="img/ElephantArcherIcon.jpg" width="30" alt=""><div><a href="Elephant_Archer.php">精銳象弓騎兵</a></div>
          </td>
          <td class="t13 trm"><img class="gg" src="img/TrebuchetPackedIcon.jpg" width="30" alt=""><div><a href="Trebuchet.php">巨型投石機</a></div></td>
          <td class="t13 trm"><img class="gg" src="img/Unique-tech.jpg" width="30" alt=""><div><a href="Shatagni.php">印度火槍</a></div></td>
   ...
   <tr>
    ...
    <table class="table" style="margin-top:50px;">
        ...
        <tr>
         ...
         <td class="t11 trm"><img class="gg" src="img/Heatedshot.png" alt=""><div><a href="Heated Shot.php">預熱射擊</a></div></td>
