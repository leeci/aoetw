...
and (max-device-width: 480px)  {
  ...
  <body style=" font-family: " 微軟正黑體 ";">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <tr>
          ...
          <td class="t19 trm">
            ...
            <br>
            <img class="gg not" src="img/ChampionIcon.jpg" alt="">
    ...
    <tr>
      ...
      <td class="t13 trm">
        <img class="gg" src="img/PlumedArcherIcon.jpg" width="30" alt="">
        <div><a href="Plumed_Archer.php">羽毛箭射手</a>
        </div>
      </td>
      <td class="t13 trm">
      ...
      <td class="t13 trm">
        ...
        <div><a href="Obsidian_Arrows.php">黑曜石之箭</a>
        </div>
      </td>
      <td class="t13 trm"></td>
      <td class="t13 trm"></td>
    ...
    <tr>
      ...
      <td class="t13 trm">
        <img class="gg" src="img/PlumedArcherIcon.jpg" width="30" alt="">
        <div><a href="Plumed_Archer.php">精銳羽毛箭射手</a>
        </div>
      </td>
      <td class="t13 trm">
      ...
      <td class="t13 trm">
        ...
        <div><a href="El_Dorado.php">黃金國</a>
        </div>
      </td>
      <td class="t13 trm ">
      ...
      <tr>
        ...
        <tr>
          ...
          <td class="t11 trm">
            ...
            <br>
            <img class="gg not" src="img/Bombard-tower-research.jpg" alt="">
