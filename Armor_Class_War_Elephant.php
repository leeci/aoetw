  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-12">
          <div class="spw"><em>這篇文章是將有關於戰象系裝甲的。而關於戰象單位這個兵種的資料請參見<a href="War_Elephant.php">波斯戰象</a></em>
          </div>
        </div>
        <div class="col-md-12">
          <div class="n1">
            <p>戰象系是一個防禦裝甲類別，所有在這個系列的兵種都會被剋戰象系的兵種有額外的傷害。</p>
          </div>
           <h3>戰象系單位</h3>
          <div class="hrn1"></div>
          <div class="n1">下列的單位都是戰象系單位
           ...
           <h3>剋戰象系的單位與建築</h3>
          <div class="hrn1"></div>
          <div class="n1">以下單位擁有對戰象系的額外傷害，按照傷殺力排列。
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-4">
