  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>卡拉維爾戰船是<a href="ak.php">非洲王朝</a>資料片中<a href="Portuguese.php">葡萄牙</a>的第二個特殊單位。在城堡時代時可以在碼頭中訓練。它是艘可以像弩炮一樣傷害多個單位的戰船。</p>
            <p>卡拉維爾戰船可在帝王時代升級成精銳卡拉維爾戰船。</p>
          </div>
           <h3>戰術</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <p>卡拉維爾戰船的攻擊可以傷害一直線上的單位，讓他們能殺死在岸邊的群聚單位或是在海上擊沉多艘敵方船艦。</p>
            <p>卡拉維爾戰船在大多數戰鬥表現中都比<a href="War_Galley.php">弩炮戰船</a>好，然而在1對1的戰鬥中他們會輸給弩炮戰船，精銳卡拉維爾戰船則會輸給重型弩炮戰船。若是論打群架，卡拉維爾戰船則可以輕易地用穿透傷害戰勝他們。</p>
            <p>卡拉維爾戰船只比<a href="War_Galley.php">弩炮戰船</a>貴一點，但是到城堡時代不需升級就能馬上訓練。在後期如果要同時訓練卡拉維爾戰船和弩炮戰船/
              <a
              href="Galleon.php">重型弩炮戰船</a>的話玩家的經濟必須相當的好才行。但如果同時有這兩種船隻的話前者可以做輸出主力，後者則做肉盾，足以應付敵方的任何艦隊。</p>
          </div>
           <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Transport_Ship.php">運輸船</a>、<a href="Fishing_Ship.php">漁船</a>、在岸邊的
                <a
                href="bulding.php">建築物</a>和近戰單位、<a href="Cannon_Galleon.php">火炮戰船</a>、群體單位。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><a href="Fire_Galley.php">火戰船</a>、<a href="Turtle_Ship.php">龜甲船</a>、
                <a
                href="Longboat.php">維京大戰船</a>、箭塔、<a href="Castle.php">城堡</a>、<a href="Mangonel.php">投石車</a>、
                  <a
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br>
                <img class="gg" src="img/CastleAgeUnique.png" style="margin: 2px;" alt=""><a href="Carrack.php">克拉克帆船</a>(護甲+1/+1)</td>
            </tr>
            <tr>
           ...
           <h3>剋卡拉維爾戰船的單位與建築</h3>
          <div class="hrn1"></div>
          <div class="n1">以下單位擁有對卡拉維爾戰船的額外傷害，按照傷殺力排列。
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-6">
          ...
          <div class="n1">
            <ul>
              <li><a href="Portuguese.php">葡萄牙</a>：卡拉維爾戰船訓練減少15%黃金成本，HP+10％。</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
          ...
          <div class="n1">
            <ul>
              <li>卡拉維爾戰船會對作弊單位中的<a href="Saboteur.php">破壞者</a>有額外攻擊加成(從<a href="aoc.php">征服者入侵</a>資料片開始)，因為該單位屬於船隻單位。</li>
              <li>卡拉維爾戰船是唯一在與戰船系一對一戰鬥中會打輸的特殊船艦。</li>
              <li>如果卡拉維爾戰船與近戰單位搏鬥時，弩會向後發射，就像被該單位的劍反射了一樣。</li>
            </ul>
          </div>
           <h3>歷史</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <div class="ien">
              <p>卡拉維爾戰船是葡萄牙人在早期現代時期廣泛使用的輕型帆船，用於長途航行。葡萄牙人為探索非洲海岸而發展起來的，這艘輕型帆船的主要優勢在於它能夠以驚人的速度迎風航行迎風。"尼娜"和"平塔"是克里斯托弗哥倫佈在1492年曆史性的航行到新世界時使用的三艘船中的其中兩艘，其實就是卡拉維爾戰船。</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#3c763d;;">
                <div class="unititle"><a href="">卡拉維爾戰船</a>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/CaravelIcon2.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">143/165(精銳)</td>
            </tr>
            <tr>
              <td class="unit3">攻擊</td>
              <td class="unit4">6/8(精銳)(遠攻)</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="img/CaravelIcon2.jpg" alt=""><a href="Caravel.php">精銳卡拉維爾戰船</a>
              </td>
            </tr>
            <tr>
              <td class="unit3">升級成本</td>
              <td class="unit4">
                <img class="gg" src="img/Elite-unique-research.jpg" alt="">750食物 475黃金</td>
            </tr>
            <tr>
        ...
        <div class="col-md-12">
          ...
          <div class="n1">
            <div class="col-md-12">
              <div class="col-md-4"> <a href="img/Caravel.png"><img class="imgn" class="hg" src="img/Caravel.png" alt=""></a> 
                <p><em>一群卡拉維爾戰船。</em>
                </p>
              </div>
              <div class="col-md-4"> <a href="img/Caravel_vs_Longboats.jpg"><img class="imgn" class="hg" src="img/Caravel_vs_Longboats.jpg" alt=""></a> 
                <p><em>卡拉維爾戰船對維京大戰船。</em>
                </p>
              </div>
              <div class="col-md-4"> <a href="img/Caravel_history.jpg"><img class="imgn" class="hg" src="img/Caravel_history.jpg" alt=""></a> 
                <p><em>卡拉維爾戰船美術圖。</em>
                </p>
              </div>
            </div>
