  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Infantry_Units.php">步兵</a>、<a href="Battering_Ram.php">衝撞車</a>。</td>
            </tr>
            <tr>
              ...
              <td class="tta4"><a href="Kamayuk.php">槍隊長</a>、<a href="Berserk.php">狂戰士</a>、<a href="Genoese_Crossbowman.php">熱那亞弩手</a>、
                ...
                href="Huskarl.php">哥德衛隊</a>、<a href="Condottiero.php">傭兵</a>、<a href="Mameluke.php">奴隸兵</a>、
                  ...
                  href="Camel.php">駱駝騎兵</a>、<a href="Elite_Skirmisher.php">戰矛兵</a>、<a href="Eagle_Warrior.php">鷹勇士</a>、
                    <a
                    href="Mangonel.php">投石車</a>、<a href="Spearman.php">重裝長槍兵</a>、<a href="Samurai.php">日本武士</a>。</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" src="img/Husbandry.jpg" width="30" alt=""><a href="Husbandry.php">畜牧培養</a>(+10%)</td>
            </tr>
            <tr>
          ...
          <div class="n1">以下單位擁有對征服者的額外傷害，按造傷殺力排列。
            ...
            </div>以下團隊加成可讓以下單位對征服者有額外傷害:
            <div class="n1"><a href="Persians.php">波斯</a>在團隊加成裡，給予以下單位+2額外攻擊vs<a href="Archer_Units.php">弓兵單位</a>。
              <div
              class="col-md-12">
                <div class="col-md-6">
        ...
        <div class="n1">
          <ul>
            <li><a href="Spanish.php">西班牙</a>：兵工廠加成征服者的科技不需花費黃金。</li>
          </ul>
        </div>
         <h3>團隊加成</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <ul>
            <li><a href="Berbers.php">柏柏</a>：<a href="Kasbah.php">聚居堡壘</a>能夠提高征服者的生產速度還有加速徵兵技術的研究時間(快25%)</li>
            <li><a href="Huns.php">匈奴</a>：<a href="Bloodlines.php">品種</a>與<a href="Husbandry.php">畜牧技術</a>研發快20%。</li>
            <li><a href="Teutons.php">條頓</a>：征服者更不容易被招降。</li>
            <li><a href="Turks.php">土耳其</a>：征服者訓練速度快20%。</li>
          </ul>
        </div>
         <h3>歷史</h3>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <p>在侵入新世界的歐洲冒險家隊伍中，那些具有超凡能力和決心的士兵成為了精英征服者。這些人是由於他們優越的武器和嚴峻的決心而克服困難並獲得勝利的人。</p>
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="img/ConquistadorIcon.jpg" width="45" alt="">
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="img/ConquistadorIcon.jpg" alt="">精銳征服者</td>
          </tr>
          <tr>
