  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p><strong>首領荷夫</strong>是《世紀帝國 II HD: 帝王世紀》中的一名步兵英雄，只可以在戰役編輯器中找到。首領荷夫現實中是諾曼底的第一個維京統治者羅洛公爵，有時他也被稱為Göngu-Hrólfr。首領荷夫有狂戰士的外貌但有更好的戰鬥力，不過移動速度比一般狂戰士慢，他會受步兵科技和其他加成的影響。由於他屬於英雄單位，因此不能被招降且會回血(在征服者資料片後)
              。</p>
            <p></p>
          </div>
        </div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><a href="">首領荷夫</a>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/VBRSK.jpg" width="80" alt="">
                </div>
              </td>
            </tr>
            <tr>
