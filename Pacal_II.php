  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>巴加爾二世是個弓兵英雄，只在"世界地國II:非洲王朝"資料片中的地圖編輯器出現，巴加爾二世的名字是以K'inich Janaab'Pakal所命名，他在位期間瑪雅帝國擴積極張實力，並監督執行在首都的大型建築計畫，後來留下的建築成為了中美洲的藝術典範。</p>
            <p>在遊戲中巴加爾二世的外型是羽毛箭射手，他會受到所有弓兵科技加成的影響。他不能被招降而且會自行回血。</p>
          </div>
          <div></div>
          <div></div>
        </div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><a href="">巴加爾二世</a>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/PlumedArcherIcon.jpg" width="80" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">8(遠程)</td>
            </tr>
            <tr>
              <td class="unit3">攻擊加成</td>
              <td class="unit4">對步兵+2
                <br>對長槍兵+2</td>
            </tr>
            <tr>
