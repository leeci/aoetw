  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p><a href="Onager.php">中型投石車</a>是一個遠程攻城單位 ，玩家必須先升級到<a href="Castle_Age.php">帝王時代</a>，研發科技後才可以在攻城器製造所進行訓練。
              它主要用來對付大群敵人。 它特別的<a href="Area_of_Effect.php">濺射傷害</a>使它成為一個強大的單位，特別是對弓箭手和緩慢移動的單位。
              <a
              href="Onager.php">中型投石車</a>還 可以攻擊地面並砍除樹木，在黑森林或樹木過多的封閉地形，它的價值顯得額外重要，除了<a href="Huns.php">匈奴人</a>和
                <a
                href="Turks.php">土耳其人</a>之外，其它文明都可以透過<a href="Siege_Workshop">攻城器製造所</a>將<a href="Mangonel.php">輕型投石車</a>升級成
                  <a
                  href="Onager.php">中型投石車</a>。</p>
            <p>中型投石車與輕型投石車最大的不同除了攻擊血量提高外，最具威脅性的是其射程+1，來到了8，讓帝王時代的遠程兵種(通常射程是8)，無法用拉打的方式打爆投石車，並可以藉著射程與強大的攻擊，一擊必殺
              <a
              href="Elite_Skirmisher.php">戰矛兵</a>與<a href="Arbalest.php">強弩兵</a>等單位。</p>
          </div>
          <h3>戰術</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <p>如果是樹林過多的擁擠地形，可以突顯<a href="Onager.php">中型投石車</a>的重要性，因為它可以有效的將樹林拆除，方便友軍在最短時間內殺入敵軍基地，同時
              <a
              href="Onager.php">中型投石車</a>也是廉價兵種(<a href=" HalberdierIcon.php">戟兵</a>、<a href=" Elite_Skirmisher.php">戰矛兵</a>)的殺手。</p>
            <p>喜好<a href="Onager.php">中型投石車</a>的玩家，應該會很喜歡使用<a href="Koreans.php">韓國</a>文明，因為特殊科技
              <a
              href="Shinkichon.php">神機箭</a>可以使投石車射程+1，亦或者與<a href="Koreans.php">韓國</a>文明結為同盟，可以降低已方的投石車最短射程限制。</p>
            <p>雖然<a href="Onager.php">中型投石車</a>是個傷害很高的單位，但砲彈是不長眼的，若操作不當，其擴散傷害的特性，也許會將敵方與已方的軍隊一同化為塵土，玉石俱焚。</p>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Armor_class_building.php">建築物</a>、<a href="Villager.php">村民</a>、<a href="Archer_Units.php">弓兵</a>。</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" src="img/Siegeengineers.jpg" alt=""><a href="Siege_Engineers.php">攻城工程師</a>:對建築物攻擊加成+20%。
                <br>
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" src="img/Siegeengineers.jpg" alt=""><a href="Siege_Engineers.php">攻城工程師</a>:對建築物攻擊加成+20%。
                <br>
                <img src="img/Unique-tech.jpg" class="gg" alt=""><a href="Shinkichon.php">神機箭</a>(+1，<a href="Koreans.php">韓國</a>限定)</td>
            </tr>
            <tr>
          ...
          <h3>剋中型投石車的單位與建築</h3>
          <div class="hrn1"></div>
          <div class="n1">以下單位擁有對中型投石車的額外傷害，按造傷殺力排列。
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-6">
          ...
          <div class="n1">
            <ul>
              <li><a href="Aztecs.php">阿茲特克</a>：中型投石車生產速度快15%。</li>
              <li><a href="Celts.php">賽爾特</a>：中型投石車攻擊速度快25%(科技樹寫20%是錯的!)</li>
              <li><a href="Chinese.php">中國</a>：科技在帝王時代便宜20%。</li>
              <li><a href="Spanish.php">葡萄牙</a>：中型投石車黃金成本減少15%。</li>
              <li><a href="Slavs.php">斯拉夫</a>：中型投石車訓練成本減少15%。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><a href="Celts.php">賽爾特</a>：中型投石車訓練和升級速度快20%。</li>
              ...
              <li><a href="Teutons.php">條頓</a>：中型投石車對僧侶的招降有較好的抗性。</li>
            </ul>
            <h3>更新日誌</h3>
            <div class="hrn1"></div>
            <div class="n1">
              ...
              <ul>
                <li>移動速度為0.5。</li>
                <li>在失落的帝國之前，中型投石車研發化學會變弱，投擲速度從3.5降低到2.9。</li>
              </ul>
              ...
              <ul>
                ...
                <li><a href="Koreans.php">韓國</a>:<a href="Shinkichon.php">神機箭</a>：給予中型投石車+2的射程，到了1.0c版效果減少為1。</li>
                <li><a href="Koreans.php">韓國</a>的團隊加分讓中型投石車有+1射程。</li>
              </ul>
              <h3><em><a href="aof.php">失落的帝國</a></em></h3>
              <ul>
                <li>中型投石車現在可以砸掉樹林。</li>
                <li>研發化學不再會影響投射物速度。</li>
                <li><a href="Celts.php">賽爾特</a>：<a href="Furor_Celtica.php">賽爾特狂暴</a>給予中型投石車+40%的HP。</li>
                <li><a href="Teutons.php">條頓</a>：<a href="Ironclad.php">鋼鐵甲</a>引入。</li>
                <li><a href="Koreans.php">韓國</a>的團隊加分改為最小範圍-2，而不是射程+1。</li>
              </ul>
            </div>
            <h3>趣事</h3>
            <div class="hrn1"></div>
            <div class="n1">
              <ul>
                <li>在失落的帝國之前，投石車研發化學會變弱，投擲速度從3.5降低到2.9。</li>
              </ul>
            </div>
            <h3>圖庫</h3>
            <div class="hrn1"></div>
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-4"> <a href="img/Onager.png"><img class="imgn" class="hg" src="img/Onager.png" alt=""></a> 
                  <p><em>中型投石車</em>
                  </p>
                </div>
                <div class="col-md-4"> <a href="img/Mangonelline.png"><img class="imgn" class="hg" src="img/Mangonelline.png" alt=""></a> 
                  <p><em>投石車系</em>
                  </p>
                </div>
              </div>
            ...
            <div class="hrn1"></div>
            <div class="n1">
              <p>投石機或稱拋石機、「 回回炮」,砲或炮，是遠古時代與中古時代出現的攻城武器，可把石彈、巨石或爆裂物投到敵方的城牆、城內或者兵陣內而造成破壞。</p>
              <p>漢語的「砲」便是古漢語動詞「拋」的名詞形式，這種通過聲調改變詞性的手段被稱為四聲別義。「砲」原指投石機與其彈，唐後也指由投石機發射的燃燒物，宋後也指由投石機發射的縱火物與爆裂物，明後也指大型管身火器。宋代之前「砲」與「炮」不同義，「炮」只有「燒烤」的意思，宋代之後「炮」逐漸有「砲」的意思。就連「火砲」一詞最初也是指發射燃燒物或爆裂物投石機與其砲彈，明後才也指大型管身火器。</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#3c763d;;">
                <div class="unititle2">中型投石車</div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/OnagerIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">除了<a href="Huns.php">匈奴人</a>和<a href="Turks.php">土耳其人</a>之外其它文明皆可研發</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="img/Siege-workshop-logo.jpg" width="30" alt=""><a href="Siege_Workshop.php">攻城器製造所</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <tr>
                ...
                <td class="unit4">
                  <img class="gg" src="img/MangonelIcon.jpg" alt=""><a href="Mangonel.php">輕型投石車</a>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="unit4">
                  <img class="gg" src="img/Siege-onager-research.jpg" alt="">1450食物1000黃金</td>
              </tr>
              <tr>
