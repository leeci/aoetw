  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>劍兵勇士又稱為冠軍劍士，可以在帝王時代<a href="Barracks.php">軍營</a>被訓練。這是民兵系的最高等。</p>
          </div>
           <h3>文明可訓練與否</h3> 
          <div class="hrn1"></div>
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-ok okc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">可訓練</span></strong></h4>  <a href="Aztecs.php">阿茲特克</a>、 <a href="Berbers.php">柏柏</a>、 <a href="Britons.php">不列顛</a>、
                <a
                href="Burmese.php">緬甸</a>、 <a href="Byzantines.php">拜占庭</a>、 <a href="Celts.php">賽爾特</a>、
                  <a
                  href="Chinese.php">中國</a>、 <a href="Franks.php">法蘭克</a>、 <a href="Goths.php">哥德</a>、 <a href="Incas.php">印加</a>、
                    <a
                    href="Indians.php">印度</a>、 <a href="Italians.php">義大利</a>、 <a href="Japanese.php">日本</a>、
                      ...
                      href="Koreans.php">韓國</a>、 <a href="Magyar.php">馬札爾</a>、 <a href="Malians.php">馬利</a>、 <a href="Mongols.php">蒙古</a>、
                        ...
                        href="Portuguese.php">葡萄牙</a>、 <a href="Saracens.php">薩拉森</a>、 <a href="Slavs.php">斯拉夫</a>、
                          <a
                          href="Spanish.php">西班牙</a>、 <a href="Teutons.php">條頓</a>、 <a href="Turks.php">土耳其</a>、 <a href="Vietnamese.php">越南</a>、
                            <a
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-remove noc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">不可訓練</span></strong></h4>  <a href="Ethiopians.php">衣索比亞</a>、 <a href="Huns.php">匈奴</a>、 <a href="Khmer.php">高棉</a>、
                <a
                href="Malay.php">馬來</a>、 <a href="Mayans.php">馬雅</a>、 <a href="Persians.php">波斯</a>。</div>
            </div>
          </div>
           <h3>戰術</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <p>劍兵勇士在兩個特定的情況下表現非常出色：第一是早期的帝王時代，由於缺乏強大的反制兵種，他將可於帝王初期大開殺戒。另一個則是帝王時代晚期，大缺金時，作為垃圾兵的反制殺手，劍兵勇士被冠上“垃圾終結者”實至名歸。</p>
            <p>對於一些文明來說，劍兵勇士是一個非常重要的選擇。這包括 <a href="Malians.php">馬利</a>的+3遠程護甲和 <a href="Aztecs.php">阿茲特克</a>、
              <a
              href="Burmese.php">緬甸</a>的額外+3攻擊。帝王時代面對劍兵勇士的衝擊，需要巨大的經濟能力來抵擋。</p>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <tr>
                ...
                <td class="tta4">
                  <img class="gg" src="img/Unique-tech.jpg" width="30" alt=""><a href="Forced_Levy.php">強制徵兵</a>:軍營步兵單位訓練不需花黃金(但馬來只有雙手劍兵)<a href="Malay.php">馬來</a>限定。</td>
              </tr>
          </table>
           <h3>剋劍兵勇士的單位與建築</h3>
          <div class="hrn1"></div>
          ...
          <div class="n1">
            <ul>
              <li><a href="Aztecs.php">阿茲特克</a>：劍兵勇士生產速度提高15％。</li>
              <li><a href="Burmese.php">緬甸</a>：劍兵勇士在帝王時代有+3攻擊。</li>
              <li><a href="Celts.php">賽爾特</a>：劍兵勇士移動加快15％。</li>
              <li><a href="Chinese.php">中國</a>：利於劍兵勇士的技術在帝王時代便宜20％。</li>
              <li><a href="Goths.php">哥德</a>：劍兵勇士便宜35％並對<a href="Armor_Class_Standard_Building.php">標準建築</a>攻擊+1。研發
                <a
                href="Perfusion.php">灌注士氣</a>後研發<a href="Tracking.php">追縱技術</a>、<a href="Squires.php">護衛</a>、
                  <a
                  href="Arson.php">縱火</a>和升級劍兵勇士的速度快100%。</li>
              <li><a href="Japanese.php">日本</a>：劍兵勇士攻速快33％。</li>
              <li><a href="Magyars.php">馬札爾</a>：免費升級<a href="Forging.php">鍛造</a>、<a href="Iron_Casting.php">鑄造</a>和
                <a
                href="Blast_Furnace.php">鼓風爐</a>。</li>
              <li><a href="Malians.php">馬利</a>：劍兵勇士在帝王時代有 +3 遠程護甲。</li>
              <li><a href="Portuguese.php">葡萄牙</a>：劍兵勇士黃金成本減少15％。</li>
              ...
              <li><a href="Vikings.php">維京</a>：劍兵勇士在城堡/帝王時代加15％/20％的生命值。</li>
            </ul>
          </div>
           <h3>團隊加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li><a href="Goths.php">哥德</a>：劍兵勇士訓練和升級快20%。研發<a href="Tracking.php">追縱技術</a>、
                <a
                href="Squires.php">護衛</a>、<a href="Arson.php">縱火</a>科技的時間快20%。</li>
              <li><a href="Teutons.php">條頓</a>：劍兵勇士更不容易被招降。</li>
            </ul>
          </div>
           <h3>更新日誌</h3>
          <div class="hrn1"></div>
          ...
          <div class="n1">
            <div class="col-md-12">
              ...
              <div class="col-md-4"> <a href="img/Champion.png"><img  class="imgn" class="hg" width="250" src="img/Champion.png" alt=""></a> 
                <p><em>一群劍兵勇士</em>
                </p>
              </div>
            </div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/ChampionIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4"><a href="Armor_Class_Infantry.php"></a>步兵</td>
            </tr>
            <tr>
