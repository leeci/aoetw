  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <P>柏柏其實並非單一民族是多個民族的統稱，另外柏柏人這個稱呼本來不是柏柏人自稱的稱呼，而是來自拉丁語中的barbari(野蠻人)。現在柏柏人主要是集中在摩洛哥和阿爾及利亞，歷史上最早紀錄於古埃及前王朝時期，之後斷斷續續有不同國家、文明歷史紀錄有提到跟他們的紛爭和爭戰，比較多柏柏有名的人大多都在安達魯斯是指阿拉伯和北非穆斯林統治下的伊比利亞半島和塞蒂馬尼亞，也指半島被統治的711年－1492年這段時期。這片區域後在收復失地運動中被半島上的基督徒所占領，今天西班牙南部的安達魯西亞因此得名。</p>
            <p>柏柏是非洲的騎兵和<a href="Naval_Vessels.php">海軍</a>文明，世紀帝國II資料片非洲王國的所新增的文明。柏柏的特殊單位是
              <a
              href="Camel_Archer.php">駱駝弓騎兵</a>這是歷史上真實的兵種曾經多次造成歐洲軍隊的麻煩，另外<a href="Team_Bonus.php">團隊加分</a>的
                <a
                href="Genitour.php">標槍騎兵</a>也是歷史上出現過的真實兵種，北非部落多次度過地中海入侵歐洲還占領了伊比利亞半島因此給逾橫越地中海的柏柏人船隻移動速度上升(古時候渡海都是很危險的)，另外作為遊牧民族時常需要建立基地是一個必備的技能因此村民移動速度上升且研發城堡時代特殊科技
                  <a
                  href="Kasbah.php">聚居堡壘</a>可加快城堡工作效率。由於長期得要在沙漠戰鬥<a href="Camel.php">駱駝</a>幾乎沙漠必備騎乘單位原因是駱駝本身比較不需要水源因此帝王時代特殊科技
                    <a
          ...
          <div class="n1">
            <ul>
              ...
              <li>柏柏雖然在馬廄單位訓練成本城堡時代便宜15%、帝王時代便宜20%(馬扎爾在哭)，但是沒有<a href="Paladin.php">遊俠</a>(聖騎士)、東南亞獨有
                <a
                href="Battle_Elephant.php">矛象伕</a>，也算是近乎綁定駱駝且因為帝王時代特殊科技馬格拉比駱駝(駱駝單位會自動回血)，因此使用駱駝會比較好。</li>
              <li>雖然貴為海軍文明但是卻欠缺了核心科技<a href="Shipwright.php">造船匠</a>，使得海軍建立上要花更多資源和時間。</li>
              <li>柏柏攻城器上欠缺<a href="Siege_Onager.php">重型投石車</a>/<a href="Siege_Ram.php">重型衝撞車</a>，但擁有
                <a
                href="Bombard_Cannon.php">火砲</a>。另外沒有<a href="Bombard_Tower.php">火砲塔</a>跟<a href="Keep.php">大型箭塔</a>還有建築學因此在防禦上比較依賴兵力。</li>
              <li>柏柏僧侶系統欠缺<a href="Block_Printing.php">雕版印刷術</a>/<a href="Sanctity.php">聖潔虔誠</a>，因此在
                <a
                href="Conversion.php">招降</a>時危險度上升。</li>
        ...
        <h3>科技樹</h3>
          ...
          <div class="n1">
            <ul>
              <li>柏柏在以前版本的戰役裡有出現過但大多都是用土耳其、薩拉森文明作取代。</li>
              <li>柏柏的船隻移動速度+10%並不會提高貿易商旅得收益，但為了平衡每次收益會減少，但總體收益並不會改變。</li>
              <li>柏柏的馬廄單位訓練成本便宜15%、20%，馬扎爾也有相關加成但只差在封建上到了帝王馬扎爾的加成就顯得很沒意義</li>
              <li>柏柏的科技樹也是名列前茅，可能是因為柏柏也是多個民族、文化的統稱吧。</li>
            </ul>
          </div>
           <h3>圖庫</h3>
          <div class="hrn1"></div>
