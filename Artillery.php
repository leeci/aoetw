  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>砲兵是<a href="Turks.php">土耳其</a>的特殊科技，可於<a href="Imperial_Age.php">帝王時代</a>在
              <a
              href="Castle.php">城堡</a>研發。研發後<a href="Bombard_Tower.php">火炮塔</a>、<a href="Bombard_Cannon.php">火炮</a>；
                <a
          ...
          <div class="n1">
            <ul>
              <li>砲兵讓土耳其火炮塔的攻擊距離可打到敵隊火炮。土耳其的<a href="Elite_Cannon_Galleon.php">精銳火炮戰船</a>有遊戲中最遠的射程(與有
                <a
                href="Siege_Engineers.php">攻城工程師</a>的巨型投機並列)土耳其的火炮在攻城上有更遠的攻擊距離。</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
