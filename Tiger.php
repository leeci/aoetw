  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="n1"></div>
        <div class="col-md-8">
          <p>老虎在《世紀帝國 II HD: 拉惹的崛起》出現，是玩家可能在未探索區域會遇到的可怕掠食者之一。牠不提供食物但會出現在地圖的一些區域並且會攻擊視野中的村民或軍事單位。如果村民沒有織布技術而且被老虎先手的的話很容易會成為虎口下的犧牲品(除了馬札爾村民外)。老虎主要出現在東南亞地圖上。</p>
          <h3>圖庫</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <div class="col-md-12">
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#b086b5;">
                <div class="unititle"><a href="">老虎</a>
                </div>
              </td>
            </tr>
            <tr>
