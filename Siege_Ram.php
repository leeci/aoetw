  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>重型衝撞車，俗稱大衝車。要等到帝王時期花費1000的食物才能研發，在許多高手心目中，有沒有重型衝撞車為判定一個文明，後帝王強不強的關鍵原因之一。除了對於建築物強大的破壞力，給對手的視覺震撼力也是相當可怕。</p>
            <p>重型衝撞車移動速度與駐紮數量前後比較</p>
            <ul>
              <li>駐紮步兵數量0→移動速度0.6 (<a href="War_Elephant.php">戰象</a>移動速度0.6)</li>
              <li>駐紮步兵數量1→移動速度0.65 (<a href="Scorpion.php">弩砲</a>、 <a href="Teutonic_Knight.php">條頓武士</a>移動速度0.65)</li>
              <li>駐紮步兵數量2→移動速度0.7(<a href="Monk.php">僧侶</a>0.7)</li>
              <li>駐紮步兵數量3→移動速度0.75</li>
              <li>駐紮步兵數量4→移動速度0.8(<a href="Villager.php">村民</a>、<a href="Trebuchet.php">巨型投石機0.8</a>)</li>
              <li>駐紮步兵數量5→移動速度0.85</li>
              <li>駐紮步兵數量6→移動速度0.9(<a href="Champion.php">劍兵勇士</a>0.9)</li>
            </ul>
          </div>
           <h3>文明可訓練與否</h3> 
          <div class="hrn1"></div>
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-ok okc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">可訓練</span></strong></h4>  <a href="Aztecs.php">阿茲特克</a>、 <a href="Byzantines.php">拜占庭</a>、 <a href="Celts.php">賽爾特</a>、
                <a
                href="Chinese.php">中國</a>、 <a href="Ethiopians.php">衣索比亞</a>、 <a href="Huns.php">匈奴</a>、
                  <a
                  href="Incas.php">印加</a>、 <a href="Khmer.php">高棉</a>、 <a href="Mayans.php">馬雅</a>、 <a href="Mongols.php">蒙古</a>、
                    <a
                    href="Persians.php">波斯</a>、 <a href="Saracens.php">薩拉森</a>、 <a href="Slavs.php">斯拉夫</a>、 <a href="Spanish.php">西班牙</a>、
                      <a
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-remove noc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">不可訓練</span></strong></h4>  <a href="Berbers.php">柏柏</a>、 <a href="Britons.php">不列顛</a>、 <a href="Burmese.php">緬甸</a>、
                <a
                href="Franks.php">法蘭克</a>、 <a href="Goths.php">哥德</a>、 <a href="Indians.php">印度</a>、 <a href="Italians.php">義大利</a>、
                  <a
                  href="Japanese.php">日本</a>、 <a href="Koreans.php">韓國</a>、 <a href="Magyar.php">馬札爾</a>、 <a href="Malay.php">馬來</a>、
                    <a
                    href="Malians.php">馬利</a>、 <a href="Portuguese.php">葡萄牙</a>、 <a href="Turks.php">土耳其</a>、
                      <a
          ...
          <div class="hrn1"></div>
          <div class="n1">
            <p>重型衝撞車是帝王中期強大的攻城武器，與<a href="Capped_Ram.php">裝甲衝撞車</a>相比，其傷害半徑從1.5提高至2，駐軍數量也從5增加至6。其讓對方產生的心理壓力更是可怕。更重要的是，起始移動速度從0.5提升至0.6，當駐紮數量到達當6人時(全部都放步兵)，移動速度會增加至0.9，這樣的速度可以媲美
              <a
              href="Champion.php">劍兵勇士</a>，你不用再為了移動速度問題，困擾是否要將步兵駐紮在衝撞車內，且生命值變成270，耐打程度有顯助的提升。</p>
            <p>蒙古文明若有發展特殊科技<a href="Drill.php">演習</a>，會強烈建議你將步兵放置在重型衝撞車，因為原始的重型衝撞車移動速度為0.6~0.9，當發展特殊科技「
              <a
              href="Drill.php">演習</a>」之後，重型衝撞車移動速度為0.9~1.2，故駐軍後的蒙古重型衝撞車，移動速度會比研發護衛技術的劍兵勇士還來的快。</p>
            <p>賽爾特文明也非常適合研發重型衝撞車，賽爾特不只有生產快速的優勢，更有特殊科技 <a href="Furor_Celtica.php">「賽爾特狂暴」</a>，讓賽爾特重型衝撞車的生命值從原本的270強化到405，耐打程度絕對超乎你的想像。</p>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Mangudai.php">蒙古突騎</a>、<a href="Mangonel.php">投石車</a>、近戰單位特別是
                <a
                href="Magyar_Huszar.php">馬札爾驃騎兵</a>。</td>
            </tr>
            <tr class="tta">
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" src="img/Unique-tech.jpg" width="30" alt=""><a href="Furor_Celtica.php">賽爾特狂暴</a>:攻城器製造所的單位+40% HP。<a href="Celts.php">賽爾特</a>限定</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" src="img/CastleAgeUnique.png" width="30" alt=""><a href="Ironclad.php">鋼鐵甲</a>:攻城武器近戰護甲+4，<a href="Teutons.php">條頓</a>限定</td>
            </tr>
            <tr>
              <td class="tta1" style="width:10%">速度</td>
              <td class="tta4">
                <img class="gg" src="img/Unique-tech.jpg" width="30" alt=""><a href="Drill.php">演習</a>:攻城器製造所的單位移動速度+50%，<a href="Mongols.php">蒙古</a>限定</td>
              <tr>
          ...
          <div class="n1">
            <ul>
              <li><a href="Aztecs.php">阿茲特克</a>：重型衝撞車訓練速度快15%。</li>
              <li><a href="Celts.php">賽爾特</a>：重型衝撞車攻擊速度快20%</li>
              <li><a href="Chinese.php">中國</a>：ˇ對重型衝撞車有利的科技在帝王時代便宜20%。</li>
              <li><a href="Slavs.php">斯拉夫</a>：重型衝撞車成本減少15%。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><a href="Celts.php">賽爾特</a>：攻城器製造所單位生產速度快20%。</li>
              <li><a href="Malians.php">馬利</a>：研發<a href="Siege_Engineers.php">攻城工程師</a>的速度快80%。</li>
            ...
            <div class="n1">
              ...
              <ul>
                <li>1.0c版後火砲塔算遠攻，對衝撞車傷害大幅降低。</li>
                <li>1.0c版後研發重型衝撞車需要1000肉，不需要黃金。</li>
                <li>步兵、弓兵可以駐紮在衝撞車裡面。</li>
                <li>引入<a href="Heresy.php">異端邪說</a>
                </li>
                <li><a href="Celts.php">賽爾特</a>:<a href="Furor_Celtica.php">賽爾特狂暴</a>給予重型衝撞車多50%的HP。</li>
                <li>蒙古：<a href="Drill.php">演習</a>引進。</li>
              </ul>
              <h3><em><a href="aof.php">失落的帝國</a></em></h3>
              <ul>
                <li>現在村民可以駐紮在衝撞車裡面。</li>
                <li><a href="Celts.php">賽爾特</a>:<a href="Furor_Celtica.php">賽爾特狂暴</a>:給予重型衝撞車多40%的HP。</li>
            ...
            <div class="n1">
              <ul>
                <li>駐紮單位：世紀帝國二初期，衝撞車是沒辦法被駐紮的，到了征服者入侵位資料片之後，衝撞車才可以駐軍(步兵、徒步弓兵，不包含村民，僧侶、國王、炸藥桶)，而到了失落的帝國才能讓村民駐軍衝撞車。另外有國外的網友在實驗衝撞車單位時，發現了一有趣的現象，長弓兵駐軍的衝撞車會跟馬路三寶或酒罪人士一樣，不斷的失控去卡別台衝撞車。(
                  <a
                  href="https://www.youtube.com/watch?v=aPK2RnpEgPA">見實驗影片</a>)。</li>
                <li><a href="">移動速度</a>：步兵駐軍後的衝撞車移動速度比弓兵駐軍的衝撞車快，簡單來說，只有步兵駐軍才能堤升衝撞車的移動速度，且任何種類的步兵駐紮衝撞車後的速度都是一樣的。</li>
                <li>攻擊2，是陸上最弱的攻擊。</li>
            ...
            <div class="n1">
              <div class="col-md-12">
                ...
                <div class="col-md-4"> <a href="img/Siegeram.png"><img class="imgn" class="hg" src="img/Siegeram.png" alt=""></a> 
                  <p><em>一群重型衝撞車。</em>
                  </p>
                </div>
            ...
            <div class="n1">
              ...
              <p>《三國演義》第九十七回敘述：孔明大怒曰：「汝燒吾雲梯，吾卻用『衝車』之法！」</p>
              <p>諸葛亮攻擊陳倉的武器，也是歷代進行攻城的時候使用的重要戰車，在陳倉，被郝昭用鏈球式磨盤所破。今天的通用輪式裝甲車略有其風，只是沒有它這樣巨大。</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#3c763d;;">
                <div class="unititle2">重型衝撞車</div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/SiegeRamIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="img/CappedRamIcon.jpg" alt=""><a href="Capped_Ram.php">裝甲衝撞車</a>
              </td>
            </tr>
          </table>
