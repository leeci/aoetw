      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            ...
            <p>城門除了哥德之外的所有文明都可以使用，垛牆和升級過的城門除了哥德、匈奴、馬札爾、馬來和波斯以外的文明都可以使用。</p>
          ...
          <div class="n1">
            <ul>
              <li><a href="Byzantines.php">拜占庭</a>：城門封建/城堡/帝王時代多20%/30%/40%的血量。</li>
              <li><a href="Chinese.php">中國</a>：在城堡/帝王時代，城門的技術價格便宜15％/20％。</li>
          ...
          <div class="n1">
            <ul>
              <li><a href="Malians.php">馬利</a>：研究踏輪起重機團隊速度提高80%。</li>
