  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p><strong>阿朗松公爵</strong>是《世紀帝國 II HD: 帝王世紀》中的一名騎兵英雄，可以在戰役"奧爾良的少女"和戰役編輯器中找到。現實中他是阿朗鬆的約翰二世:在百年戰爭後期的一位法國公爵和將軍。他是聖女貞德的親密朋友和支持者。阿朗松公爵有騎士的外貌但有更好的戰鬥力，他會受騎兵科技和其他加成的影響。由於他屬於英雄單位，因此不能被招降且會回血
              。</p>
            <p></p>
          </div>
          <div></div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/Dukedalencon.png" width="80" alt="">
                </div>
              </td>
            </tr>
            <tr>
