  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="n1"></div>
        <div class="col-md-8">
          <p>羊駝在《世紀帝國 II HD: 失落的帝國》中是可馴化的動物，一隻有100的肉。羊駝會出現在包括雅典衛城，岩坑池，猶加敦等在內的地圖上。</p>
          <p>印加一開始因為文明加成會有一隻羊駝。</p>
          <h3>文明優勢</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
          ...
          <div class="n1">
            <div class="col-md-12">
              <div class="col-md-4">
                <img class="hg" width="200" src="img/LlamaII.png" alt="">
                <p><em>世紀帝國 II的羊駝。</em>
                </p>
              </div>
            </div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#b086b5;">
                <div class="unititle"><a href="">羊駝</a>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/LlamaII_icon.png" width="80" alt="">
                </div>
              </td>
            </tr>
            <tr>
