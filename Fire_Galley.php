  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>火蒙衝在封建時代時可以在碼頭中被訓練，當把<a href="Galley.php">戰船</a>升級成<a href="War_Galley.php">弩砲戰船</a>的時候，火蒙衝也會自動升級成
              <a
              href="Fire_Ship.php">火戰船</a>。</p>
            <p>火蒙衝、<a href="Demolition_Raft.php">自爆筏</a>都是在<a href="ak.php">非洲王國</a>資料片的時候一起推出的，使封建時代海戰才有更多的可看性，而不是只能看到一堆戰船的海戰。</p>
            <p>而<a href="Vikings.php">維京</a>成了全文明中唯一不能出火蒙衝的國家，這也使得在<a href="aoc.php">征服者入侵</a>時代的海戰強國，搖身一變成海戰初期弱勢文明，在
              <a
              href="Feudal_Age.php">封建時代</a>遇到敵方的火蒙衝時，將顯得相當無助。</p>
            <p><strong>不可生產文明：</strong>維京</p>
          </div>
           <h3>戰術</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <p>因為火蒙衝有著很高的攻速，所以在前期能夠對<a href="Fishing_Ship.php">漁船</a>、碼頭造成嚴重的威脅，所以在早期的比賽中使用火蒙衝能夠很有效騷擾對方的海上單位。</p>
            <p>當火蒙衝與戰船一對一的時候，火蒙衝能夠輕鬆地打贏<a href="Galley.php">戰船</a>。但是，如果是在大規模的交戰中，由於因為戰船的高射程，反而是戰船有著較大的優勢。</p>
            <p>火蒙衝也很容易受到<a href="Demolition_Raft.php">自爆筏</a>的威脅，因為火蒙衝的攻擊距離很近，所以無法在爆炸前打沉
              <a
              href="Demolition_Raft.php">自爆筏</a>。如果一艘<a href="Demolition_Raft.php">自爆筏</a>能夠打沉兩艘以上的火蒙衝就是非常划算了！</p>
            <p>值得一提的是，<a href="Demolition_Raft.php">自爆筏</a>沒辦法一擊必殺火蒙衝，需要搭配其他船隻來解決殘血的火蒙衝。</p>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Transport_Ship.php">運輸船</a>、<a href="Fishing_Ship.php">漁船</a>、在岸邊的建築物和近戰單位、
                <a
                href="Galley.php">戰船</a>。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><a href="Demolition_Raft.php">自爆筏</a>、箭塔、在岸邊的範圍單位。</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
          ...
          <h3>剋火蒙衝的單位與建築</h3>
          <div class="hrn1"></div>
          <div class="n1">以下單位擁有對火蒙衝的額外傷害，按照傷殺力排列。
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-6">
          ...
          <div class="n1">
            <ul>
              <li><a href="Berbers.php">阿茲特克</a>：火蒙衝訓練速度提高15%。</li>
              <li><a href="Berbers.php">柏柏</a>：火蒙衝移動速度提高10％。</li>
              <li><a href="Burmese.php">緬甸</a>：研究<a href="Faith.php">忠誠信仰</a>便宜50％。</li>
              <li><a href="Byzantines.php">拜占庭</a>：火蒙衝開火速率快25%。</li>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/FireGalleyIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="img/War-galley-research.jpg" alt="">230食物 100黃金</td>
            </tr>
            <tr>
        ...
        <div class="col-md-12">
          ...
          <div class="n1">
            <div class="col-md-12">
              ...
              <div class="col-md-4"> <a href="img/Firegalley (1).png"><img class="imgn" class="hg" src="img/Firegalley (1).png" alt=""></a> 
                <p><em>一群火蒙衝。</em>
                </p>
              </div>
              <div class="col-md-4"> <a href="img/Firegalley.png"><img class="imgn" class="hg" src="img/Firegalley.png" alt=""></a> 
