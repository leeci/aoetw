  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>巨港是"世界地國II:非洲王朝"資料片中馬來人進入城堡時代研發完科技"海上霸主"可以建造的特殊軍事經濟復合式建築物。巨港比碼頭有更多的生命值和視野，而且能以箭矢攻擊來犯的敵方單位。</p>
          </div>
          <h3>戰術</h3>
          <div class="hrn1"></div>
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                <li>巨港像碼頭一樣可以做資源收集站也可以是軍事建築物。不過巨港比起碼頭有更多生命值還能向攻擊敵方單位，所以它可以當作防禦工事的一部分，根據不同的遊戲地圖使用它們，而且巨港只花費木材！</li>
                <li>在像海島這樣的地圖上玩的時候，巨港對馬來人來說是非常有利的，因為他們幫助確保海岸線安全，同時在一定程度上保護了馬來漁船和貿易商旅。這對馬來人來說特別重要，因為漁船和貿易商旅在這些地圖上是經濟的重要組成部分。利用巨港可以阻止敵方運輸船難靠近而且也不需要巡邏海岸線。</li>
                <li>在像沿海，波羅的海和大陸那樣定居點沒有被水隔開的地圖上，使用巨港可以產生巨大的影響，因為它們可以跟城堡和箭塔一起保護海岸。他們也在很多情況下幫助海軍並保護海上經濟。</li>
                <li>在河流，高地或其他具有河流和/或湖泊的地圖上，巨港可以成為防禦性結構的一部分，因為河流和湖泊是地面部隊的屏障，在這種情況下，使巨港和海軍部隊可以有效地幫助靠近海岸線的防禦工事。也能有效防衛淺灘因為這是地面部隊渡過河流的唯一路徑。</li>
                <li>即使巨港得到攻擊力和生命值提高，但還是能被許多船艦遠距離摧毀。建議在海岸周邊部屬攻城武器或以其他防禦建築物（如箭塔或城堡）支援他們。另外，海軍也能捍衛巨港保衛海岸。</li>
                <li>在玩團隊遊戲時，巨港是非常有價值的，因為海軍貿易路線可以更容易地得到保護，它們提供了貿易商旅掩護。所以在進行水上貿易時，如果有馬來人作為同盟的話通常會更安全。</li>
                <li>巨港只能建在淺水區或靠近海岸的淺灘上。在兩棲地圖中，通過將巨港放置在海軍和陸地部隊相交的戰略位置，最好是毗鄰森林，使得更少的單位有機會對其造成傷害，同時還能以神風船炸飛敵方單位。即使在水位低於平均水平的地圖上，也可以利用港口的權力來威懾附近的敵方村民。</li>
              </div>
            </div>
          </div>
           <h3>可訓練的單位與技術</h3>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Naval_Vessels.php">船艦</a>。</td>
            </tr>
            <tr>
              <td class="tta1">劣勢(不易對抗)</td>
              <td class="tta4"><a href="Siege_Weapon_Unit.php">攻城單位</a>、<a href="Tarkan.php">韃靼騎兵</a>、
                <a
          ...
          <div class="n1">
            <ul>
              <li><a href="Malay.php">馬來</a>：巨港視野+100%。。</li>
              <li><a href="Malians.php">馬利</a>：研究<a href="Masonry.php">磚瓦技術</a>、<a href="Architecture.php">建築學</a>和
                <a
                href="Treadmill_Crane.php">踏輪起重機</a>團隊速度提高80%。</li>
              <li><a href="Vikings.php">維京</a>：巨港建造花費便宜15%。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li>一開始巨港的HP是2200然後開火速率為2.5，在5.3改版後HP降到2000開火速率也降為3.05。</li>
            </ul>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#3c763d;;">
                <div class="unititle"><a href="">巨港</a>
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">對<a href="Armor_Class_Ship.php">船隻</a>攻擊+9</td>
            </tr>
            <tr>
          ...
          <div class="thanks">感謝！本頁面由賜齡協助完成。</div>
        </div>
      </div>
      <div class="col-md-12">
         <h3>圖庫</h3>
