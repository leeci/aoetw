  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-12">
          <div class="n1">
            <p>攻城武器能在城堡時代開始訓練。他們是強大的機器，擅長破壞敵方建築和對付大量敵方單位。攻城武器的單位升級以及遠程的攻城武器(火砲)只有在帝王時代才有。</p>
          ...
          <div class="n1">
            <ul>
              <li>像船一樣，攻城武器不能讓僧侶治療，而必須由村民修復。 修復攻城武器需要花費黃金。</li>
              <li>所有的攻城武器都需要花費木材和黃金，唯一例外的是爆炸桶，他們花費食物和黃金。一般來說，攻城單位是最昂貴且訓練時間最長的單位。</li>
              <li>要訓練火炮則必須先研發化學。</li>
              <li>攻城武器和僧侶一樣需要研發科技後才招降他們。要招降攻城武器，必須先研究信仰救贖。</li>
              <li>巨型投石機，中型投石車（從失落的帝國資料片開始）和重型投石車可以砸樹木開路，當然村民也可以。這相當具有戰略意義，特別是在森林茂密的地圖上例如:黑森林，可以繞後給對方來個措手不及。</li>
            </ul>
          </div>
          <h3>分類</h3>
          <div class="hrn1"></div>
          ...
          <div class="hrn1"></div>
          <div class="n1">
            <p><a href="Slavs.php">斯拉夫</a>、<a href="Celts.php">賽爾特</a>和<a href="Ethiopians.php">衣索比亞</a>因為他們的文明加成和
              <a
              href="Unique_Unit.php">獨特技術</a>擁有最好的攻城武器。衣索比亞是唯一能夠使用<a href="Siege_Workshop.php">攻城器製造</a>所所有單位的文明。</p>
          </div>
          <h3>文明加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
          ...
          <div class="n1">
            ...
            <ul>
              ...
              <li><a href="Khmer.php">高棉</a>：<a href="Scorpion.php">弩炮</a>射程+1。</li>
              <li><a href="Koreans.php">韓國</a>：投石車最小射程範圍從3改為1。</li>
            </ul>
          </div>
          <h3>攻城器單位</h3>
          <div class="hrn1"></div>
          ...
          <div class="n1">
            <table class="table-bordered" width="100%">
              ...
              <tr>
                ...
                <td class="tunitc6">攻城武器攻擊範圍+1(衝撞車除外)。對建築物攻擊加成+20%(炸藥桶+40%)。</td>
              </tr>
              <tr>
                <td class="tunitc6">
            ...
            <div class="n1">
              <table class="table-bordered" width="100%">
                <tr>
                  ...
                  <td class="tunitcc" style="width: 10%;">科技</td>
                  <td class="tunitcc" style="width: 15%;">成本</td>
                  <td class="tunitcc">影響</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="tunitc6">巨型投石機有範圍傷害，對靜止單位有100%命中率。</td>
                </tr>
                <tr>
                  <td class="tunitc6">
