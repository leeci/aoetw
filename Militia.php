  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>民兵是步兵單位，可以在<a href="Barracks.php">軍營</a>被訓練。</p>
          </div>
          <h3>戰術</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <p>民兵，在亞洲華人圈俗稱棒棒，是<a href="Dark_Age.php">黑暗時代</a>唯一能生產的軍事單位，早年大家覺得民兵沒什麼用處，但隨著時代的變遷，今天的民兵已經變成一種主流打法，控制得宜可以有效的騷擾對方經濟，取得非常大的優勢。以步兵為主的文明，如
              <a
              href="Celts.php">賽爾特</a>、 <a href="Goths.php">哥德</a>、 <a href="Japanese.php">日本</a>和 <a href="Aztecs.php">阿茲特克</a>都是非常凶殘的民兵快攻文明。</p>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Skirmisher.php">矛兵</a>、<a href="Scout_Cavalry.php">斥侯</a>、
                <a
                href="Spearman.php">槍兵</a>、<a href="Villager.php">村民</a>。</td>
            </tr>
            <tr>
          ...
          <div class="n1">
            <ul>
              <li><a href="Aztecs.php">阿茲特克</a>：民兵生產速度提高15％。</li>
              <li><a href="Burmese.php">緬甸</a>：民兵在封建/城堡/帝王時代有 +1/+2/+3攻擊。</li>
              <li><a href="Celts.php">賽爾特</a>：民兵移動加快15％。</li>
              <li><a href="Chinese.php">中國</a>：利於民兵的技術在封建/城堡/帝王時代便宜10％/15％/20％。</li>
              <li><a href="Goths.php">哥德</a>：民兵從封建時代開始便宜35％並對<a href="building.php">建築物</a>攻擊+1。研發
                <a
                href="Perfusion.php">灌注士氣</a>後研發<a href="Tracking.php">追縱技術</a>、<a href="Squires.php">護衛</a>、
                  <a
                  href="Arson.php">縱火</a>和升級裝甲步兵的速度快100%。</li>
              <li><a href="Japanese.php">日本</a>：民兵攻速快33％(從封建時代開始)。</li>
              <li><a href="Magyars.php">馬札爾</a>：免費升級<a href="Forging.php">鍛造</a>、<a href="Iron_Casting.php">鑄造</a>和
                <a
                href="Blast_Furnace.php">鼓風爐</a>。</li>
              <li><a href="Malians.php">馬利</a>：民兵在封建/城堡/帝王時代有 +1/+2/+3 遠程護甲。</li>
              <li><a href="Portuguese.php">葡萄牙</a>：民兵黃金成本減少15％。</li>
              ...
              <li><a href="Vikings.php">維京</a>：民兵在封建/城堡/帝王時代加10％/15％/20％的生命值。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li><a href="Goths.php">哥德</a>：民兵訓練和升級快20%。研發<a href="Tracking.php">追縱技術</a>、
                <a
                href="Squires.php">護衛</a>、<a href="Arson.php">縱火</a>科技的時間快20%。</li>
              <li><a href="Teutons.php">條頓</a>：民兵更不容易被招降。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li>民兵遠防是0。</li>
              <li><a href="Goths.php">哥德</a>:在封建/城堡/帝王時代，民兵成本便宜10%/15%/25%。</li>
            </ul>
            <h3><em><a href="aoc.php">征服者入侵</a></em></h3>
            <ul>
              <li>民兵現在擁有1的遠防。</li>
              <li>引入<a href="Heresy.php">異端邪說</a>。</li>
              <li><a href="Goths.php">哥德</a>:1.0c後，哥德民兵從封建時代開始便宜35%。</li>
            </ul>
            <h3><em><a href="ak.php">非洲王國</a></em></h3>
            <ul>
              <li>新科技<a href="Arson.php">縱火</a>引進。</li>
              <li><a href="Vikings.php">維京</a>:4.8版本引進<a href="Chieftains.php">酋長</a>科技，民兵對
                <a
                href="Armor_Class_Cavalry.php">騎兵單位</a>有+5攻擊。</li>
              <li><a href="Vikings.php">維京</a>:在4.8b版本後，<a href="Chieftains.php">酋長</a>讓民兵對駱駝有額外+2攻擊。</li>
            </ul>
            <h3><em><a href="aor.php">王者崛起</a></em></h3>
            <ul>
              <li><a href="Vikings.php">維京</a>:5.7版本<a href="Chieftains.php">酋長</a>科技現在讓民兵對駱駝有額外+4攻擊。</li>
            </ul>
          </div>
          <h3>趣事</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li>馬來的民兵再研發<a href="Forced Levy.php">強制徵兵</a>後不用黃金。</li>
          ...
          <div class="n1">
            <div class="col-md-12">
              ...
              <div class="col-md-4"> <a href="img/Militia.png"><img  class="imgn" class="hg" width="250" src="img/Militia.png" alt=""></a> 
                <p><em>一群民兵</em>
                </p>
              </div>
            </div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#3c763d;;">
                <div class="unititle2">民兵</div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/MilitiaIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="img/Barracks-logo.jpg" alt=""><a href="Barracks-logo.php">軍營</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="img/Man-at-arms-research.jpg" alt="">100肉45金</td>
            </tr>
            <tr>
