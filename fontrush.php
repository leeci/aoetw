    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          ...
          <div class="hrn1"></div>
          <div class="n1">
            <p>前置槍矛為一種極具侵略的打法，流程為正常21～22p上封建，3～4村民前置軍營，上封建後補雙靶場出矛兵，配合槍兵進攻，村民可持續插塔壓迫，也可以稱作槍矛塔，還算能克制傳統的肉馬與小弓開局。</p><strong><span class="glyphicon glyphicon-plus" aria-hidden="true" style=" color: #3c763d; margin-right: 5px; "></span>什麼時候該打前置槍矛</strong>
            <p>你想打就打，但風險極高，報酬又沒裝甲塔大。</p>
          </div>
          <h3>反制</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <div class="row">
              <div class="col-md-12">
                <p>黑快民兵轉裝甲開局能有效防止敵人前置，現今黑快民兵開局的多，因此此打法並不多見。</p>
                <p>如我沒抓到對方前置村民，可屯一波肉馬+矛反打，而肉馬也可以直接抄對方家。</p>
              </div>
            </div>
          </div>
           <h3>流程</h3>
