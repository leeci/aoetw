  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>賽爾特狂暴是<a href="Celts.php">賽爾特</a>的特殊科技，可於<a href="Imperial_Age.php">帝王時代</a>在
              <a
              href="Castle.php">城堡</a>研發。研發後<a href="Siege_Workshop.php">攻城器製造所</a>的單位+40% HP。</p>
          </div>
          <h3>戰術要點</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li>賽爾特狂暴讓賽爾特人的<a href="Siege_Weapons.php">攻城武器</a>更難被摧毀。搭配他們的文明加成(攻城武器開火速度快20%)和團隊加成(攻城器製造所工作速率快15%)，讓賽爾特攻城武器是遊戲中最為人所懼怕的</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><a href="Berbers.php">柏柏</a>：<a href="Kasbah.php">聚居堡壘</a>能夠加速賽爾特狂暴的研究時間(快25%)。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          ...
          <div class="hrn1"></div>
          <div class="n1">
            <p>“凱爾特人的勇士有著非常情緒化的戰士的名聲，他們的士氣會大幅波動，賽爾特狂暴或者凱爾特怒火是一種高度激進的攻擊行為，會讓所有敵方軍隊看到後都試圖逃跑，如果憤怒被抑制住，它可能會突然消失並變成恐懼，如果凱爾特領導人能夠管理和指揮他們的士兵的怒氣，那麼這是一個令人望而生畏的力量倍增器。“</p>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#31b0d5;">
                <div class="unititle"><a href="">賽爾特狂暴</a>
                </div>
              </td>
            </tr>
            <tr>
