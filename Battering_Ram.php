  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>輕型衝撞車是世紀帝國遊戲中，沒有人駕駛卻可以講話的神奇軍事單位，它可以從攻城器製造所製造，對一般單位的攻擊力較低，對建築物、攻城器單位皆有額外的傷害加成，其遠程裝甲值極高，行進中幾乎不受弓箭手傷害影響，因此許多玩家會將步兵單位駐紮在衝撞車內做掩護殺入敵陣。</p>
            <p>每一台衝撞車最多可以駐紮四個步兵單位(步兵、徒步弓手、村民)，當步兵單位駐紮在衝撞車時，可以提升移動速度和對建築物的傷害，要特別留意的是，衝撞車在遊戲中移動速度排最後一名，建造費用很耗木材與黃金資源，且近身裝甲竟然只有(-3)，但在遊戲中顯示值為0，一般村民、村姑徒手亂打便可造成大量傷害，因此需要好好保護。</p>
            <p>輕型衝撞車移動速度與駐紮數量前後比較</p>
            <ul>
              <li>駐紮步兵數量0→移動速度0.5</li>
              <li>駐紮步兵數量1→移動速度0.55</li>
              <li>駐紮步兵數量2→移動速度0.6 (<a href="Siege_Ram.php">重型衝撞車</a>、<a href="War_Elephant.php">戰象</a>移動速度0.6)</li>
              <li>駐紮步兵數量3→移動速度0.65 (<a href="Scorpion.php">弩砲</a>移動速度0.65)</li>
              <li>駐紮步兵數量4→移動速度0.7 (<a href="Monk.php">僧侶</a>移動速度0.7)</li>
            </ul>
          </div>
           <h3>戰術</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <p>在城堡時期，輕型衝撞車是最強大的攻城武器之一，也是少數在城堡時期可以對城堡建築物造成威脅的單位，適合拿來拆除對手的建築物，其傷害對建築物皆有額外的加成效果，同時可以做為步兵單位推進的掩護物，不少玩家會運用他的超高遠程裝甲特性來吸收敵方弓箭手的火力
              。</p>
            <p>輕型衝撞車在遊戲中顯示的近身裝甲值為0，實際上的值設定為(-3)，雖然遠防裝甲很高，但對於近戰單位的抵抗力卻非常薄弱，因此輕型衝撞車可以承受大多數遠程攻擊單位的傷害(
              <a
              href="Mangonel.php">投石車</a>、<a href="Mangudai.php">蒙古突騎</a>除外)。</p>
            <p>關於衝撞車用途不單純是做為攻城武器，亦可做為步兵軍事單位的掩護物，另外對於其他攻城器製造所單位也有額外的傷害效果，故有時會拿來破敵方的衝撞車陣、弩砲陣、投石車陣也是蠻常見的，可是行走速度很慢是個致命缺點，而且非常吃重木材資源，所以一般來說數量不會一次生產太多，或者是生產後先藏放在城器製造所，等到一定的數量才會搭配其他軍事單位放手一搏殺出一條血路。</p>
            <p>如果對手出輕型衝撞車拆除你的建築物，在沒有其他任何的兵力支援下，村民上前拆除也許是個不錯的選擇，因為輕型衝撞車的近身裝甲值很低、行走的慢，所以它很怕近戰的傷害，反之，若你選擇輕型衝撞車當推進幫手，在混亂中一定要小心衝撞車的控制，只要稍不注意，很可能會被一群村民徒手拆除，當然，比較建議使用
              <a
          ...
          <div class="n1">
            <ul>
              <li><a href="Aztecs.php">阿茲特克</a>：輕型衝撞車訓練速度快15%。</li>
              <li><a href="Celts.php">賽爾特</a>：輕型衝撞車攻擊速度快20%</li>
              <li><a href="Chinese.php">中國</a>：對輕型衝撞車有利的科技在城堡/帝王時代各便宜15%/20%。</li>
              <li><a href="Portuguese.php">葡萄牙</a>：輕型衝撞車黃金花費減少15%。</li>
              <li><a href="Slavs.php">斯拉夫</a>：輕型衝撞車成本減少15%。</li>
            </ul>
          </div>
           <h3>團隊加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <div class="n1">
              ...
              <ul>
                ...
                <li><a href="Celts.php">賽爾特</a>:<a href="Furor_Celtica.php">賽爾特狂暴</a>給予衝撞車多50%的HP。</li>
            ...
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-4"> <a href="img/Bram1.jpg"><img class="imgn" class="hg" src="img/Bram1.jpg" alt=""></a> 
                  <p><em>衝撞車模型。</em>
                  </p>
                </div>
                <div class="col-md-4"> <a href="img/Batteringram.png"><img class="imgn" class="hg" src="img/Batteringram.png" alt=""></a> 
                  <p><em>一群輕型衝撞車。</em>
                  </p>
                </div>
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-4"> <a href="img/Batteringramgarrison.png"><img class="imgn" class="hg" src="img/Batteringramgarrison.png" alt=""></a> 
                  <p><em>有單位駐紮的衝撞車。</em>
                  </p>
                </div>
              </div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#3c763d;;">
                <div class="unititle2">輕型衝撞車</div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/BatteringRamIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="img/Capped-ram-research.jpg" alt="">300食物</td>
            </tr>
            <tr>
