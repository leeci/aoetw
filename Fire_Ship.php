    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          ...
          <div class="hrn1"></div>
          <div class="n1">
            <p>火戰船能夠壓制大部分的船，並且能夠造成巨大的傷害。火戰船也可以用來對付陸地單位，效果也是不錯。但是，因為火戰船需要很靠近敵人，所以<a href="Demolition_Raft.php">自爆筏</a>很大的克制噴火船。
              <a
              href="Koreans.php">韓國</a>的<a href="Turtle_Ship.php">龜甲船</a>也能夠威脅到火戰船。火戰船雖然有非常快的攻擊速度，但是每一個"火焰"的攻擊力很低。雖然攻擊力偏低，但是還是能對船造成不俗的傷害。</p>
            <p>儘管火戰船對船有傷害力也有著很高的防禦力，但是城堡時代的火戰船還是比<a href="War_Galley.php">弩炮戰船</a>的速度慢。所以需要適當的戰術，攻其不備。當火戰船升級成
              <a
              href="Fast_Fire_Ship.php">重型火戰船</a>後，倒是能夠輕易地追上<a href="Galleon.php">重型弩砲戰船</a>。</p>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Transport_Ship.php">運輸船</a>、<a href="Fishing_Ship.php">漁船</a>、在岸邊的建築物和近戰單位、
                <a
                href="War_Galley.php">弩炮戰船</a>、<a href="Cannon_Galleon.php">火炮戰船</a>。</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="tta4">
                <p>
                  ...
                  alt=""><a href="Greek_Fire.php">希臘之火</a>(+1，<a href="Byzantines.php">拜占庭</a>限定)</p>
              </td>
            </tr>
            <tr>
          ...
          <h3>剋火戰船的單位與建築</h3>
          <div class="hrn1"></div>
          <div class="n1">以下單位擁有對火戰船的額外傷害，按照傷殺力排列。
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-6">
          ...
          <div class="n1">
            <ul>
              <li><a href="Berbers.php">阿茲特克</a>：火戰船訓練速度提高15%。</li>
              <li><a href="Berbers.php">柏柏</a>：火戰船移動速度提高10％。</li>
              <li><a href="Burmese.php">緬甸</a>：研究<a href="Faith.php">忠誠信仰</a>便宜50％。</li>
              <li><a href="Byzantines.php">拜占庭</a>：火戰船開火速率快25%。</li>
              <li><a href="Celts.php">賽爾特</a>：在視野內的動物不會被轉化</li>
              <li><a href="Chinese.php">中國</a>：有利於火戰船科技在城堡/帝王便宜15%/20％</li>
              <li><a href="Italians.php">義大利</a>：研究<a href="Careening.php">傾側維修術</a>，
                <a
                href="Dry Dock.php">旱碼頭</a>和<a href="Shipwright.php">造船匠</a>便宜50％，升級到快速火戰船便宜50%。</li>
              <li><a href="Persians.php">波斯</a>：火戰船在城堡/帝王時代訓練的速度提高15/20% <a href="Careening.php">傾側維修術</a>和升級到
                <a
                href="Fast_Fire_Ship.php">快速火戰船</a>的研發速度在城堡/帝王時代提高15%/20％。研究<a href="Dry Dock.php">旱碼頭</a>的速度快20％。</li>
              <li><a href="Portuguese.php">葡萄牙</a>：火戰船訓練減少15%黃金成本，火戰船+10％HP。</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li><a href="Teutons.php">條頓</a>：火戰船對招降的抵抗力更強。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              ...
              <li>4.8版本後火戰船會受到<a href="Ballistic.php">彈道學</a>的影響。</li>
            </ul>
          ...
          <div class="hrn1"></div>
          <div class="n1">
            <p>西方僅拜占庭人把古代的造船傳統延續到中世紀。他們在三列槳座戰船上的改變催生了火戰船，這是一種由槳和延遲帆支撐的狹窄而快速的軍艦。這些戰艦的戰鬥力部分由士兵，弓箭手和彈射器提供，但拜占庭海軍的秘密武器是希臘之火。這種極易揮發的混合物從火戰船船頭的軟管噴出，並在與空氣接觸時引燃
              火是對付木船的毀滅性武器，拜占庭人的敵人無法忍受噴著希臘之火火戰船的猛烈攻勢。其他文明有時會獲得希臘之火的秘密，但它的使用需要非常謹慎且危險，因此在今天它已經失傳。</p>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#3c763d;;">
                <div class="unititle" style="color: #fff">火戰船</div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
            ...
            <tr>
              ...
              <td class="unit4">除了<a href="Vikings.php">維京</a>以外的所有文明</td>
              <tr>
              ...
              <tr>
                ...
                <td class="unit4"><a href="Armor_Class_Ship.php">船</a>(+6)</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="unit4">
                  <img class="gg" src="img/Fast-fire-ship-research.jpg" alt="">280食物 250黃金</td>
              </tr>
              <tr>
        ...
        <div class="col-md-12">
          ...
          <div class="n1">
            <div class="col-md-12">
              ...
              <div class="col-md-4"> <a href="img/Fireship.png"><img class="imgn" class="hg" src="img/Fireship.png" alt=""></a> 
                <p><em>一群火戰船。</em>
                </p>
              </div>
              <div class="col-md-4"> <a href="img/FireShipHD.png"><img class="imgn" class="hg" src="img/FireShipHD.png" alt=""></a> 
