  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p><strong>丁禮</strong>是《王者崛起》中的一名騎兵英雄。他只能在戰役編輯器中使用，並擁有<a href="Paladin.php">遊俠</a>的外觀。由於他屬於英雄單位，因此不能被招降且會回血
              。</p>
          </div>
           <h3>歷史</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <p>他的原型來自於越南歷史上的知名人物丁禮，他也是梨利的姪子。他既勇猛、狡詐又武功高強。他在年輕時曾擔任<a href="Le_Loi.php">黎利</a>的護衛。他和梨來在黎利發起藍山起義後不久就率先加入，他同時也是梨利最信賴的人之一。1427年，
              <a
              href="Wang_Tong.php">王通</a>出擊藍山軍的將領黎阮，丁禮率兵五百人前去救援。因兵少，在途中遭到王通夾擊，丁禮被俘，後被斬首。</div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/Dinhleicon.png" width="80" alt="">
                </div>
              </td>
            </tr>
            <tr>
