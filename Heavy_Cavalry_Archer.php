  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>重裝馬弓騎兵訓練於<a href="Imperial_Age.php">帝王時代</a>的<a href="Archery_Range">射箭場</a>，他有非常快的速度與遠程的攻擊，使他成為一名出色的騷擾者，是非常有效對付步兵單位的兵種。但因為他是騎馬的遠程單位，因此懼怕
              <a
              href="Skirmisher.php">戰矛兵</a>與<a href="Pikeman.php">槍兵</a>。</p>
          </div>
          <h3>文明可訓練與否</h3> 
          <div class="hrn1"></div>
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-ok okc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">可訓練</span></strong></h4>  <a href="Berbers.php">柏柏</a>、 <a href="Britons.php">不列顛</a>、 <a href="Burmese.php">緬甸</a>、
                <a
                href="Byzantines.php">拜占庭</a>、 <a href="Celts.php">賽爾特</a>、 <a href="Chinese.php">中國</a>、 <a href="Ethiopians.php">衣索比亞</a>、
                  <a
                  href="Franks.php">法蘭克</a>、 <a href="Goths.php">哥德</a>、 <a href="Huns.php">匈奴</a>、 <a href="Indians.php">印度</a>、
                    <a
                    href="Japanese.php">日本</a>、 <a href="Khmer.php">高棉</a>、 <a href="Koreans.php">韓國</a>、 <a href="Magyar.php">馬札爾</a>、
                      <a
                      href="Malians.php">馬利</a>、 <a href="Mongols.php">蒙古</a>、 <a href="Persians.php">波斯</a>、 <a href="Saracens.php">薩拉森</a>、
                        <a
                        href="Slavs.php">斯拉夫</a>、 <a href="Spanish.php">西班牙</a>、 <a href="Turks.php">土耳其</a>、 <a href="Vietnamese.php">越南</a>。</div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-remove noc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">不可訓練</span></strong></h4>  <a href="Aztecs.php">阿茲特克</a>、 <a href="Incas.php">印加</a>、 <a href="Italians.php">義大利</a>、
                <a
                href="Malay.php">馬來</a>、 <a href="Mayans.php">馬雅</a>、 <a href="Portuguese.php">葡萄牙</a>、
                  <a
                  href="Teutons.php">條頓</a>、 <a href="Vikings.php">維京</a>。</div>
            </div>
          </div>
          <h3>戰術</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <p>升級重裝馬弓騎兵非常昂貴，即使在城堡時代屯了大量的 <a href="Cavalry_Archer.php">馬弓騎兵</a>，也不會輕易的研發，一般來說上帝王後優先研發的科技為
              <a
              href="Bracer.php">謢腕技術</a>與 <a href="Chemistry.php">化學</a>，而不是研發重裝馬弓。 <a href="Skirmisher.php">矛兵</a>和
                <a
                href="Mangonel.php">投石車</a>對於馬弓騎兵是相當可怕的，另外 <a href="Camel.php">駱駝</a>與 <a href="Camel_Archer.php">駱駝射手</a>也可以輕易地解決馬弓騎兵。</p>
            <p>馬弓騎兵最強悍的文明絕對是<a href="Huns.php">匈奴人</a>、<a href="Mongols.php">蒙古人</a>、
              <a
              href="Saracens.php">薩拉森</a>與<a href="Magyars.php">馬札爾</a>。蒙古人擁有絕佳的射速。匈奴人則是有便宜的<a href="Cavalry_Archer.php">馬弓騎兵</a>，薩拉森人對建築有+4的攻擊，而馬札爾人在帝王時代透過
                <a
                href="Recurve Bow.php">反曲弓</a>科技，讓馬弓騎兵射程與攻擊額外+1。<a href="Turks.php">土耳其人</a>通過 <a href="Sipahi.php">采邑騎兵</a>血量+20。</p>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="Kamayuk.php">槍隊長</a>、<a href="Genoese_Crossbowman.php">熱那亞弩手</a>、
                ...
                href="Huskarl.php">哥德衛隊</a>、<a href="Mameluke.php">奴隸兵</a>、<a href="Camel.php">駱駝騎兵</a>、
                  <a
                  href="Skirmisher.php">矛兵</a>、<a href="Eagle_Warrior.php">鷹勇士</a>、<a href="Onager.php">中型投石車</a>、
                    <a
                    href="Scorpion.php">弩炮</a>、。</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br>
                <img class="gg" src="img/Parthian-Tactics.jpg" alt=""><a href="Parthian_Tactics.php">帕提亞戰術</a>:對<a href="Armor_Class_Spearman.php">長槍兵</a>攻擊+4
                <br>
                <img class="gg" src="img/Unique-tech.jpg" width="30" alt=""><a href="Recurve_Bow.php">反曲弓</a>(+1)， 5.5版後的<a href="Magyars.php">馬扎爾</a>限定</td>
            </tr>
            <tr>
              ...
              <td class="tta4">
                ...
                <img class="gg" src="img/Bracer.jpg" width="30" alt=""><a href="Bracer.php">護腕</a>(+1)
                <br>
                <img class="gg" src="img/Unique-tech.jpg" width="30" alt=""><a href="Recurve_Bow.php">反曲弓</a>(+1，<a href="Magyars.php">馬扎爾</a>限定)</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br>
                <img class="gg" src="img/Ringarcherarmor.jpg" width="30" alt=""><a href="Ring_Archer_Armor.php">弓兵環甲</a>(+1/+2)
                <br>
                <img class="gg" src="img/Parthian-Tactics.jpg" alt=""><a href="Parthian_Tactics.php">帕提亞戰術</a>(+1/+2)</td>
            </tr>
            <tr>
          ...
          <h3>剋馬弓騎兵系的單位與建築</h3> 
          <div class="hrn1"></div>以下單位擁有對馬弓騎兵系的額外傷害，按照傷殺力排列。
          <div class="n1">
            <div class="row">
              <div class="col-md-4">
        ...
        <div class="n1">
          <ul>
            <li><a href="Burmese.php">緬甸</a>：<a href="Faith.php">忠誠信仰</a>便宜50%。</li>
            <li><a href="Chinese.php">中國</a>：對重裝馬弓騎兵有利的科技在帝王時代便宜20%。</li>
            <li><a href="Franks.php">法蘭克</a>：多20%的血量。</li>
            <li><a href="Huns.php">匈奴</a>：造價便宜20%。
              <li><a href="Mongols.php">蒙古</a>：射速快25%。</li>
              <li><a href="Saracens.php">薩拉森</a>：對<a href="Armor_Class_Standard_Building.php">標準建築</a>攻擊+4</li>
              <li><a href="Spanish.php">西班牙</a>：兵工廠科技升級不用黃金</li>
              <li><a href="Turks.php">土耳其</a>：<a href="Chemistry.php">化學</a>免費。</li>
              <li><a href="Vietnamese.php">越南</a>：血量增加20%。免費<a href="Conscription.php">徵兵制度</a>。</li>
          </ul>
        </div>
        <h3>團隊加成</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <ul>
            ...
            <li><a href="Britons.php">不列顛</a>：馬弓騎兵生產快20%。研發<a href="Thumb_Ring.php">拇指環</a>和
              <a
              href="Parthian_Tactics.php">帕提亞戰術</a>的速度快20%。</li>
            ...
            <li><a href="Teutons.php">條頓</a>：重裝馬弓騎兵對僧侶抵抗力更強。</li>
          </ul>
        </div>
        <h3>更新日誌</h3>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <ul>
            ...
            <li><a href="Huns.php">匈奴</a>:重裝馬弓騎兵便宜30％。。</li>
          </ul>
          <h3><em><a href="aof.php">失落的帝國</a></em></h3>
          <ul>
            <li>成本減為40木材65黃金。</li>
            <li><a href="Huns.php">匈奴</a>:重裝馬弓騎兵便宜25％。</li>
            <li><a href="Magyars.php">馬扎爾</a>:5.5版本後特殊科技反曲弓給予重裝馬弓騎兵+1射程。</li>
            <li><a href="Turks.php">土耳其</a>:特殊科技<a href="Sipahi.php">采邑騎兵</a>給予20HP。</li>
          </ul>
          <h3><em><a href="ak.php">非洲王國</a></em></h3>
          <ul>
            <li>馬弓騎兵成本再次減到40木材60黃金。</li>
            <li><a href="Franks.php">法蘭克</a>:重裝馬弓騎兵多20％的HP。</li>
            <li><a href="Huns.php">匈奴</a>:現在重裝馬弓騎兵於帝王時代便宜20％。</li>
          </ul>
          <h3><em><a href="aor.php">王者崛起</a></em></h3>
          <ul>
            <li><a href="Magyars.php">馬扎爾</a>:5.5版本後特殊科技反曲弓給予重裝馬弓騎兵+1射程和+1攻擊。</li>
          </ul>
        </div>
        <h3>歷史</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <p>“馬弓騎兵如果使用得宜會是一種毀滅性的力量，但他們也很容易受到敵人的砲火。為他們裝備頭盔和胸甲讓他們不那麼脆弱。這造救了重裝馬弓騎兵，這個弓箭手的靈活性不如其非武裝對手靈活，但能夠在減少傷亡的同時進行戰鬥。拜占庭人在與波斯騎兵作戰時廣泛重裝馬弓騎兵使用交戰“</p>
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#3c763d;;">
              <div class="unititle">重裝馬弓騎兵</div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="img/HeavyCavArcherIcon.jpg" width="45" alt="">
              </div>
            </td>
          </tr>
          <tr>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          ...
          <div class="col-md-4"> <a href="img/Heavycavalryarcher.png"><img class="imgn" class="hg" src="img/Heavycavalryarcher.png" alt=""></a> 
            <p><em>一群重裝馬弓騎兵</em>
            </p>
          </div>
        </div>
