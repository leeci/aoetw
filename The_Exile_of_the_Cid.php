  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        <div class="col-md-12">
          <h1><strong>席德的流亡歲月</strong></h1>
          <div class="hrn1"></div>
        </div>
        <div class="col-md-8">
          <div class="n1">
            <p>席德的流亡歲月是席德戰役的第三個場景，席德被阿方索國王流放後尋找一位新君主的故事。</p>
          </div>
          <h2>玩家</h2>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <div class="n1">
              <ul>
                <li>席德不能領導西班牙軍隊，科技是薩拉森。</li>
                <li>知道什麼時候攻擊，什麼時候撤退，你需要破壞擋你前進的城牆，因為你別無選擇。</li>
            ...
            <div class="n1">
              <ul>
                <li>席德(紅色)一開始被隻身流放，不用怕你很快就會招募支持者。</li>
                <li>阿方索國王是你的敵人，但他只會恐嚇威脅較低，真正敵人是巴塞隆那的貝倫格爾伯爵， 他們會派出劍兵、騎士、弩砲和輕型衝撞車去攻擊你。</li>
                <li>只要你能遇上其他的摩爾人，摩爾人蒙達米特 (綠色) 將會是一個可以成為同盟的人。</li>
            </div>
            <h3>攻略</h3>
            <div class="hrn1"></div>
            <ul>席德拿到巨型投石車(在右下角)可以直接破壞阿方索國王軍隊擋在河口的城堡。</li>
              <li>到達薩拉城後可以派軍隊直接破壞伯爵在外的攻城器具建築。</li>
              <li>破壞後可以利用拿到的村民建造自己的基地，開始組件自己的軍隊。</li>
              <li>席德可以升級到帝王時代，可生產巨型投石車針對城堡。</li>
            ...
            <div class="hrn1"></div>
            <ul>
              <li>基本上這關很簡單，一開始先靠近馬場拿到馬後他才會開門放你走。</li>
              <li>拿到馬後走到城門外，阿方索國王軍隊會把你列為敵人，不太過度恐慌慢慢走即可，路上的攔截軍不構成威脅。</li>
              <li>盡量靠著邊邊走，以防右邊城堡攻擊。</li>
              <li>拿到巨型投石車後，直接攻擊城堡，也可以在生產幾個衝撞車來幫忙打城門。城堡打完後阿方索國王軍隊就會轉變成同盟。</li>
              <li>再去薩拉城後，直接接著打城外的攻城器具，當破壞完你會獲得˙村民就可以開始建造自己的軍隊。</li>
              <li>對方戰力不高，不用太畏懼如果上帝王后就可以派大軍和數量巨型投石車， 一路打進去。</li>
            </ul>
            <h3>快速破關</h3>
            <div class="hrn1"></div>
            <ul>
              <li> <a href="https://www.youtube.com/watch?v=QpI3GxgX7TQ">此影片是，快速通關打法可以根據個人遊戲體驗斟酌使用</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/EIC 3.jpg" width="" alt="">
                </div>
              </td>
            </tr>
            <tr>
