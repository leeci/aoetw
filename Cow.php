  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="n1"></div>
        <div class="col-md-8">
          <p>乳牛在《世紀帝國 II HD: 失落的帝國》中是可馴化的動物，一隻有150的肉，跟水牛很類似(在《世紀帝國 II HD: 非洲王朝》資料片出現)。乳牛有14HP比其他五種可馴養動物的7HP多一些，這讓那些黑暗時代想用斥侯騎兵跟民兵殺死敵方乳牛的玩家不能輕易達到目的。乳牛主要出現在歐洲地圖上。</p>
           <h3>文明優勢</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#b086b5;">
                <div class="unititle"><a href="">乳牛</a>
                </div>
              </td>
            </tr>
            <tr>
