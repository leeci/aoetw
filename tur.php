...
<div class="n1">
    <table class="table">
        ...
        <i class="fas fa-arrow-down"></i></td>
           <td class="t19 trm not"><img class="gg" src="img/PikemanIcon.jpg" alt="">
        ...
        <td style=" vertical-align: middle; " class="t5 trm im"><a href="Imperial_Age.php">帝王時代</a></td>
         ...
         <img class="gg" src="img/ChampionIcon.jpg" alt=""><div><a href="Champion.php">劍兵勇士</a></div></td>
          <td class="t19 trm not"><img class="gg" src="img/HalberdierIcon.jpg" alt=""><div><a href="Halberdier.php">戟兵</a></div></td>
...
<td class="t19 trm"></td>  
        ...
        <tr>
          ...
          <td class="t15 trm not"><img class="gg" src="img/EliteSkirmisherIcon.jpg"><a href="Elite_Skirmisher.php"><div>戰矛兵</div></a><i class="fas fa-arrow-down"></i> </td>
        ...
        <tr>
          ...
          <td class="t19 trm"><img class="gg" src="img/CavalierIcon.jpg"><div><a href="Cavalier.php">騎兵</a></div>
            <i class="fas fa-arrow-down"></i><br><div class="not"><img class="gg" src="img/PaladinIcon.jpg"><div><a href="Paladin.php" class="">遊俠</a></div></div></td>
        ...
        <tr>
          <td style=" vertical-align: middle; " class="t5 trm ca"><a href="Castle_Age.php">城堡時代</a></td>
         <td class="t13 trm">
          <img class="gg" src="img/JanissaryIcon.jpg" width="30" alt=""><div><a href="Janissary.php">土耳其火槍兵</a></div><i class="fas fa-arrow-down">
          </td>
          <td class="t13 trm">
            <img class="gg" src="img/PetardIcon.jpg" width="30" alt=""><div><a href="Petard.php">爆炸桶</a></div>
          </td>
          <td class="t13 trm"><img class="gg" src="img/CastleAgeUnique.png" width="30" alt=""><div><a href="Cavalry_Units.php">采邑騎兵</a></div></td>
          <td class="t13 trm"></td>
          <td class="t13 trm"></td>
          <td class="t13 trm"></td>
          <td class="t13 trm"></td>
        ...
        <tr>
          <td style=" vertical-align: middle; " class="t5 trm im"><a href="Imperial_Age.php">帝王時代</a></td>
          <td class="t13 trm"><img class="gg" src="img/JanissaryIcon.jpg" width="30" alt=""><div><a href="Janissary.php">精銳土耳其火槍兵</a></div></td>
          <td class="t13 trm"><img class="gg" src="img/TrebuchetPackedIcon.jpg" width="30" alt=""><div><a href="Trebuchet.php">巨型投石機</a></div></td>
          <td class="t13 trm"><img class="gg" src="img/Unique-tech.jpg" width="30" alt=""><div><a href="Artillery.php">砲兵</a></div></td>
   ...
   <tr>
    <td style=" vertical-align: middle; " class="t5 trm fe"><a href="Feudal_Age.php">封建時代</a></td>           
        ...
        <tr>
         ...
         <td class="t11 trm not"><img class="gg" src="img/Herbalmedicine.png" width="30" alt=""><div><a href="Herbal_Medicine.php">草藥學</a></td>
        ...
        <tr>
          <td style=" vertical-align: middle; " class="t5 trm im"><div><a href="Imperial_Age.php">帝王時代</a></div></td>
            <td class="t11 trm not"><img class="gg" src="img/Faith.jpg" width="30" alt=""><div><a href="Faith.php">忠誠信仰</a></div></td>
