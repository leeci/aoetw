  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-12">
          <div class="n1">
            <p>騎兵系是一個防禦裝甲類別，所有在這個系列的兵種都會被剋騎兵系的兵種有額外的傷害。</p>
          </div>
           <h3>騎兵系單位</h3> 
          <div class="hrn1"></div>
          <div class="n1">下列的單位都是騎兵系單位
            <ul>
              <li>
                ...
                alt=""><a href="Heavy_Cavalry_Archer.php">精銳馬弓騎兵</a> 
              </li>
              <li>
                <img class="gg" src="img/GenitourIcon.jpg" alt=""><a href="Genitour.php">標槍騎兵</a>→
                <img class="gg" src="img/GenitourIcon.jpg"
                alt=""><a href="Genitour.php">精銳標槍騎兵</a>(<a href="Berbers.php">柏柏</a>和同盟限定)</li>
              <li>
              ...
              <li>
                <img class="gg" src="img/CataphractIcon.jpg" alt=""><a href="Cataphract.php">聖騎兵</a>(12)→
                <img class="gg" src="img/CataphractIcon.jpg"
                alt=""><a href="Cataphract.php">精銳聖騎兵</a>(16)(<a href="Byzantines.php">拜占庭</a>限定)</li>
              <li>
                <img class="gg" src="img/MangudaiIcon.jpg" width="22" alt=""> <a href="Mangudai.php">蒙古突騎</a>→
                <img class="gg" src="img/MangudaiIcon.jpg"
                width="22" alt=""> <a href="Mangudai.php">精銳蒙古突騎</a>(<a href="Mongols.php">蒙古</a>限定)</li>
              <li>
                <img class="gg" src="img/WarElephantIcon.jpg" width="22" alt=""> <a href="War_Elephant.php">戰象</a>→
                <img class="gg" src="img/WarElephantIcon.jpg"
                width="22" alt=""> <a href="War_Elephant.php">精銳戰象</a>(<a href="Persians.php">波斯</a>限定)</li>
              <li>
                <img class="gg" src="img/Saracenmamluk_icon.png" alt=""><a href="Mameluke.php">奴隸兵</a>(11)→
                <img class="gg" src="img/Saracenmamluk_icon.png"
                alt=""><a href="Mameluke.php">精銳奴隸兵</a>(11)(<a href="Saracens.php">薩拉森</a>限定)</li>
              <li>
              ...
              <li>
                ...
                <img class="gg" src="img/WarWagonIcon.jpg"
              ...
              <li>
                <img class="gg" src="img/MissionaryIcon.jpg" alt=""><a href="Missionary.php">傳教士</a>(<a href="Spanish.php">西班牙</a>限定)</li>
              <li>
              ...
              <li>
                ...
                <img class="gg" src="img/Magyar_Huszar_icon.jpg"
                width="22" alt=""> <a href="Magyar_Huszar.php">精銳馬札爾驃騎兵</a>(<a href="Magyars.php">馬札爾</a>限定)</li>
              <li>
           ...
           <h3>剋騎兵系的單位與建築</h3> 
          <div class="hrn1"></div>
          <div class="n1">以下單位擁有對騎兵系的額外傷害，按照傷殺力排列。這裡也列出攻擊加成0的單位是因為矛象伕的騎兵護甲是-2的關係，0-(-2)=2大於0還是會有攻擊加成。
            <div
            class="n1">
              <div class="col-md-12">
                <div class="col-md-4">
