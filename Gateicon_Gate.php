      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            ...
            <p>城門除了哥德之外的所有文明都可以使用，垛牆和升級過的城門除了<a href="Goths.php">哥德</a>、<a href="Huns.php">匈奴</a>、
              <a
              href="Magyars.php">馬扎爾</a>、<a href="Malay.php">馬來</a>和<a href="Persians.php">波斯</a>以外的文明都可以使用。</p>
          ...
          <div class="n1">
            <ul>
              <li><a href="Byzantines.php">拜占庭</a>：城門在封建/城堡/帝王時代多20%/30%/40%的血量。</li>
              <li><a href="Chinese.php">中國</a>：在城堡/帝王時代，對城門有利的技術價格便宜15％/20％。</li>
          ...
          <div class="hrn1"></div>
          <div class="n1">
            <p>城門與城牆蓋在一起，以方便部隊進出要塞。城門可能是防守位置中最脆弱的部分，所以通常會在附近布置部隊保護。最普遍類型的城門是一個由絞車提起地重型金屬網的。城門會因為自己的重量和沿著溝槽放好位子。
              通常在城門後面上方會有一條狹長的通道。任何設法越過城門的攻擊者將容易遭受狹窄通道內士兵的射擊。</p>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">防止敵方單位進入，讓友方單位通過</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4"><a href="Armor_class_building.php">建築</a>(+20)
          ...
          <div class="thanks">感謝! 此頁面賜齡協助編輯</div>
        </div>
        <div class="col-md-12">
           <h3>圖庫</h3>
          <div class="hrn1"></div>
