  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p><strong>薩拉丁</strong>是《世紀帝國 II HD: 失落的帝國》中的一名騎兵英雄。他只能在戰役編輯器中使用，薩拉丁擁有奴隸兵的外觀。由於他屬於英雄單位，因此不能被招降且會回血
              。</p>
            <p></p>
          </div>
          <div></div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><a href="">薩拉丁</a>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="img/Saladinicon.png" width="80" alt="">
                </div>
              </td>
            </tr>
            <tr>
