...
and (max-device-width: 480px)  {
  ...
  <body style=" font-family: " 微軟正黑體 ";">
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t19 trm">
              <img class="gg" src="img/ArcherIcon.jpg">
              <div><a href="Archer.php">弓兵</a>
              </div> <i class="fas fa-arrow-down"></i> 
            </td>
            <td class="t15 trm">
          ...
          <tr>
            ...
            <td class="t15 trm">
              <img class="gg" src="img/ArbalestIcon.jpg"><a href="Arbalest.php"><div>強弩兵</div></a>
            </td>
            <td class="t15 trm not">
              <img class="gg" src="img/Imperialskirmishericon.png"><a href="Imperial_Skirmisher.php"><div>帝王戰矛兵</div></a>
            </td>
            <td class="t15 trm not">
              <img class="gg" src="img/HeavyCavArcherIcon.jpg"><a href="Heavy_Cavalry_Archer.php"><div>重裝馬弓騎兵</div></a>
            </td>
            <td class="t15 trm">
              <img class="gg" src="img/HandCannoneerIcon.jpg"><a href="Hand_Cannoneer.php"><div>火槍兵</div></a>
            </td>
            <td class="t15 trm not">
              <img class="gg" src="img/GenitourIcon.jpg"><a href="Genitour.php"><div>精銳標槍騎兵</div></a>
            </td>
            <td class="t15 trm not">
              <img class="gg" src="img/Parthian-Tactics.jpg"><a href="Parthian_Tactics.php"><div>帕提亞戰術</div></a>
            </td>
          </tr>
        </table>
        <table class="table" style="margin-top:50px;">
        ...
        <table class="table" style="margin-top:50px;">
          <tr>
            <td class="trm" style="border-top: none;" colspan="5"> <a href="Siege_Workshop.php"><img class="ng" src="img/Siegeworkshopicon.png" alt=""></a> 
              <div
              id="攻城器製造所"><a href="Siege_Workshop.php">攻城器製造所</a>
      </div>
      </td>
      </tr>
      <tr>
        ...
        <td class="t23 trm">
          <img class="gg" src="img/MangonelIcon.jpg" width="30" alt="">
          <div><a href="Mangonel.php">輕型投石車</a>
          </div><i class="fas fa-arrow-down"></i>
        </td>
        <td class="t23 trm">
      ...
      <tr>
        ...
        <td class="t23 trm">
          ...
          <br>
          <img class="gg not" src="img/SiegeRamIcon.jpg" width="30" alt="">
        ...
        <td class="t23 trm">
          ...
          <br>
          <img class="gg not" src="img/SiegeOnagerIcon.jpg" width="30" alt="">
    ...
    <tr>
      ...
      <td class="t13 trm">
        <img class="gg" src="img/New_Genoese_Crossbowman.png" width="30" alt="">
        <div><a href="Genoese_Crossbowman.php">熱那亞弩手</a>
        </div>
      </td>
      <td class="t13 trm">
        <img class="gg" src="img/PetardIcon.jpg" width="30" alt="">
        <div><a href="Petard.php">爆炸桶</a>
        </div>
      </td>
      <td class="t13 trm">
        <img class="gg" src="img/CastleAgeUnique.png" width="30" alt="">
        <div><a href="Pavise.php">巨盾</a>
        </div>
      </td>
      <td class="t13 trm"></td>
      <td class="t13 trm"></td>
    ...
    <tr>
      ...
      <td class="t13 trm">
        <img class="gg" src="img/New_Genoese_Crossbowman.png" width="30" alt="">
        <div><a href="Genoese_Crossbowman.php">精銳熱那亞弩手</a>
        </div>
      </td>
      <td class="t13 trm">
        <img class="gg" src="img/TrebuchetPackedIcon.jpg" width="30" alt="">
        <div><a href="Trebuchet.php">巨型投石機</a>
        </div>
      </td>
      <td class="t13 trm">
        <img class="gg" src="img/Unique-tech.jpg" width="30" alt="">
        <div><a href="Silk_Road.php">絲綢之路</a>
        </div>
      </td>
      <td class="t13 trm">
      ...
      <td class="t13 trm not">
        <img class="gg" src="img/Sappers.jpg" width="30" alt="">
        <div><a href="Sappers.php">坑道工兵</a>
        </div>
      </td>
      <td class="t13 trm">
        <img class="gg" src="img/Conscription.jpg" width="30" alt="">
        <div><a href="Conscription.php">徵兵制度</a>
        </div>
      </td>
      <td class="t13 trm">
        <img class="gg" src="img/Spiestreason.jpg" width="30" alt="">
        <div><a href="Spies.php">間諜</a>
        </div>
      </td>
    </tr>
    </table>
    <table class="table" style="margin-top:50px;">
      <tr>
        <td class="trm" colspan="5" style="border-top: none;"> <a href="Town_Center.php"><img class="ng" src="img/Towncentericon.png" alt=""></a> 
          <div><a href="Town_Center.php">城鎮中心</a>
          </div>
        </td>
      </tr>
      <tr>
        ...
        <td class="t23 trm">
          <img class="gg" src="img/VillagerMaleIcon.jpg" alt="">
          <div><a href="Villager.php">村民</a>
          </div>
        </td>
        <td class="t23 trm">
          <img class="gg" src="img/Feudal-age-reseach.jpg" alt="">
          <div><a href="Feudal_Age.php">封建時代</a>
          </div> <i class="fas fa-arrow-down"></i> 
        </td>
        <td class="t23 trm">
    ...
    <table class="table" style="margin-top:50px;">
      ...
      <tr>
        ...
        <td class="t23 trm">
          <img class="gg" src="img/Croprotation.jpg" alt="">
          <div><a href="Crop_Rotation.php">輪耕</a>
          </div>
        </td>
        <td class="t23 trm"></td>
        <td class="t23 trm"></td>
    ...
    <table class="table" style="margin-top:50px;">
      ...
      <tr>
        ...
        <td class="t10 trm">
          ...
          <br>
          <img class="gg" src="img/CannonGalleonIcon.jpg">
          <div><a href="Elite_Cannon_Galleon.php" class="">精銳火炮戰船</a>
          </div>
        </td>
        <td class="t10 trm">
    ...
    <table class="table" style="margin-top:50px;">
      <tr>
        <td class="trm" colspan="6" style="border-top: none;"> <a href="Blacksmith.php"><img class="ng" src="img/Blacksmithicon.png" alt=""></a> 
          <div
          id="兵工廠"><a href="Blacksmith.php">兵工廠</a>
            </div>
        </td>
      </tr>
      <tr>
    ...
    <table class="table" style="margin-top:50px;">
      <tr>
        <td class="trm" colspan="9" style="border-top: none;"> <a href="Monastery.php"><img class="ng" src="img/Monasteryicon.png" alt=""></a> 
          <div
          id="修道院"><a href="Monastery.php">修道院</a>
            </div>
        </td>
      </tr>
      <tr>
    ...
    <table class="table" style="margin-top:50px;">
      <tr>
        <td class="trm" colspan="9" style="border-top: none;"> <a href="University.php"><img class="ng" src="img/Universityicon.png" alt=""></a> 
          <div
          id="學院"><a href="University.php">學院</a>
            </div>
        </td>
      </tr>
      <tr>
